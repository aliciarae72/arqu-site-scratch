...
(function (global, factory) {
	...
	define(["exports"], function (t) {
		...
		self.document &&
			(((I = self.document.createElement("img")).onload = function () {
				z && L(z), (z = null), (F = !0);
			}),
			(I.onerror = function () {
				(T = !0), (z = null);
					...
					try {
						self.localStorage.setItem(r, this.anonId),
							Object.keys(this.eventData).length >= 1 &&
								self.localStorage.setItem(e, JSON.stringify(this.eventData));
					} catch (t) {
				...
				return (
					...
					(e.prototype.postMapLoadEvent = function (t, e) {
						C.EVENTS_URL &&
							...
							this.queueRequest({ id: e, timestamp: Date.now() });
					}),
					(e.prototype.processRequests = function () {
						...
						if (!this.pendingRequest && 0 !== this.queue.length) {
							...
							(r && this.success[r]) ||
								...
								d(this.anonId) || (this.anonId = y()),
								this.postEvent(n, {}, function (e) {
									e || (r && (t.success[r] = !0));
								}));
						}
					}),
				...
				return (
					...
					(e.prototype.processRequests = function () {
						...
						if (!this.pendingRequest && 0 !== this.queue.length) {
							...
							this.postEvent(i, { "enabled.telemetry": !1 }, function (e) {
		...
		var at = function (t, e) {
			...
			ot = function (t, e) {
				return at(c(t, { type: "arrayBuffer" }), e);
			},
			st = function (t, e) {
				return at(c(t, { method: "POST" }), e);
			};
		var ut, lt;
		(ut = []), (lt = 0);
		var pt = function (t, e) {
			...
			var n = !1,
				i = function () {
					if (!n)
						for (
							n = !0, lt--;
							ut.length && lt < C.MAX_PARALLEL_IMAGE_REQUESTS;
				...
				a = ot(t, function (t, r, n, a) {
					if ((i(), t)) e(t);
						...
						var u = new self.Blob([new Uint8Array(r)], { type: "image/png" });
						(o.cacheControl = n),
							(o.expires = a),
							(o.src = r.byteLength
								? s.createObjectURL(u)
		...
		var ft = function (t, e) {
			...
			yt = (function (t) {
				function e(e, r) {
					void 0 === r && (r = {}), t.call(this, "error", c({ error: e }, r));
				}
				return (
					t && (e.__proto__ = t),
					(e.prototype = Object.create(t && t.prototype)),
		...
		(dt.prototype.on = function (t, e) {
			return (
				...
				ct(t, e, this._listeners),
				this
			);
		}),
			(dt.prototype.off = function (t, e) {
				return (
					ht(t, e, this._listeners), ht(t, e, this._oneTimeListeners), this
				);
			}),
			(dt.prototype.once = function (t, e) {
				return (
					(this._oneTimeListeners = this._oneTimeListeners || {}),
					ct(t, e, this._oneTimeListeners),
					this
				);
			}),
		...
		function Lt(t, e) {
			...
			if ("array" === t.kind) {
				...
				if ("value" === t.kind)
					for (var r = 0, n = Ft; r < n.length; r += 1) {
		...
		var Ot = e(function (t, e) {
				...
				try {
					e.parseCSSColor = function (t) {
						...
						if ("#" === i[0])
							return 4 === i.length
								? (e = parseInt(i.substr(1), 16)) >= 0 && e <= 4095
									? [
											((3840 & e) >> 4) | ((3840 & e) >> 8),
											(240 & e) | ((240 & e) >> 4),
											(15 & e) | ((15 & e) << 4),
		...
		(Dt.parse = function (t) {
			...
			(Dt.prototype.toArray = function () {
				...
				return 0 === n
					? [0, 0, 0, 0]
					: [(255 * t) / n, (255 * e) / n, (255 * r) / n, n];
			}),
			(Dt.black = new Dt(0, 0, 0, 1)),
			(Dt.white = new Dt(1, 1, 1, 1)),
			(Dt.transparent = new Dt(0, 0, 0, 0)),
			(Dt.red = new Dt(1, 0, 0, 1));
		...
		function Kt(t) {
			...
			return null === t
				...
				: "string" === e || "number" === e || "boolean" === e
					? String(t)
					: t instanceof Dt || t instanceof Rt
						? t.toString()
						: JSON.stringify(t);
		}
		...
		var Zt = { string: zt, number: kt, boolean: It, object: Et },
			Ht = function (t, e) {
		...
		(Ht.parse = function (t, e) {
			...
			if ("array" === i) {
				...
				if (t.length > 2) {
					var s = t[1];
					if ("string" != typeof s || !(s in Zt) || "object" === s)
						return e.error(
		...
		(Yt.parse = function (t, e) {
			...
			for (var r = [], n = 1; n < t.length - 1; n += 2) {
				...
				var s = null;
				if (o["font-scale"] && !(s = e.parse(o["font-scale"], 1, kt)))
					return null;
				var u = null;
				if (o["text-font"] && !(u = e.parse(o["text-font"], 1, Mt(zt))))
					return null;
				r.push({ text: i, scale: s, font: u });
			}
			return new Yt(r);
		}),
		...
		($t.parse = function (t, e) {
			...
			($t.prototype.evaluate = function (t) {
				...
				if ("color" === this.type.kind) {
					for (var e, r, n = 0, i = this.args; n < i.length; n += 1) {
						...
						if ("string" == typeof e) {
							...
							return new Dt(e[0] / 255, e[1] / 255, e[2] / 255, e[3]);
					}
					throw new Xt(
						r ||
				...
				return "formatted" === this.type.kind
					? Rt.fromString(Kt(this.args[0].evaluate(t)))
					: Kt(this.args[0].evaluate(t));
			}),
			...
			($t.prototype.serialize = function () {
				if ("formatted" === this.type.kind)
					return new Yt([
						{ text: this.args[0], scale: null, font: null },
					]).serialize();
		...
		(te.prototype.evaluate = function (t) {
			...
			(te.parse = function (t, e) {
				...
				for (
					...
					if (!d)
						if (Array.isArray(h) && h.length !== y.length)
							u.error(
								"Expected " +
									h.length +
									" arguments, but found " +
		...
		(ee.parse = function (t, e) {
			...
			if (!i) return null;
			var a = null;
			return r.locale && !(a = e.parse(r.locale, 1, zt))
				? null
				: new ee(n, i, a);
		}),
		...
		function Se(t) {
			var e = Ae(t.r),
				r = Ae(t.g),
				n = Ae(t.b),
				i = be((0.4124564 * e + 0.3575761 * r + 0.1804375 * n) / ce),
				a = be((0.2126729 * e + 0.7151522 * r + 0.072175 * n) / he);
			return {
				l: 116 * a - 16,
				a: 500 * (i - a),
				b: 200 * (a - be((0.0193339 * e + 0.119192 * r + 0.9503041 * n) / fe)),
				alpha: t.a,
			};
		}
		function ke(t) {
			...
			return (
				...
				(n = fe * _e(n)),
				new Dt(
					we(3.2404542 * r - 1.5371385 * e - 0.4985314 * n),
					we(-0.969266 * r + 1.8760108 * e + 0.041556 * n),
					we(0.0556434 * r - 0.2040259 * e + 1.0572252 * n),
					t.alpha,
				)
			);
		}
		...
		var Ie = {
			...
			Ee = Object.freeze({ lab: Ie, hcl: Be }),
		...
		(Pe.interpolationFactor = function (t, e, n, i) {
			var a = 0;
			if ("exponential" === t.name) a = Ve(e, t.base, n, i);
			else if ("linear" === t.name) a = Ve(e, 1, n, i);
			...
			(Pe.parse = function (t, e) {
				...
				return "number" === l.kind ||
					...
					("array" === l.kind &&
						...
						"number" == typeof l.N)
					? new Pe(l, r, n, i, u)
					: e.error("Type " + Tt(l) + " is not interpolatable.");
			}),
			(Pe.prototype.evaluate = function (t) {
				...
				return "interpolate" === this.operator
					? pe[this.type.kind.toLowerCase()](l, p, u)
					: "interpolate-hcl" === this.operator
						? Be.reverse(Be.interpolate(Be.forward(l), Be.forward(p), u))
						: Ie.reverse(Ie.interpolate(Ie.forward(l), Ie.forward(p), u));
			}),
		...
		(Fe.parse = function (t, e) {
			...
			return d
				? "value" !== y.type.kind && e.concat(1).checkSubtype(r, y.type)
					? null
					: new Fe(r, n, y, i, a, d)
				: null;
		}),
			(Fe.prototype.evaluate = function (t) {
				...
				return (
					(Nt(e) === this.inputType && this.outputs[this.cases[e]]) ||
					this.otherwise
				).evaluate(t);
			}),
		...
		(Xe.parse = function (t, e) {
			...
			if (
				...
				!(o = e.parse(n["min-fraction-digits"], 1, kt))
			)
				return null;
			var s = null;
			return n["max-fraction-digits"] &&
				!(s = e.parse(n["max-fraction-digits"], 1, kt))
				? null
				: new Xe(r, i, a, o, s);
		}),
				...
				"color" === e.type
					...
					: "formatted" === e.type
						...
						: ir(r) === e.type ||
							...
							(r = void 0),
				sr(r, t.default, e.default)
			);
		}
		function hr(t, e) {
			for (var r, n, i = 0, a = t.length - 1, o = 0; i <= a; ) {
				if (
					((r = t[(o = Math.floor((i + a) / 2))][0]),
					(n = t[o + 1][0]),
					e === r || (e > r && e < n))
				)
					return o;
		...
		var fr = function (t, e) {
			...
			(this.expression = t),
				...
				(this._defaultValue = e
					? "color" === (r = e).type && ar(r.default)
						? new Dt(0, 0, 0, 0)
						: "color" === r.type
							? Dt.parse(r.default) || null
							: void 0 === r.default
								? null
								: r.default
					: null),
		...
		var mr = function (t, e) {
			(this.kind = t),
				...
				(this.isStateDependent = "constant" !== t && !ne(e.expression));
		};
		...
		var vr = function (t, e, r) {
			(this.kind = t),
				...
				(this._styleExpression = e),
				(this.isStateDependent = "camera" !== t && !ne(e.expression)),
				r instanceof Pe && (this._interpolationType = r.interpolation);
		};
		function gr(t, e) {
			...
			var a = (function t(e) {
				var r = null;
				if (e instanceof Me) r = t(e.result);
					...
					(e instanceof ue || e instanceof Pe) &&
						e.input instanceof te &&
						"zoom" === e.input.name &&
						(r = e);
			...
			return a || i
				? a instanceof wt
					...
					: a instanceof Pe && !nr(e)
						...
						: Qe(
								a
									? new vr(n ? "camera" : "composite", t.value, a)
									: new mr(n ? "constant" : "source", t.value),
							)
				: tr([
						new wt(
							"",
		...
		(vr.prototype.evaluateWithoutErrorHandling = function (t, e, r) {
			...
			(vr.prototype.interpolationFactor = function (t, e, r) {
				return this._interpolationType
					? Pe.interpolationFactor(this._interpolationType, t, e, r)
					: 0;
			});
		var xr = function (t, e) {
			(this._parameters = t),
					...
					(function t(e, r) {
						...
						if (
							(o &&
								...
								e.default
									? (e.default = Dt.parse(e.default))
									: (e.default = Dt.parse(r.default))),
							e.colorSpace && "rgb" !== e.colorSpace && !Ee[e.colorSpace])
						)
							throw new Error("Unknown color space: " + e.colorSpace);
						if ("exponential" === p) n = pr;
						else if ("interval" === p) n = lr;
						...
						if (s) {
							...
							return {
								...
								evaluate: function (t, n) {
									var i = t.zoom;
									return pr({ stops: x, base: e.base }, r, i).evaluate(i, n);
								},
							};
						}
						return l
							? {
									...
									interpolationFactor:
										"exponential" === p
											? Pe.interpolationFactor.bind(void 0, {
													name: "exponential",
							...
							: {
									...
									evaluate: function (t, o) {
										var s =
											o && o.properties ? o.properties[e.property] : void 0;
										return void 0 === s
											? sr(e.default, r.default)
											: n(e, r, s, i, a);
									},
								};
		...
		function br(t, e) {
			...
			var n = t;
			return (
				"string" == typeof t && "color" === e.type && (n = Dt.parse(t)),
				{
					kind: "constant",
					evaluate: function () {
						return n;
		...
		function _r(t) {
			var e = t.key,
				...
				u = ir(r);
			if ("object" !== u)
				return [new vt(e, r, "object expected, " + u + " found")];
			for (var l in r) {
				var p = l.split(".")[0],
					c = n[p] || n["*"],
					h = void 0;
			...
			for (var f in n)
				i[f] ||
					(n[f].required &&
						void 0 === n[f].default &&
						void 0 === r[f] &&
						s.push(new vt(e, r, 'missing required property "' + f + '"')));
			return s;
		}
		function wr(t) {
			var e = t.value,
			...
			if ("array" !== ir(e))
				return [new vt(a, e, "array expected, " + ir(e) + " found")];
		...
		function Ar(t) {
			var e = t.key,
				...
				i = ir(r);
			return "number" !== i
				? [new vt(e, r, "number expected, " + i + " found")]
				: "minimum" in n && r < n.minimum
					? [new vt(e, r, r + " is less than the minimum value " + n.minimum)]
		...
		function Sr(t) {
			var e,
				...
				u = !s,
				l =
					"array" === ir(t.value.stops) &&
					"array" === ir(t.value.stops[0]) &&
					"object" === ir(t.value.stops[0][0]),
				p = _r({
					key: t.key,
					value: t.value,
					...
					objectElementValidators: {
						stops: function (t) {
							...
							(e = e.concat(
								...
								"array" === ir(r) &&
									0 === r.length &&
									e.push(new vt(t.key, r, "array must have at least one stop"));
							return e;
						},
						default: function (t) {
							return Gr({
			...
			return (
				"identity" === a &&
					s &&
					p.push(
						new vt(t.key, t.value, 'missing required property "property"'),
					),
				"identity" === a ||
					t.value.stops ||
					p.push(new vt(t.key, t.value, 'missing required property "stops"')),
				"exponential" === a &&
					t.valueSpec.expression &&
					!nr(t.valueSpec) &&
					p.push(new vt(t.key, t.value, "exponential functions not supported")),
				t.styleSpec.$version >= 8 &&
					(u && !er(t.valueSpec)
						? p.push(new vt(t.key, t.value, "property functions not supported"))
						: s &&
							!rr(t.valueSpec) &&
							p.push(new vt(t.key, t.value, "zoom functions not supported"))),
				("categorical" !== a && !l) ||
					void 0 !== t.value.property ||
					p.push(new vt(t.key, t.value, '"property" property is required')),
				p
			);
			function c(t) {
				var e = [],
					...
					s = t.key;
				if ("array" !== ir(a))
					return [new vt(s, a, "array expected, " + ir(a) + " found")];
				if (2 !== a.length)
					return [
						new vt(
							s,
							a,
							"array length 2 expected, length " + a.length + " found",
						),
					];
				if (l) {
					if ("object" !== ir(a[0]))
						return [new vt(s, a, "object expected, " + ir(a[0]) + " found")];
					if (void 0 === a[0].zoom)
						return [new vt(s, a, "object stop key must have zoom")];
					if (void 0 === a[0].value)
						return [new vt(s, a, "object stop key must have value")];
					if (n && n > bt(a[0].zoom))
						return [
							new vt(
								s,
					...
					bt(a[0].zoom) !== n && ((n = bt(a[0].zoom)), (r = void 0), (o = {})),
						(e = e.concat(
							_r({
								key: s + "[0]",
								value: a[0],
								...
								style: t.style,
								styleSpec: t.styleSpec,
								objectElementValidators: { zoom: Ar, value: h },
							}),
						));
				} else
					e = e.concat(
			...
			function h(t, n) {
				...
				return "categorical" !== a ||
					"number" !== s ||
					(isFinite(u) && Math.floor(u) === u)
					? "categorical" !== a && "number" === s && void 0 !== r && u < r
						? [
								new vt(
									t.key,
									l,
						...
						: ((r = u),
							"categorical" === a && u in o
								? [new vt(t.key, l, "stop domain values must be unique")]
								: ((o[u] = !0), []))
					: [new vt(t.key, l, "integer expected, found " + u)];
			}
		}
		function kr(t) {
			var e = ("property" === t.expressionContext ? gr : dr)(
				_t(t.value),
				t.valueSpec,
			);
			if ("error" === e.result)
			...
			if (
				...
				-1 !== r.possibleOutputs().indexOf(void 0)
			)
				return [
					new vt(
						t.key,
			...
			if ("filter" === t.expressionContext && !ne(r))
				return [
					new vt(
						t.key,
						t.value,
			...
			if (t.expressionContext && 0 === t.expressionContext.indexOf("cluster")) {
				...
				if ("cluster-initial" === t.expressionContext && !re(r))
					return [
						new vt(
							t.key,
							t.value,
		...
		function zr(t) {
			...
			return (
				Array.isArray(n.values)
					...
					: -1 === Object.keys(n.values).indexOf(bt(r)) &&
						i.push(
							new vt(
								e,
								r,
				...
				: "==" === r
					...
					: "!=" === r
						...
						: "<" === r || ">" === r || "<=" === r || ">=" === r
							? Cr(t[1], t[2], r)
							: "any" === r
								? ((e = t.slice(1)), ["any"].concat(e.map(Vr)))
								: "all" === r
									? ["all"].concat(t.slice(1).map(Vr))
									: "none" === r
										? ["all"].concat(t.slice(1).map(Vr).map(Fr))
										: "in" === r
											? Mr(t[1], t.slice(2))
											: "!in" === r
												? Fr(Mr(t[1], t.slice(2)))
			...
			switch (t) {
				...
				default:
					return e.length > 200 &&
						...
						? ["filter-in-large", t, ["literal", e.sort(Pr)]]
		...
		function Lr(t) {
			return Ir(_t(t.value))
				...
				: (function t(e) {
						...
						var n = e.key;
						if ("array" !== ir(r))
							return [new vt(n, r, "array expected, " + ir(r) + " found")];
						var i = e.styleSpec;
						var a;
						var o = [];
						if (r.length < 1)
							return [
								new vt(n, r, "filter array must have at least 1 element"),
							];
						o = o.concat(
							zr({
								key: n + "[0]",
						...
						switch (bt(r[0])) {
							...
							case "!in":
								r.length >= 2 &&
									"string" !== (a = ir(r[1])) &&
									o.push(
										new vt(n + "[1]", r[1], "string expected, " + a + " found"),
									);
		...
		function Or(t, e) {
			...
			if ("paint" === e && u && s[u[1]] && s[u[1]].transition)
				return Gr({
					key: r,
					value: a,
			...
			return (
				"symbol" === t.layerType &&
					...
					"text-font" === o &&
						...
						"identity" === bt(a.type) &&
						c.push(
							new vt(r, a, '"text-font" does not support identity functions'),
						)),
				c.concat(
					Gr({
						key: t.key,
		...
		function jr(t) {
			...
			r.type ||
				r.ref ||
				e.push(new vt(n, r, 'either "type" or "ref" is required'));
			var o,
				s = bt(r.type),
				u = bt(r.ref);
			if (r.id)
			...
			if ("ref" in r)
				["type", "source", "source-layer", "filter", "layout"].forEach(
					function (t) {
						t in r &&
							e.push(
								new vt(n, r[t], '"' + t + '" is prohibited for ref layers'),
							);
					},
				),
					...
					o
						? o.ref
							? e.push(
									new vt(n, r.ref, "ref cannot reference another ref layer"),
								)
							: (s = bt(o.type))
						: e.push(new vt(n, r.ref, 'ref layer "' + u + '" not found'));
				...
				if (r.source) {
					...
					h
						...
						: e.push(
								new vt(n, r.source, 'source "' + r.source + '" not found'),
							);
							...
							["type", "url", "tileSize"].indexOf(s) < 0 &&
								a.push(
									new vt(
										r + "." + s,
										e[s],
										'a source with a "url" property may not include a "' +
											s +
											'" property',
									),
								);
		...
		function qr(t) {
			...
			if ("object" !== o)
				return (a = a.concat([
					new vt("light", e, "object expected, " + o + " found"),
				]));
			for (var s in e) {
				var u = s.match(/^(.*)-transition$/);
				a =
					u && n[u[1]] && n[u[1]].transition
						? a.concat(
								Gr({
									key: s,
									value: e[s],
		...
		function Nr(t) {
			var e = t.value,
				...
				n = ir(e);
			return "string" !== n
				? [new vt(r, e, "string expected, " + n + " found")]
				: [];
		}
		var Kr = {
			"*": function () {
			...
			boolean: function (t) {
				var e = t.value,
					...
					n = ir(e);
				return "boolean" !== n
					? [new vt(r, e, "boolean expected, " + n + " found")]
					: [];
			},
			number: Ar,
			color: function (t) {
				var e = t.key,
					...
					n = ir(r);
				return "string" !== n
					? [new vt(e, r, "color expected, " + n + " found")]
					: null === Ot(r)
						? [new vt(e, r, 'color expected, "' + r + '" found')]
						: [];
			},
			constants: gt,
			enum: zr,
		...
		function Gr(t) {
			var e = t.value,
				r = t.valueSpec,
				n = t.styleSpec;
			return r.expression && ar(bt(e))
				? Sr(t)
				: r.expression && yr(_t(e))
					? kr(t)
					: r.type && Kr[r.type]
						? Kr[r.type](t)
						: _r(xt({}, t, { valueSpec: r.type ? n[r.type] : r }));
		}
		function Xr(t) {
			var e = t.value,
				r = t.key,
			...
			return n.length
				...
				: (-1 === e.indexOf("{fontstack}") &&
						n.push(
							new vt(r, e, '"glyphs" url must include a "{fontstack}" token'),
						),
					-1 === e.indexOf("{range}") &&
						n.push(new vt(r, e, '"glyphs" url must include a "{range}" token')),
					n);
		}
		function Zr(t, e) {
			e = e || mt;
		...
		(Zr.source = Yr(Rr)),
			...
			(Zr.layer = Yr(jr)),
			(Zr.filter = Yr(Lr)),
			(Zr.paintProperty = Yr(Dr)),
			(Zr.layoutProperty = Yr(Ur));
		var Jr = Zr,
			$r = Zr.light,
			Wr = Zr.paintProperty,
		...
		(nn.prototype.insert = function (t, e, r, n, i) {
			...
			(nn.prototype.toArrayBuffer = function () {
				...
				for (
					var t = this.cells, e = rn + this.cells.length + 1 + 1, r = 0, n = 0;
					n < this.cells.length;
					n++
				)
		...
		function sn(t, e, r) {
			void 0 === r && (r = {}),
				...
				(on[t] = { klass: e, omit: r.omit || [], shallow: r.shallow || [] });
		}
		for (var un in (sn("Object", Object),
		(en.serialize = function (t, e) {
		...
		sn("Color", Dt),
		sn("Error", Error),
		sn("StylePropertyFunction", xr),
		sn("StyleExpression", fr, { omit: ["_evaluator"] }),
		sn("ZoomDependentExpression", vr),
		sn("ZoomConstantExpression", mr),
		sn("CompoundExpression", te, { omit: ["_evaluate"] }),
		He))
		...
		function ln(t, e) {
			...
			if ("object" == typeof t) {
				...
				if (!s.serialize) {
					for (var p in t)
						if (t.hasOwnProperty(p) && !(on[u].omit.indexOf(p) >= 0)) {
							var c = t[p];
		...
		function yn(t) {
			return (
				!hn.Arabic(t) &&
				!hn["Arabic Supplement"](t) &&
				!hn["Arabic Extended-A"](t) &&
				!hn["Arabic Presentation Forms-A"](t) &&
				!hn["Arabic Presentation Forms-B"](t)
			);
		}
		function dn(t) {
			return (
				...
				747 === t ||
				(!(t < 4352) &&
					(!!hn["Bopomofo Extended"](t) ||
						!!hn.Bopomofo(t) ||
						!(
							!hn["CJK Compatibility Forms"](t) ||
							(t >= 65097 && t <= 65103)
						) ||
						!!hn["CJK Compatibility Ideographs"](t) ||
						!!hn["CJK Compatibility"](t) ||
						!!hn["CJK Radicals Supplement"](t) ||
						!!hn["CJK Strokes"](t) ||
						!(
						...
						!!hn["CJK Unified Ideographs Extension A"](t) ||
						!!hn["CJK Unified Ideographs"](t) ||
						!!hn["Enclosed CJK Letters and Months"](t) ||
						!!hn["Hangul Compatibility Jamo"](t) ||
						!!hn["Hangul Jamo Extended-A"](t) ||
						!!hn["Hangul Jamo Extended-B"](t) ||
						!!hn["Hangul Jamo"](t) ||
						!!hn["Hangul Syllables"](t) ||
						!!hn.Hiragana(t) ||
						!!hn["Ideographic Description Characters"](t) ||
						!!hn.Kanbun(t) ||
						!!hn["Kangxi Radicals"](t) ||
						!!hn["Katakana Phonetic Extensions"](t) ||
						!(!hn.Katakana(t) || 12540 === t) ||
						!(
						...
						!!hn["Unified Canadian Aboriginal Syllabics"](t) ||
						!!hn["Unified Canadian Aboriginal Syllabics Extended"](t) ||
						!!hn["Vertical Forms"](t) ||
						!!hn["Yijing Hexagram Symbols"](t) ||
						!!hn["Yi Syllables"](t) ||
						!!hn["Yi Radicals"](t)))
			);
		}
		...
		function vn(t, e) {
			return (
				...
				!((t >= 2304 && t <= 3583) || (t >= 3840 && t <= 4255) || hn.Khmer(t))
			);
		}
		var gn,
			xn = !1,
		...
		(In.prototype.getValue = function (t) {
			...
			(In.prototype.setValue = function (t, e) {
				this._values.hasOwnProperty(t) ||
					(this._values[t] = new zn(this._values[t].property)),
					(this._values[t].value = new kn(
		...
		(En.prototype.possiblyEvaluate = function (t) {
			for (
				var e = new Cn(this._properties), r = 0, n = Object.keys(this._values);
				r < n.length;
				r += 1
			) {
				var i = n[r];
		...
		(Pn.prototype.getValue = function (t) {
			...
			(Pn.prototype.possiblyEvaluate = function (t) {
				for (
					var e = new Cn(this._properties),
						r = 0,
						n = Object.keys(this._values);
					r < n.length;
					r += 1
				) {
					var i = n[r];
		...
		(Tn.prototype.possiblyEvaluate = function (t, e) {
			return "constant" === t.expression.kind || "camera" === t.expression.kind
				? new Vn(this, { kind: "constant", value: t.expression.evaluate(e) }, e)
				: new Vn(this, t.expression, e);
		}),
		...
		(Ln.prototype.possiblyEvaluate = function (t, e) {
			if (void 0 !== t.value) {
				...
				return this._calculate(
					t.expression.evaluate(new Sn(Math.floor(e.zoom - 1), e)),
					t.expression.evaluate(new Sn(Math.floor(e.zoom), e)),
					t.expression.evaluate(new Sn(Math.floor(e.zoom + 1), e)),
					e,
				);
			}
		...
		sn("DataDrivenProperty", Tn),
			sn("DataConstantProperty", Mn),
			sn("CrossFadedDataDrivenProperty", Fn),
			sn("CrossFadedProperty", Ln),
			sn("ColorRampProperty", On);
		var Un = (function (t) {
				function e(e, r) {
					if (
						(t.call(this),
						...
						"custom" !== e.type &&
							...
							r.layout && (this._unevaluatedLayout = new Pn(r.layout)),
							r.paint))
					) {
						for (var n in ((this._transitionablePaint = new In(r.paint)),
						e.paint))
				...
				return (
					...
					(e.prototype.setLayoutProperty = function (t, e, r) {
						...
						"visibility" !== t
							...
							: (this.visibility = "none" === e ? e : "visible");
					}),
					(e.prototype.getPaintProperty = function (t) {
						return v(t, "-transition")
					...
					(e.prototype.recalculate = function (t) {
						t.getCrossfadeParameters &&
							...
							this._unevaluatedLayout &&
								(this.layout = this._unevaluatedLayout.possiblyEvaluate(t)),
		...
		var Qn = (function (t) {
			...
			return (
				...
				(e.prototype.emplaceBack = function (t, e, r, n, i, a, o, s, u, l, p) {
					var c = this.length;
					return (
						this.resize(c + 1), this.emplace(c, t, e, r, n, i, a, o, s, u, l, p)
					);
				}),
		...
		(Qn.prototype.bytesPerElement = 24),
			sn("StructArrayLayout6i1ul2ui2i24", Qn);
		var ti = (function (t) {
			function e() {
				t.apply(this, arguments);
			}
		...
		var ri = (function (t) {
			...
			return (
				...
				(e.prototype.emplaceBack = function (
					...
					return (
						this.resize(y + 1),
						this.emplace(y, t, e, r, n, i, a, o, s, u, l, p, c, h, f)
					);
				}),
		...
		(ri.prototype.bytesPerElement = 40),
			sn("StructArrayLayout2i2ui3ul3ui2f2ub40", ri);
		var ni = (function (t) {
			function e() {
				t.apply(this, arguments);
			}
		...
		var mi = (function (t) {
			...
			var r = {
				anchorX: { configurable: !0 },
				anchorY: { configurable: !0 },
				horizontalPlacedTextSymbolIndex: { configurable: !0 },
				...
				featureIndex: { configurable: !0 },
				numGlyphVertices: { configurable: !0 },
		...
		var bi = (function (t) {
			...
			var r = {
				x: { configurable: !0 },
				y: { configurable: !0 },
				tileUnitDistanceFromAnchor: { configurable: !0 },
			};
			return (
				(r.x.get = function () {
					return this._structArray.int16[this._pos2 + 0];
		...
		var Si = Nn([{ name: "a_pos", components: 2, type: "Int16" }], 4),
			ki = Si.members,
			zi =
				(Si.size,
				Si.alignment,
		...
		function Ii(t, e) {
			return (
				256 * (t = l(Math.floor(t), 0, 255)) + (e = l(Math.floor(e), 0, 255))
			);
		}
		(zi.prototype.prepareSegment = function (t, e, r, n) {
				...
				t > zi.MAX_VERTEX_ARRAY_LENGTH &&
					w(
						"Max vertices per segment is " +
							zi.MAX_VERTEX_ARRAY_LENGTH +
							": bucket requested " +
							t,
					),
				(!i ||
					i.vertexLength + t > zi.MAX_VERTEX_ARRAY_LENGTH ||
					i.sortKey !== n) &&
					((i = {
			...
			(zi.MAX_VERTEX_ARRAY_LENGTH = Math.pow(2, 16) - 1),
			sn("SegmentVector", zi);
		var Bi = function () {
		...
		(ji.prototype.defines = function () {
			...
			(ji.serialize = function (t) {
				var e = t.value,
					r = t.names,
					n = t.type;
				return { value: ln(e), names: r, type: n };
			}),
		...
		(Ri.prototype.defines = function () {
			...
			(Ri.prototype.setConstantPatternPositions = function (t, e) {
		...
		(qi.prototype.defines = function () {
			...
			(qi.prototype.populatePaintArray = function (t, e) {
				var r = this.paintVertexArray,
					n = r.length;
				r.reserve(t);
				var i = this.expression.evaluate(new Sn(0), e, {});
				if ("color" === this.type)
					for (var a = Ui(i), o = n; o < t; o++) r.emplaceBack(a[0], a[1]);
				else {
			...
			(qi.prototype.updatePaintArray = function (t, e, r, n) {
				...
				if ("color" === this.type)
					for (var o = Ui(a), s = t; s < e; s++) i.emplace(s, o[0], o[1]);
				else {
		...
		(Ni.prototype.defines = function () {
			...
			(Ni.prototype.populatePaintArray = function (t, e) {
				...
				if ("color" === this.type)
					for (var o = Ui(i), s = Ui(a), u = n; u < t; u++)
			...
			(Ni.prototype.updatePaintArray = function (t, e, r, n) {
				...
				if ("color" === this.type)
					for (var s = Ui(a), u = Ui(o), l = t; l < e; l++)
		...
		(Ki.prototype.defines = function () {
			...
			(Ki.prototype.populatePaintArray = function (t, e, r) {
		...
		(Gi.createDynamic = function (t, e, r) {
					...
					if (o instanceof Vn && er(o.property.specification)) {
						...
						if (
							...
							if ("constant" === o.value.kind)
								(n.binders[a] = new Ri(o.value.value, s, u)), i.push("/u_" + a);
							else {
								var p = Hi(a, u, "source");
								(n.binders[a] = new Ki(o.value, s, u, l, e, p, t.id)),
									i.push("/a_" + a);
							}
						else if ("constant" === o.value.kind)
							(n.binders[a] = new ji(o.value.value, s, u)), i.push("/u_" + a);
						else if ("source" === o.value.kind) {
							var c = Hi(a, u, "source");
							(n.binders[a] = new qi(o.value, s, u, c)), i.push("/a_" + a);
						} else {
							var h = Hi(a, u, "composite");
							(n.binders[a] = new Ni(o.value, s, u, l, e, h)),
								i.push("/z_" + a);
						}
					}
				}
			...
			(Gi.prototype.updatePaintArrays = function (t, e, r, n) {
				...
				for (var a in t)
					for (
						var o = 0, s = this._featureMap.getPositions(+a);
						o < s.length;
						o += 1
					) {
						var u = s[o],
						...
						for (var p in this.binders) {
							...
							if (
								!(c instanceof ji || c instanceof Ri) &&
								!0 === c.expression.isStateDependent
							) {
								var h = r.paint.get(p);
			...
			(Gi.prototype.setUniforms = function (t, e, r, n) {
				for (var i in this.binders)
					for (
						var a = this.binders[i], o = 0, s = a.uniformNames;
						o < s.length;
						o += 1
					) {
						var u = s[o];
			...
			(Gi.prototype.updatePatternPaintBuffers = function (t) {
				...
				for (var r in this.binders) {
					...
					if (n instanceof Ki) {
						...
						(n instanceof qi || n instanceof Ni) &&
							n.paintVertexBuffer &&
			...
			(Gi.prototype.upload = function (t) {
				...
				for (var n in this.binders) {
					...
					(i instanceof qi || i instanceof Ni) &&
						i.paintVertexBuffer &&
		...
		var Xi = function (t, e, r, n) {
			...
			for (var i = 0, a = e; i < a.length; i += 1) {
				var o = a[i];
				(this.programConfigurations[o.id] = Gi.createDynamic(o, r, n)),
		...
		function Hi(t, e, r) {
			var n = {
					color: { source: pi, composite: ci },
					number: { source: ii, composite: pi },
				},
				i = (function (t) {
					return {
						"line-pattern": { source: Yn, composite: Yn },
						"fill-pattern": { source: Yn, composite: Yn },
						"fill-extrusion-pattern": { source: Yn, composite: Yn },
					}[t];
				})(t);
			return (i && i[r]) || n[e][r];
		}
		(Xi.prototype.populatePaintArrays = function (t, e, r, n) {
			...
			(Xi.prototype.updatePaintArrays = function (t, e, r, n) {
				for (var i = 0, a = r; i < a.length; i += 1) {
					var o = a[i];
					this.needsUpload =
						this.programConfigurations[o.id].updatePaintArrays(t, e, o, n) ||
						this.needsUpload;
				}
			}),
			...
			sn("ConstantBinder", ji),
			sn("CrossFadedConstantBinder", Ri),
			sn("SourceExpressionBinder", qi),
			sn("CrossFadedCompositeBinder", Ki),
			sn("CompositeExpressionBinder", Ni),
			sn("ProgramConfiguration", Gi, { omit: ["_buffers"] }),
			sn("ProgramConfigurationSet", Xi);
		var Yi = 8192;
		var Ji,
			$i =
				((Ji = 16),
				{ min: -1 * Math.pow(2, Ji - 1), max: Math.pow(2, Ji - 1) - 1 });
		function Wi(t) {
			for (
				var e = Yi / t.extent, r = t.loadGeometry(), n = 0;
				n < r.length;
				n++
			)
				for (var i = r[n], a = 0; a < i.length; a++) {
					...
					(o.x = Math.round(o.x * e)),
						...
						(o.x < $i.min || o.x > $i.max || o.y < $i.min || o.y > $i.max) &&
							w(
		...
		var ta = function (t) {
			(this.zoom = t.zoom),
				...
				(this.index = t.index),
				(this.hasPattern = !1),
				(this.layoutVertexArray = new Gn()),
				(this.indexArray = new si()),
				(this.segments = new zi()),
				(this.programConfigurations = new Xi(ki, t.layers, t.zoom)),
		...
		function na(t, e) {
			...
			for (var r = 0; r < e.length; r++)
				for (var n = e[r], i = 0; i < n.length; i++) if (pa(t, n[i])) return !0;
					...
					for (var a = 0, o = i[n]; a < o.length; a += 1) {
						...
						if (!(u < 0 || u >= Yi || l < 0 || l >= Yi)) {
							var p = this.segments.prepareSegment(
								...
								c = p.vertexLength;
							Qi(this.layoutVertexArray, u, l, -1, -1),
								Qi(this.layoutVertexArray, u, l, 1, -1),
								Qi(this.layoutVertexArray, u, l, 1, 1),
								Qi(this.layoutVertexArray, u, l, -1, 1),
		...
		var da = {
				paint: new Dn({
					...
					"circle-translate-anchor": new Mn(
						mt.paint_circle["circle-translate-anchor"],
					),
					"circle-pitch-scale": new Mn(mt.paint_circle["circle-pitch-scale"]),
					"circle-pitch-alignment": new Mn(
						mt.paint_circle["circle-pitch-alignment"],
					),
					...
					"circle-stroke-opacity": new Tn(
						mt.paint_circle["circle-stroke-opacity"],
					),
				}),
			},
			ma = 1e-6,
		...
		function ka() {
			var t = new va(4);
			return (
				va != Float32Array && ((t[0] = 0), (t[1] = 0), (t[2] = 0)),
				(t[3] = 1),
				t
			);
		}
		...
		!(function () {
			var t,
				e =
					((t = new va(2)), va != Float32Array && ((t[0] = 0), (t[1] = 0)), t);
		})();
		var Ta = (function (t) {
			function e(e) {
				t.call(this, e, da);
			...
			return (
				...
				(e.prototype.queryRadius = function (t) {
					var e = t;
					return (
						ha("circle-radius", this, e) +
						ha("circle-stroke-width", this, e) +
						fa(this.paint.get("circle-translate"))
					);
				}),
				(e.prototype.queryIntersectsFeature = function (
					...
					for (
						var u = ya(
							...
							p = "map" === this.paint.get("circle-pitch-alignment"),
							c = p
								? u
								: (function (t, e) {
		...
		function Na(t, e) {
			for (
				var r = new Uint8Array(1024), n = {}, i = 0, a = 0;
				i < 256;
				i++, a += 4
			) {
				n[e] = i / 255;
			...
			return new Ra({ width: 256, height: 1 }, r);
		}
		var Ka = (function (t) {
				function e(e) {
					...
					(e.prototype._updateColorRamp = function () {
						var t =
							this._transitionablePaint._values["heatmap-color"].value
								.expression;
						(this.colorRamp = Na(t, "heatmapDensity")),
			...
			Ga = {
				paint: new Dn({
					"hillshade-illumination-direction": new Mn(
						mt.paint_hillshade["hillshade-illumination-direction"],
					),
					"hillshade-illumination-anchor": new Mn(
						mt.paint_hillshade["hillshade-illumination-anchor"],
					),
					"hillshade-exaggeration": new Mn(
						mt.paint_hillshade["hillshade-exaggeration"],
					),
					"hillshade-shadow-color": new Mn(
						mt.paint_hillshade["hillshade-shadow-color"],
					),
					"hillshade-highlight-color": new Mn(
						mt.paint_hillshade["hillshade-highlight-color"],
					),
					"hillshade-accent-color": new Mn(
						mt.paint_hillshade["hillshade-accent-color"],
					),
				}),
			},
			Xa = (function (t) {
			...
			Za = Nn([{ name: "a_pos", components: 2, type: "Int16" }], 4),
			Ha = Za.members,
					...
					(h = (function (t, e, r, n) {
						...
						for (i = 0, a = e.length; i < a; i++)
							(o = e[i] * n),
								...
								l.push(uo(u));
						for (l.sort(ao), i = 0; i < l.length; i++)
							oo(l[i], r), (r = Qa(r, r.next));
						return r;
					})(t, e, h, r)),
				t.length > 80 * r)
			) {
		...
		function Wa(t, e, r, n, i) {
			var a, o;
			if (i === bo(t, e, r, n) > 0)
				for (a = e; a < r; a += n) o = vo(a, t[a], t[a + 1], o);
		...
		function Qa(t, e) {
			...
			do {
				if (
					((r = !1),
					n.steiner || (!ho(n, n.next) && 0 !== co(n.prev, n, n.next)))
				)
					n = n.next;
				else {
		...
		function to(t, e, r, n, i, a, o) {
			if (t) {
				...
				for (var s, u, l = t; t.prev !== t.next; )
					if (((s = t.prev), (u = t.next), a ? ro(t, n, i, a) : eo(t)))
						e.push(s.i / r),
							e.push(t.i / r),
							e.push(u.i / r),
							go(t),
		...
		function eo(t) {
			...
			for (var i = t.next.next; i !== t.prev; ) {
				if (
					lo(e.x, e.y, r.x, r.y, n.x, n.y, i.x, i.y) &&
					co(i.prev, i, i.next) >= 0
				)
					return !1;
				i = i.next;
			}
		...
		function ro(t, e, r, n) {
			...
			for (
				var s = i.x < a.x ? (i.x < o.x ? i.x : o.x) : a.x < o.x ? a.x : o.x,
					...
					p = i.y > a.y ? (i.y > o.y ? i.y : o.y) : a.y > o.y ? a.y : o.y,
					c = so(s, u, e, r, n),
					h = so(l, p, e, r, n),
					f = t.prevZ,
					y = t.nextZ;
				...
				if (
					f !== t.prev &&
					f !== t.next &&
					lo(i.x, i.y, a.x, a.y, o.x, o.y, f.x, f.y) &&
				...
				if (
					...
					y !== t.prev &&
						y !== t.next &&
						lo(i.x, i.y, a.x, a.y, o.x, o.y, y.x, y.y) &&
						co(y.prev, y, y.next) >= 0)
				)
					return !1;
				y = y.nextZ;
			}
				...
				(e = (function (t, e) {
					...
					for (; n !== l; )
						i >= n.x &&
							n.x >= p &&
							i !== n.x &&
							lo(a < c ? i : o, a, p, c, a < c ? o : i, a, n.x, n.y) &&
							((u = Math.abs(a - n.y) / (i - n.x)) < h ||
								(u === h && n.x > r.x)) &&
							yo(n, t) &&
							((r = n), (h = u)),
							(n = n.next);
		...
		function fo(t, e, r, n) {
			return (
				!!((ho(t, e) && ho(r, n)) || (ho(t, n) && ho(r, e))) ||
				(co(t, e, r) > 0 != co(t, e, n) > 0 &&
					co(r, n, t) > 0 != co(r, n, e) > 0)
			);
		}
		function yo(t, e) {
		...
		function So(t, e) {
			...
			if ((n && a.push(n), e > 1))
				for (var u = 0; u < a.length; u++)
					a[u].length <= e ||
						(_o(a[u], e, 1, a[u].length - 1, ko), (a[u] = a[u].slice(0, e)));
			return a;
		}
		function ko(t, e) {
		...
		function Io(t, e, r, n, i) {
			for (var a = i.patternDependencies, o = 0, s = e; o < s.length; o += 1) {
				...
				if ("constant" !== l.kind) {
					var p = l.evaluate({ zoom: n - 1 }, r, {}),
						c = l.evaluate({ zoom: n }, r, {}),
						h = l.evaluate({ zoom: n + 1 }, r, {});
					(a[p] = !0),
						(a[c] = !0),
						(a[h] = !0),
						(r.patterns[u.id] = { min: p, mid: c, max: h });
				}
			}
			return r;
		}
		...
		var Bo = function (t) {
			(this.zoom = t.zoom),
				...
				(this.layoutVertexArray = new Gn()),
				(this.indexArray = new si()),
				(this.indexArray2 = new ui()),
				(this.programConfigurations = new Xi(Ha, t.layers, t.zoom)),
				(this.segments = new zi()),
				(this.segments2 = new zi()),
				(this.stateDependentLayerIds = this.layers
					.filter(function (t) {
						return t.isStateDependent();
					})
			...
			for (var r = 0, n = t; r < n.length; r += 1) {
				...
				if (this.layers[0]._featureFilter(new Sn(this.zoom), a)) {
					...
					void 0 !== a.id && (l.id = a.id),
						this.hasPattern
							? this.features.push(Io("fill", this.layers, l, this.zoom, e))
							: this.addFeature(l, u, o, {}),
						e.featureIndex.insert(a, u, o, s, this.index);
				}
			}
		}),
				...
				for (var i = 0, a = So(e, 500); i < a.length; i += 1) {
					...
					for (
						...
						if (0 !== m.length) {
							...
							var v = this.segments2.prepareSegment(
									m.length,
									this.layoutVertexArray,
									this.indexArray2,
								),
							...
							for (var x = 1; x < m.length; x++)
								this.layoutVertexArray.emplaceBack(m[x].x, m[x].y),
					...
					for (var b = Ya(h, f), _ = 0; _ < b.length; _ += 3)
		...
		var Eo = {
				paint: new Dn({
					...
					"fill-translate-anchor": new Mn(
						mt.paint_fill["fill-translate-anchor"],
					),
		...
		var Fo = function (t) {
			(this.zoom = t.zoom),
				...
				(this.indexArray = new si()),
				(this.programConfigurations = new Xi(Co, t.layers, t.zoom)),
				(this.segments = new zi()),
				(this.stateDependentLayerIds = this.layers
					.filter(function (t) {
						return t.isStateDependent();
		...
		function Lo(t, e) {
			return (
				(t.x === e.x && (t.x < 0 || t.x > Yi)) ||
				(t.y === e.y && (t.y < 0 || t.y > Yi))
			);
		}
		function Oo(t) {
			return (
		...
		(Fo.prototype.populate = function (t, e) {
			...
			for (var r = 0, n = t; r < n.length; r += 1) {
				...
				if (this.layers[0]._featureFilter(new Sn(this.zoom), a)) {
					...
					void 0 !== a.id && (l.id = a.id),
						this.hasPattern
							? this.features.push(
									Io("fill-extrusion", this.layers, l, this.zoom, e),
								)
							: this.addFeature(l, u, o, {}),
			...
			(Fo.prototype.addFeature = function (t, e, r, n) {
				for (var i = 0, a = So(e, 500); i < a.length; i += 1) {
						...
						if (0 !== f.length && !Oo(f))
							for (var y = 0, d = 0; d < f.length; d++) {
								...
								if (d >= 1) {
									var v = f[d - 1];
									if (!Lo(m, v)) {
										p.vertexLength + 4 > zi.MAX_VERTEX_ARRAY_LENGTH &&
										...
										var g = m.sub(v)._perp()._unit(),
											x = v.dist(m);
										y + x > 32768 && (y = 0),
											To(this.layoutVertexArray, m.x, m.y, g.x, g.y, 0, 0, y),
											To(this.layoutVertexArray, m.x, m.y, g.x, g.y, 0, 1, y),
											(y += x),
											To(this.layoutVertexArray, v.x, v.y, g.x, g.y, 0, 0, y),
											To(this.layoutVertexArray, v.x, v.y, g.x, g.y, 0, 1, y);
					...
					p.vertexLength + s > zi.MAX_VERTEX_ARRAY_LENGTH &&
						(p = this.segments.prepareSegment(
							s,
							this.layoutVertexArray,
							this.indexArray,
					...
					for (
						var _ = [], w = [], A = p.vertexLength, S = 0, k = o;
						S < k.length;
						S += 1
					) {
						var z = k[S];
						if (0 !== z.length) {
							...
							for (var I = 0; I < z.length; I++) {
								var B = z[I];
								To(this.layoutVertexArray, B.x, B.y, 0, 0, 1, 1, 0),
									_.push(B.x),
									_.push(B.y);
							}
						}
					}
					for (var E = Ya(_, w), P = 0; P < E.length; P += 3)
						this.indexArray.emplaceBack(A + E[P], A + E[P + 2], A + E[P + 1]);
		...
		var Do = {
				paint: new Dn({
					"fill-extrusion-opacity": new Mn(
						mt["paint_fill-extrusion"]["fill-extrusion-opacity"],
					),
					"fill-extrusion-color": new Tn(
						mt["paint_fill-extrusion"]["fill-extrusion-color"],
					),
					"fill-extrusion-translate": new Mn(
						mt["paint_fill-extrusion"]["fill-extrusion-translate"],
					),
					"fill-extrusion-translate-anchor": new Mn(
						mt["paint_fill-extrusion"]["fill-extrusion-translate-anchor"],
					),
					"fill-extrusion-pattern": new Fn(
						mt["paint_fill-extrusion"]["fill-extrusion-pattern"],
					),
					"fill-extrusion-height": new Tn(
						mt["paint_fill-extrusion"]["fill-extrusion-height"],
					),
					"fill-extrusion-base": new Tn(
						mt["paint_fill-extrusion"]["fill-extrusion-base"],
					),
					"fill-extrusion-vertical-gradient": new Mn(
						mt["paint_fill-extrusion"]["fill-extrusion-vertical-gradient"],
					),
				}),
			},
			Uo = (function (t) {
				...
				return (
					...
					(e.prototype.hasOffscreenPass = function () {
						return (
							0 !== this.paint.get("fill-extrusion-opacity") &&
							"none" !== this.visibility
						);
					}),
					(e.prototype.resize = function () {
						this.viewportFrame &&
							(this.viewportFrame.destroy(), (this.viewportFrame = null));
					}),
					e
				);
			})(Un);
		...
		(Go.types = ["Unknown", "Point", "LineString", "Polygon"]),
			(Go.prototype.loadGeometry = function () {
				var t = this._pbf;
				t.pos = this._geometry;
				for (
					var e, r = t.readVarint() + t.pos, n = 1, a = 0, o = 0, s = 0, u = [];
					t.pos < r;
		...
		function is(t, e, r, n, i, a, o) {
			t.emplaceBack(
				...
				n ? 1 : 0,
				i ? 1 : -1,
				Math.round(ts * r.x) + 128,
				Math.round(ts * r.y) + 128,
				(1 + (0 === a ? 0 : a < 0 ? -1 : 1)) | (((o * rs) & 63) << 2),
				(o * rs) >> 6,
			);
		}
		var as = function (t) {
			(this.zoom = t.zoom),
				...
				(this.indexArray = new si()),
				(this.programConfigurations = new Xi(No, t.layers, t.zoom)),
				(this.segments = new zi()),
				(this.stateDependentLayerIds = this.layers
					.filter(function (t) {
						return t.isStateDependent();
		...
		(as.prototype.populate = function (t, e) {
			...
			for (var r = 0, n = t; r < n.length; r += 1) {
				...
				if (this.layers[0]._featureFilter(new Sn(this.zoom), a)) {
					...
					void 0 !== a.id && (l.id = a.id),
						this.hasPattern
							? this.features.push(Io("line", this.layers, l, this.zoom, e))
							: this.addFeature(l, u, o, {}),
						e.featureIndex.insert(a, u, o, s, this.index);
				}
			}
			...
			(as.prototype.addLine = function (t, e, r, n, i, a, o, s) {
				...
				for (
					var l = "Polygon" === Qo[e.type], p = t.length;
				...
				if (!(p < (l ? 3 : 2))) {
					...
					var h = (Yi / (512 * this.overscaling)) * 15,
						f = t[c],
						y = this.segments.prepareSegment(
							10 * p,
							this.layoutVertexArray,
							this.indexArray,
						);
					...
					for (var k = c; k < p; k++)
						if (
							...
							if (
								(C &&
									"round" === M &&
									(B < a ? (M = "miter") : B <= 2 && (M = "fakeround")),
								"miter" === M && B > i && (M = "bevel"),
								"bevel" === M &&
									(B > 2 && (M = "flipbevel"), B < i && (M = "miter")),
								_ && (this.distance += d.dist(_)),
								"miter" === M)
							)
								z._mult(B),
								...
								if (
									(L ? ((v = 0), (m = O)) : ((m = 0), (v = O)),
									b ||
										this.addCurrentVertex(d, this.distance, A, m, v, !1, y, u),
									"fakeround" === M)
								) {
									for (
										var D = Math.floor(8 * (0.5 - (I - 0.5))),
											U = void 0,
											j = 0;
										j < D;
										j++
										...
										(U = S.mult((j + 1) / (D + 1))
											._add(A)
											._unit()),
											this.addPieSliceVertex(d, this.distance, U, L, y, u);
								...
								w &&
									this.addCurrentVertex(d, this.distance, S, -m, -v, !1, y, u);
							} else
								"butt" === M
									? (b ||
											this.addCurrentVertex(
			...
			(as.prototype.addCurrentVertex = function (t, e, r, n, i, a, o, s) {
				...
				s && (e = os(e, s)),
					...
					this.e1 >= 0 &&
						this.e2 >= 0 &&
						(p.emplaceBack(this.e1, this.e2, this.e3), o.primitiveLength++),
					(this.e1 = this.e2),
					(this.e2 = this.e3),
					(u = r.mult(-1)),
					...
					e > ns / 2 &&
						!s &&
						((this.distance = 0),
						this.addCurrentVertex(t, this.distance, r, n, i, a, o));
			}),
			(as.prototype.addPieSliceVertex = function (t, e, r, n, i, a) {
				...
				a && (e = os(e, a)),
					...
					this.e1 >= 0 &&
						this.e2 >= 0 &&
						(s.emplaceBack(this.e1, this.e2, this.e3), i.primitiveLength++),
		...
		var ss = new Dn({
			...
			us = {
				paint: new Dn({
					...
					"line-translate-anchor": new Mn(
						mt.paint_line["line-translate-anchor"],
					),
		...
		var ps = (function (t) {
			...
			return (
				...
				(e.prototype._updateGradient = function () {
					...
					(this.gradient = Na(t, "lineProgress")),
						(this.gradientTexture = null);
				}),
				(e.prototype.recalculate = function (e) {
					t.prototype.recalculate.call(this, e),
						(this.paint._values["line-floorwidth"] = ls.possiblyEvaluate(
					...
					return (
						...
						(function (t, e, r) {
							for (var n = 0; n < e.length; n++) {
								var i = e[n];
								if (t.length >= 3)
									for (var a = 0; a < i.length; a++) if (pa(t, i[a])) return !0;
		...
		var hs = Nn([
			...
			fs = Nn([{ name: "a_projected_pos", components: 3, type: "Float32" }], 4),
			ys =
				(Nn([{ name: "a_fade_opacity", components: 1, type: "Uint32" }], 4),
				Nn([{ name: "a_placed", components: 2, type: "Uint8" }], 4)),
			ds =
				(Nn([
				...
				t.sections.forEach(function (t) {
					t.text = (function (t, e, r) {
						...
						return (
							...
							An.applyArabicShaping && (t = An.applyArabicShaping(t)),
							t
						);
					})(t.text, e, r);
				}),
		...
		function _s(t, e) {
			...
			if ("source" === r.kind) return { functionType: "source" };
			for (var n = r.zoomStops, i = 0; i < n.length && n[i] <= t; ) i++;
			for (var a = (i = Math.max(0, i - 1)); a < n.length && n[a] < t + 1; )
				a++;
			a = Math.min(n.length - 1, a);
			var o = { min: n[i], max: n[a] };
			return "composite" === r.kind
				? { functionType: "composite", zoomRange: o, propertyValue: e.value }
				: {
						functionType: "camera",
						layoutSize: r.evaluate(new Sn(t + 1)),
						zoomRange: o,
		...
		var zs = function (t) {
			(this.layoutVertexArray = new Jn()),
				(this.indexArray = new si()),
				(this.programConfigurations = t),
				(this.segments = new zi()),
				(this.dynamicLayoutVertexArray = new $n()),
				(this.opacityVertexArray = new Wn()),
				(this.placedSymbolArray = new di());
		};
		...
		var Is = function (t, e, r) {
			(this.layoutVertexArray = new t()),
				...
				(this.segments = new zi()),
				(this.collisionVertexArray = new ei());
		};
		...
		var Bs = function (t) {
			...
			(this.textSizeData = _s(this.zoom, e["text-size"])),
				(this.iconSizeData = _s(this.zoom, e["icon-size"]));
		...
		(Bs.prototype.createArrays = function () {
			(this.text = new zs(
				new Xi(hs.members, this.layers, this.zoom, function (t) {
					return /^text/.test(t);
				}),
			)),
				(this.icon = new zs(
				...
				(this.collisionBox = new Is(ti, ds.members, ui)),
				(this.collisionCircle = new Is(ti, ms.members, si)),
				(this.glyphOffsetArray = new xi()),
				(this.lineVertexArray = new _i()),
				(this.symbolInstances = new vi());
		}),
				...
				if (((this.features = []), s || u)) {
					for (
						...
						if (r._featureFilter(h, m)) {
							...
							var _ = void 0;
							if (
								(u && (_ = r.getValueAndResolveTokens("icon-image", m)), x || _)
							) {
								...
								if (
									(void 0 !== m.id && (A.id = m.id),
									this.features.push(A),
									_ && (p[_] = !0),
									x)
								)
									for (
										var S = i.evaluate(m, {}).join(","),
											k =
			...
			(Bs.prototype.upload = function (t) {
				this.uploaded ||
					(this.collisionBox.upload(t), this.collisionCircle.upload(t)),
					this.text.upload(
						t,
						this.sortFeaturesByY,
						!this.uploaded,
			...
			(Bs.prototype.addSymbols = function (t, e, r, n, i, a, o, s, u, l) {
				for (
					...
					var g = v[m],
						...
						S = f.vertexLength,
						k = g.glyphOffset[1];
					Ss(c, s.x, s.y, x.x, k + x.y, A.x, A.y, r),
						Ss(c, s.x, s.y, b.x, k + b.y, A.x + A.w, A.y, r),
						Ss(c, s.x, s.y, _.x, k + _.y, A.x, A.y + A.h, r),
						Ss(c, s.x, s.y, w.x, k + w.y, A.x + A.w, A.y + A.h, r),
						ks(h, s, 0),
			...
			(Bs.prototype.addCollisionDebugVertices = function (
				t,
				e,
				r,
				n,
				...
				var l = a.segments.prepareSegment(4, a.layoutVertexArray, a.indexArray),
					...
					y = s.anchorY;
				if (
					(this._addCollisionDebugVertex(c, h, o, f, y, new i(t, e)),
					this._addCollisionDebugVertex(c, h, o, f, y, new i(r, e)),
					this._addCollisionDebugVertex(c, h, o, f, y, new i(r, n)),
					this._addCollisionDebugVertex(c, h, o, f, y, new i(t, n)),
					(l.vertexLength += 4),
					u)
				) {
					var d = a.indexArray;
			...
			(Bs.prototype.addDebugCollisionBoxes = function (t, e, r) {
				for (var n = t; n < e; n++) {
					...
					this.addCollisionDebugVertices(
						...
						s,
						u,
						l ? this.collisionCircle : this.collisionBox,
						i.anchorPoint,
						r,
						l,
					);
			...
			(Bs.prototype._deserializeCollisionBoxesForSymbol = function (
				t,
				e,
				r,
				n,
				...
				for (var a = {}, o = e; o < r; o++) {
					...
					a.textCircles ||
						((a.textCircles = []), (a.textFeatureIndex = s.featureIndex));
					a.textCircles.push(
						s.anchorPointX,
						s.anchorPointY,
						s.radius,
			...
			(Bs.prototype.addIndicesForPlacedTextSymbol = function (t) {
				for (
					var e = this.text.placedSymbolArray.get(t),
						r = e.vertexStartIndex + 4 * e.numGlyphs,
						n = e.vertexStartIndex;
					n < r;
					n += 4
				)
					this.text.indexArray.emplaceBack(n, n + 1, n + 2),
			...
			(Bs.prototype.sortFeatures = function (t) {
				if (
					...
					for (var e = [], r = 0; r < this.symbolInstances.length; r++)
						e.push(r);
					for (
						var n = Math.sin(t), i = Math.cos(t), a = [], o = [], s = 0;
						s < this.symbolInstances.length;
						s++
					) {
						var u = this.symbolInstances.get(s);
						a.push(0 | Math.round(n * u.anchorX + i * u.anchorY)),
							o.push(u.featureIndex);
					}
					e.sort(function (t, e) {
					...
					for (var l = 0, p = e; l < p.length; l += 1) {
						...
						this.featureSortOrder.push(h.featureIndex),
							h.horizontalPlacedTextSymbolIndex >= 0 &&
								this.addIndicesForPlacedTextSymbol(
									h.horizontalPlacedTextSymbolIndex,
								),
							h.verticalPlacedTextSymbolIndex >= 0 &&
								this.addIndicesForPlacedTextSymbol(
						...
						if (f.numGlyphs) {
							...
							this.icon.indexArray.emplaceBack(y, y + 1, y + 2),
								this.icon.indexArray.emplaceBack(y + 1, y + 2, y + 3);
						}
					}
		...
		var Es = new Dn({
				...
				"icon-ignore-placement": new Mn(
					mt.layout_symbol["icon-ignore-placement"],
				),
				"icon-optional": new Mn(mt.layout_symbol["icon-optional"]),
				"icon-rotation-alignment": new Mn(
					mt.layout_symbol["icon-rotation-alignment"],
				),
				"icon-size": new Tn(mt.layout_symbol["icon-size"]),
				"icon-text-fit": new Mn(mt.layout_symbol["icon-text-fit"]),
				"icon-text-fit-padding": new Mn(
					mt.layout_symbol["icon-text-fit-padding"],
				),
				...
				"icon-pitch-alignment": new Mn(
					mt.layout_symbol["icon-pitch-alignment"],
				),
				"text-pitch-alignment": new Mn(
					mt.layout_symbol["text-pitch-alignment"],
				),
				"text-rotation-alignment": new Mn(
					mt.layout_symbol["text-rotation-alignment"],
				),
				...
				"text-ignore-placement": new Mn(
					mt.layout_symbol["text-ignore-placement"],
				),
			...
			Ps = {
				paint: new Dn({
					...
					"icon-translate-anchor": new Mn(
						mt.paint_symbol["icon-translate-anchor"],
					),
					...
					"text-translate-anchor": new Mn(
						mt.paint_symbol["text-translate-anchor"],
					),
				}),
				layout: Es,
			},
			Vs = (function (t) {
				...
				return (
					...
					(e.prototype.getValueAndResolveTokens = function (t, e) {
						...
						return i.isDataDriven() || yr(i.value)
							? n
							: ((r = e.properties),
			...
			Cs = {
				paint: new Dn({
					...
					"background-pattern": new Ln(
						mt.paint_background["background-pattern"],
					),
					"background-opacity": new Mn(
						mt.paint_background["background-opacity"],
					),
				}),
			},
			Ms = (function (t) {
			...
			Ts = {
				paint: new Dn({
					...
					"raster-brightness-min": new Mn(
						mt.paint_raster["raster-brightness-min"],
					),
					"raster-brightness-max": new Mn(
						mt.paint_raster["raster-brightness-max"],
					),
					...
					"raster-fade-duration": new Mn(
						mt.paint_raster["raster-fade-duration"],
					),
				}),
			},
			Fs = (function (t) {
		...
		var Ls = (function (t) {
				...
				return (
					...
					(e.prototype.hasOffscreenPass = function () {
						return (
							void 0 !== this.implementation.prerender ||
					...
					if (!(c.w > f.w || c.h > f.h)) {
						if (
							...
							c.h === f.h
								...
								: c.w === f.w
									? ((f.y += c.h), (f.h -= c.h))
									: (o.push({ x: f.x + c.w, y: f.y, w: f.w - c.w, h: c.h }),
										(f.y += c.h),
										(f.h -= c.h));
						break;
					}
		...
		var Rs = function (t, e) {
			...
			for (var a in t) {
				var o = t[a],
					s = { x: 0, y: 0, w: o.data.width + 2, h: o.data.height + 2 };
				i.push(s), (r[a] = new Us(s, o));
			}
			for (var u in e) {
				var l = e[u],
					p = { x: 0, y: 0, w: l.data.width + 2, h: l.data.height + 2 };
				i.push(p), (n[u] = new Us(p, l));
			}
			var c = Ds(i),
				h = c.w,
				f = c.h,
				y = new Ra({ width: h || 1, height: f || 1 });
			for (var d in t) {
				var m = t[d],
					v = r[d].paddedRect;
				Ra.copy(m.data, y, { x: 0, y: 0 }, { x: v.x + 1, y: v.y + 1 }, m.data);
			}
			for (var g in e) {
				var x = e[g],
					b = n[g].paddedRect,
					...
					A = x.data.width,
					S = x.data.height;
				Ra.copy(x.data, y, { x: 0, y: 0 }, { x: _, y: w }, x.data),
					Ra.copy(
						x.data,
						y,
						{ x: 0, y: S - 1 },
			...
			(this.useMipmap = Boolean(e && e.useMipmap)),
				...
				i
					...
					: t instanceof qs ||
						  ...
						  t instanceof Ks ||
						  t instanceof Gs
						? o.texSubImage2D(o.TEXTURE_2D, 0, 0, 0, o.RGBA, o.UNSIGNED_BYTE, t)
						: o.texSubImage2D(
								o.TEXTURE_2D,
								0,
								0,
		...
		var Zs = function (t, e, r, n, i) {
				var a,
					...
					f = t[e + c];
				for (
					c += h, a = f & ((1 << -p) - 1), f >>= -p, p += s;
					p > 0;
					a = 256 * a + t[e + c], c += h, p -= 8
				);
				for (
					o = a & ((1 << -p) - 1), a >>= -p, p += n;
					p > 0;
					o = 256 * o + t[e + c], c += h, p -= 8
				);
				if (0 === a) a = 1 - l;
				else {
					...
					e = Math.abs(e),
						isNaN(e) || e === 1 / 0
							...
							: ((o = Math.floor(Math.log(e) / Math.LN2)),
								...
								(e += o + c >= 1 ? h / u : h * Math.pow(2, 1 - c)) * u >= 2 &&
									(o++, (u /= 2)),
								o + c >= p
									? ((s = 0), (o = p))
									: o + c >= 1
										? ((s = (e * u - 1) * Math.pow(2, i)), (o += c))
										: ((s = e * Math.pow(2, c - 1) * Math.pow(2, i)), (o = 0)));
					i >= 8;
					t[r + f] = 255 & s, f += y, s /= 256, i -= 8
				);
				for (
					o = (o << i) | s, l += i;
					l > 0;
					t[r + f] = 255 & o, f += y, o /= 256, l -= 8
				);
				t[r + f - y] |= 128 * d;
			},
			Ys = Js;
		...
		Js.prototype = {
			...
			readFixed64: function () {
				var t =
					lu(this.buf, this.pos) + 4294967296 * lu(this.buf, this.pos + 4);
				return (this.pos += 8), t;
			},
			readSFixed64: function () {
				var t =
					lu(this.buf, this.pos) + 4294967296 * cu(this.buf, this.pos + 4);
				return (this.pos += 8), t;
			},
			readFloat: function () {
											...
											r < 128
												...
												: (function (t, e, r) {
														var n,
															...
															a = r.buf;
														if (
															((i = a[r.pos++]), (n = (112 & i) >> 4), i < 128)
														)
															return Ws(t, n, e);
														if (
															((i = a[r.pos++]), (n |= (127 & i) << 3), i < 128)
														)
															return Ws(t, n, e);
														if (
															((i = a[r.pos++]),
			...
			skip: function (t) {
				...
				else if (e === Js.Bytes) this.pos = this.readVarint() + this.pos;
				else if (e === Js.Fixed32) this.pos += 4;
				else {
			...
			writeFixed64: function (t) {
				this.realloc(8),
					pu(this.buf, -1 & t, this.pos),
					pu(this.buf, Math.floor(t * (1 / 4294967296)), this.pos + 4),
					(this.pos += 8);
			},
				...
				this.pos = (function (t, e, r) {
					for (var n, i, a = 0; a < e.length; a++) {
						if ((n = e.charCodeAt(a)) > 55295 && n < 57344) {
							...
							i && ((t[r++] = 239), (t[r++] = 191), (t[r++] = 189), (i = null));
						n < 128
							? (t[r++] = n)
							: (n < 2048
									? (t[r++] = (n >> 6) | 192)
		...
		function yu(t, e, r) {
			if (3 === t) {
				...
				e.push({
					id: i,
					bitmap: new ja({ width: o + 2 * hu, height: s + 2 * hu }, a),
		...
		(vu.prototype.send = function (t, e, r, n) {
			...
			(vu.prototype.receive = function (t) {
				...
				if (!n.targetMapId || this.mapId === n.targetMapId) {
					...
					if ("<response>" === n.type || "<cancel>" === n.type)
						(e = this.callbacks[n.id]),
							delete this.callbacks[n.id],
							e && n.error ? e(pn(n.error)) : e && e(null, pn(n.data));
						...
						var s = n.type.split("."),
							u = pn(n.data);
						this.parent
							.getWorkerSource(n.sourceMapId, s[0], u.source)
							[s[1]](u, a);
		...
		(xu.prototype.setNorthEast = function (t) {
			return (
				(this._ne = t instanceof bu ? new bu(t.lng, t.lat) : bu.convert(t)),
				this
			);
		}),
			(xu.prototype.setSouthWest = function (t) {
				return (
					(this._sw = t instanceof bu ? new bu(t.lng, t.lat) : bu.convert(t)),
					this
				);
			}),
			(xu.prototype.extend = function (t) {
				var e,
					...
					n = this._sw,
					i = this._ne;
				if (t instanceof bu) (e = t), (r = t);
				else {
					if (!(t instanceof xu))
						return Array.isArray(t)
							? t.every(Array.isArray)
								? this.extend(xu.convert(t))
								: this.extend(bu.convert(t))
							: this;
				...
				return (
					n || i
						...
						: ((this._sw = new bu(e.lng, e.lat)),
							(this._ne = new bu(r.lng, r.lat))),
					this
				);
			}),
		...
		(bu.prototype.wrap = function () {
			...
			(bu.convert = function (t) {
				...
				if (Array.isArray(t) && (2 === t.length || 3 === t.length))
					return new bu(Number(t[0]), Number(t[1]));
				if (!Array.isArray(t) && "object" == typeof t && null !== t)
					return new bu(Number("lng" in t ? t.lng : t.lon), Number(t.lat));
				throw new Error(
			...
			(Iu.prototype.url = function (t, e) {
				var r,
					...
					s =
						...
						(n = this.y),
						(i = this.z),
						(a = gu(256 * r, 256 * (n = Math.pow(2, i) - n - 1), i)),
						(o = gu(256 * (r + 1), 256 * (n + 1), i)),
						a[0] + "," + a[1] + "," + o[0] + "," + o[1]),
					u = (function (t, e, r) {
				...
				return t[(this.x + this.y) % t.length]
					...
					.replace(
						"{y}",
						String("tms" === e ? Math.pow(2, this.z) - this.y - 1 : this.y),
					)
					.replace("{quadkey}", u)
		...
		(Eu.prototype.equals = function (t) {
			...
			(Eu.prototype.children = function (t) {
				...
				return [
					new Eu(e, this.wrap, e, r, n),
					new Eu(e, this.wrap, e, r + 1, n),
					new Eu(e, this.wrap, e, r, n + 1),
					new Eu(e, this.wrap, e, r + 1, n + 1),
				];
			}),
			...
			sn("CanonicalTileID", Iu),
			sn("OverscaledTileID", Eu, { omit: ["posMatrix"] });
		var Vu = function (t, e, r) {
			...
			for (
				var i = e.data,
					a = "terrarium" === r ? this._unpackTerrarium : this._unpackMapbox,
					o = 0;
				o < n;
				o++
			)
		...
		(Lu.prototype.updateState = function (t, e, r) {
			...
			if (
				...
				for (var a in ((this.deletedStates[t][n] = {}), this.state[t][n]))
					r[a] || (this.deletedStates[t][n][a] = null);
			else
				for (var o in r) {
					this.deletedStates[t] &&
						this.deletedStates[t][n] &&
						null === this.deletedStates[t][n][o] &&
			...
			(Lu.prototype.removeFeatureState = function (t, e, r) {
				if (!(null === this.deletedStates[t])) {
					var n = String(e);
					if (((this.deletedStates[t] = this.deletedStates[t] || {}), r && e))
						null !== this.deletedStates[t][n] &&
							((this.deletedStates[t][n] = this.deletedStates[t][n] || {}),
					...
					if (null === this.deletedStates[o]) {
						...
						for (var l in this.deletedStates[o]) {
							if (null === this.deletedStates[o][l]) this.state[o][l] = {};
								...
								for (
									var p = 0, h = Object.keys(this.deletedStates[o][l]);
									p < h.length;
									p += 1
								) {
									var f = h[p];
		...
		var Ou = function (t, e, r) {
			(this.tileID = t),
				...
				(this.grid = e || new en(Yi, 16, 0)),
				(this.grid3D = new en(Yi, 16, 0)),
				(this.featureIndexArray = r || new Ai());
		};
		function Du(t) {
			for (
		...
		(Ou.prototype.insert = function (t, e, r, n, i, a) {
			...
			for (var s = a ? this.grid3D : this.grid, u = 0; u < e.length; u++) {
				for (
					var l = e[u], p = [1 / 0, 1 / 0, -1 / 0, -1 / 0], c = 0;
					c < l.length;
					c++
				) {
					var h = l[c];
				...
				p[0] < Yi &&
					...
					p[2] >= 0 &&
					p[3] >= 0 &&
					s.insert(o, p[0], p[1], p[2], p[3]);
			}
		}),
			(Ou.prototype.loadVTLayers = function () {
				return (
					this.vtLayers ||
						((this.vtLayers = new Wo.VectorTile(
							new Ys(this.rawTileData),
						).layers),
						(this.sourceLayerCoder = new Mu(
							this.vtLayers
			...
			(Ou.prototype.query = function (t, e, r) {
				...
				for (
					var a = t.params || {},
						...
						l = t.queryPadding * o,
						p = Du(u),
						c = this.grid.query(p.minX - l, p.minY - l, p.maxX + l, p.maxY + l),
						h = Du(t.cameraQueryGeometry),
						f = this.grid3D.query(
							h.minX - l,
							h.minY - l,
							h.maxX + l,
								...
								n.loadMatchingFeature(
									...
									function (e, i) {
										...
										return (
											e.id &&
												(a = r.getState(
													i.sourceLayer || "_geojsonTileLayer",
													e.id,
												)),
			...
			(Ou.prototype.loadMatchingFeature = function (t, e, r, n, i, a, o, s) {
				...
				if (
					...
					if (i(new Sn(this.tileID.overscaledZ), p))
							...
							if (!(a && a.indexOf(h) < 0)) {
								...
								if (f) {
									...
									if (y) {
										...
										var m = t[h];
										void 0 === m && (m = t[h] = []),
											m.push({ featureIndex: n, feature: d, intersectionZ: y });
									}
								}
							}
						}
		...
		(ju.prototype.registerFadeDuration = function (t) {
				...
				if (
					...
					for (var a in ((this.queryPadding = 0), this.buckets)) {
						...
						this.queryPadding = Math.max(
							this.queryPadding,
							e.style.getLayer(a).queryRadius(o),
						);
					}
			...
			(ju.prototype.upload = function (t) {
				...
				this.imageAtlas &&
					...
					((this.imageAtlasTexture = new Xs(t, this.imageAtlas.image, n.RGBA)),
					(this.imageAtlas.uploaded = !0)),
					this.glyphAtlasImage &&
						((this.glyphAtlasTexture = new Xs(
							t,
							this.glyphAtlasImage,
							n.ALPHA,
						)),
			...
			(ju.prototype.queryRenderedFeatures = function (
				t,
				e,
				r,
				n,
			...
			(ju.prototype.clearMask = function () {
				this.segments && (this.segments.destroy(), delete this.segments),
					this.maskedBoundsBuffer &&
						(this.maskedBoundsBuffer.destroy(), delete this.maskedBoundsBuffer),
					this.maskedIndexBuffer &&
						(this.maskedIndexBuffer.destroy(), delete this.maskedIndexBuffer);
			}),
			(ju.prototype.setMask = function (t, e) {
				if (
					!o(this.mask, t) &&
					((this.mask = t), this.clearMask(), !o(t, { 0: !0 }))
				) {
					var r = new Xn(),
						n = new si();
					...
					(this.maskedBoundsBuffer = e.createVertexBuffer(r, Cu.members)),
		...
		(qu.fromFeature = function (t, e) {
			for (var r = new qu(), n = 0; n < t.sections.length; n++) {
				var i = t.sections[n];
				r.sections.push({ scale: i.scale || 1, fontStack: i.fontStack || e }),
					(r.text += i.text);
			...
			(qu.prototype.trim = function () {
				for (
					var t = 0, e = 0;
					e < this.text.length && Nu[this.text.charCodeAt(e)];
					e++
				)
					t++;
				for (
					var r = this.text.length, n = this.text.length - 1;
					n >= 0 && n >= t && Nu[this.text.charCodeAt(n)];
					n--
				)
					r--;
		...
		var Nu = { 9: !0, 10: !0, 11: !0, 12: !0, 13: !0, 32: !0 },
			Ku = {};
		function Gu(t, e, r, n) {
		...
		function Zu(t, e, r, n, i, a) {
			for (
				var o = null, s = Gu(e, r, i, a), u = 0, l = n;
				u < l.length;
				u += 1
			) {
				var p = l[u],
		...
		function Hu(t, e, r, n) {
			...
			for (
				...
				var l = t.getSection(u),
					...
					c = n[l.fontStack],
					h = c && c[p];
				h && !Nu[p] && (s += h.metrics.advance * l.scale + e),
					u < t.length() - 1 &&
						(Ku[p] ||
							(!((i = p) < 11904) &&
								(hn["Bopomofo Extended"](i) ||
									hn.Bopomofo(i) ||
									hn["CJK Compatibility Forms"](i) ||
									hn["CJK Compatibility Ideographs"](i) ||
									hn["CJK Compatibility"](i) ||
									hn["CJK Radicals Supplement"](i) ||
									hn["CJK Strokes"](i) ||
									hn["CJK Symbols and Punctuation"](i) ||
									hn["CJK Unified Ideographs Extension A"](i) ||
									hn["CJK Unified Ideographs"](i) ||
									hn["Enclosed CJK Letters and Months"](i) ||
									hn["Halfwidth and Fullwidth Forms"](i) ||
									hn.Hiragana(i) ||
									hn["Ideographic Description Characters"](i) ||
									hn["Kangxi Radicals"](i) ||
									hn["Katakana Phonetic Extensions"](i) ||
									hn.Katakana(i) ||
									hn["Vertical Forms"](i) ||
									hn["Yi Radicals"](i) ||
									hn["Yi Syllables"](i)))) &&
						a.push(Zu(u + 1, s, o, a, Xu(p, t.getCharCode(u + 1)), !1));
			}
			return (function t(e) {
		...
		function Ju(t, e, r, n, i) {
			if (i) {
				...
				if (s)
					for (
						var u = s.metrics.advance * a.scale, l = (t[n].x + u) * i, p = r;
						p <= n;
						p++
					)
						t[p].x -= l;
		...
		(Ku[10] = !0),
			...
			(t.getJSON = function (t, e) {
				return at(c(t, { type: "json" }), e);
			}),
			(t.normalizeSpriteURL = function (t, e, r, n) {
				var i = X(t);
				return U(t)
					? ((i.path = "/styles/v1" + i.path + "/sprite" + e + r), D(i, n))
					: ((i.path += "" + e + r), Z(i));
			}),
			(t.ResourceType = et),
			(t.getImage = pt),
			...
			(t.AlphaImage = ja),
			(t.Properties = Dn),
			(t.DataConstantProperty = Mn),
			(t.styleSpec = mt),
			(t.validateLight = $r),
			(t.endsWith = v),
			(t.emitValidationErrors = tn),
			(t.validateStyle = Jr),
			(t.extend = c),
			(t.Evented = dt),
			...
			(t.LngLatBounds = xu),
			(t.mercatorXfromLng = wu),
			(t.mercatorYfromLat = Au),
			(t.Event = ft),
			(t.ErrorEvent = yt),
			(t.postTurnstileEvent = W),
			(t.postMapLoadEvent = tt),
			...
			(t.EXTENT = Yi),
			(t.MercatorCoordinate = zu),
			(t.CanonicalTileID = Iu),
			(t.StructArrayLayout4i8 = Xn),
			(t.rasterBoundsAttributes = Cu),
			(t.SegmentVector = zi),
			...
			(t.evaluateSizeForZoom = function (t, e, r) {
				if ("constant" === t.functionType)
					return { uSizeT: 0, uSize: t.layoutSize };
				if ("source" === t.functionType) return { uSizeT: 0, uSize: 0 };
				if ("camera" === t.functionType) {
					var n = t.propertyValue,
						i = t.zoomRange,
						a = t.sizeRange,
						o = l(
							br(n, r.specification).interpolationFactor(e, i.min, i.max),
							0,
							1,
						);
					return { uSizeT: 0, uSize: a.min + o * (a.max - a.min) };
				}
				var s = t.propertyValue,
					u = t.zoomRange;
				return {
					uSizeT: l(
						br(s, r.specification).interpolationFactor(e, u.min, u.max),
						0,
						1,
					),
					uSize: 0,
			...
			(t.WritingMode = Ru),
			(t.transformMat4 = Sa),
			(t.evaluateSizeForFeature = function (t, e, r) {
				var n = e;
				return "source" === t.functionType
					? r.lowerSize / bs
					: "composite" === t.functionType
						? le(r.lowerSize / bs, r.upperSize / bs, n.uSizeT)
						: n.uSize;
			}),
			(t.addDynamicAttributes = ks),
			(t.properties = Ps),
			(t.polygonIntersectsPolygon = ea),
			(t.isMapboxURL = U),
			...
			(t.registerForPluginAvailability = function (t) {
				return (
					bn
						? t({ pluginURL: bn, completionCallback: gn })
						: wn.once("pluginAvailable", t),
					t
				);
			}),
			(t.ZoomHistory = cn),
			...
			(t.UniformColor = Li),
			(t.clamp = l),
			(t.StructArrayLayout2i4 = Gn),
			(t.StructArrayLayout2ui4 = ui),
			(t.ProgramConfiguration = Gi),
			(t.StructArrayLayout1ui2 = li),
			(t.StructArrayLayout3ui6 = si),
			(t.wrap = p),
			(t.create$2 = function () {
				var t = new va(4);
				return (
					va != Float32Array && ((t[1] = 0), (t[2] = 0)),
					(t[0] = 1),
					(t[3] = 1),
					t
				);
			...
			(t.Anchor = xs),
			(t.GLYPH_PBF_BORDER = mu),
			(t.distToSegmentSquared = ua),
			(t.allowsLetterSpacing = function (t) {
				for (var e = 0, r = t; e < r.length; e += 1)
					if (!yn(r[e].charCodeAt(0))) return !1;
				return !0;
			}),
			(t.shapeText = function (t, e, r, n, i, a, o, s, u, l, p) {
				...
				if (d && 1 === c.sections.length) {
					h = [];
					for (
						var v = 0, g = d(c.toString(), Hu(c, s, n, e));
						v < g.length;
						v += 1
					) {
						var x = g[v],
					...
					h = [];
					for (
						var w = 0, A = m(c.text, c.sectionIndex, Hu(c, s, n, e));
						w < A.length;
						w += 1
					) {
						var S = A[w],
						...
						(k.text = S[0]),
							(k.sectionIndex = S[1]),
							(k.sections = c.sections),
							h.push(k);
					}
				} else
					h = (function (t, e) {
						for (
							var r = [], n = t.text, i = 0, a = 0, o = e;
							a < o.length;
							a += 1
						) {
							var s = o[a];
				...
				return (
					(function (t, e, r, n, i, a, o, s, u) {
						for (
							var l = 0,
								p = -17,
								c = 0,
								h = t.positionedGlyphs,
								f = "right" === a ? 1 : "left" === a ? 0 : 0.5,
								y = 0,
								d = r;
							y < d.length;
							y += 1
					...
					!!f.length && ((y.text = y.text.toString()), y)
				);
			}),
			(t.allowsVerticalWritingMode = fn),
			...
			(t.classifyRings = So),
			(t.SIZE_PACK_FACTOR = bs),
			(t.SymbolBucket = Bs),
			(t.register = sn),
			(t.CollisionBoxArray = fi),
			(t.DictionaryCoder = Mu),
			(t.FeatureIndex = Ou),
			(t.ImageAtlas = Rs),
			(t.LineBucket = as),
			(t.FillBucket = Bo),
			(t.FillExtrusionBucket = Fo),
			(t.mvt = Wo),
			(t.Protobuf = Ys),
			(t.DEMData = Vu),
			(t.vectorTile = Wo),
	...
	define(["./shared.js"], function (e) {
		...
		function t(e) {
			var r = typeof e;
			if ("number" === r || "boolean" === r || "string" === r || null == e)
			...
			for (var l = [], u = 0; s < r / 2; ) {
				...
				for (
					f = Math.abs(((f + 3 * Math.PI) % (2 * Math.PI)) - Math.PI),
						l.push({ distance: s, angleDelta: f }),
						u += f;
					s - l[0].distance > n;
		...
		function l(t, r, n, l, u, h) {
			for (
				var c = a(n, u, h), p = s(n, l) * h, f = 0, d = i(t) / 2, g = 0;
				g < t.length - 1;
				g++
			) {
				var m = t[g],
			...
			return (
				...
				(function t(r, n, a, s, l, u, h, c, p) {
					...
					for (var y = 0; y < r.length - 1; y++) {
						for (
							var x = r[y], w = r[y + 1], M = x.dist(w), S = w.angleTo(x);
							m + a < g + M;
		...
		var h = function (t, r, n, o, i, a, s, l, u, h, c, p) {
			...
			if (((this.boxStartIndex = t.length), h)) {
				...
				v > 0 &&
					((v = Math.max(10 * l, v)),
					this._addLineCollisionCircles(t, r, n, n.segment, y, v, o, i, a, c));
			} else {
				if (p) {
					...
					x._rotate(_),
						...
						M._rotate(_),
						S._rotate(_),
						(g = Math.min(x.x, w.x, M.x, S.x)),
						(m = Math.max(x.x, w.x, M.x, S.x)),
						(f = Math.min(x.y, w.y, M.y, S.y)),
						(d = Math.max(x.y, w.y, M.y, S.y));
				}
				t.emplaceBack(n.x, n.y, g, f, m, d, o, i, a, 0, 0);
			}
			this.boxEndIndex = t.length;
		};
		h.prototype._addLineCollisionCircles = function (
			e,
			t,
			r,
			n,
		...
		function f(t, r, n) {
			...
			for (
				var o = 1 / 0, i = 1 / 0, a = -1 / 0, s = -1 / 0, l = t[0], u = 0;
				u < l.length;
				u++
			) {
				var h = l[u];
			...
			for (var x = o; x < a; x += m)
				for (var w = i; w < s; w += m) y.push(new g(x + v, w + v, v, t));
			for (
				var M = (function (e) {
						for (
							var t = 0, r = 0, n = 0, o = e[0], i = 0, a = o.length, s = a - 1;
							i < a;
							s = i++
						) {
							var l = o[i],
				...
				(_.d > M.d || !M.d) &&
					...
					_.max - M.d <= r ||
						((v = _.h / 2),
						y.push(new g(_.p.x - v, _.p.y - v, v, t)),
						y.push(new g(_.p.x + v, _.p.y - v, v, t)),
						y.push(new g(_.p.x - v, _.p.y + v, v, t)),
						y.push(new g(_.p.x + v, _.p.y + v, v, t)),
						(S += 4));
		...
		function g(t, r, n, o) {
			(this.p = new e.Point(t, r)),
				(this.h = n),
				(this.d = (function (t, r) {
					for (var n = !1, o = 1 / 0, i = 0; i < r.length; i++)
						for (var a = r[i], s = 0, l = a.length, u = l - 1; s < l; u = s++) {
							var h = a[s],
								c = a[u];
							h.y > t.y != c.y > t.y &&
								t.x < ((c.x - h.x) * (t.y - h.y)) / (c.y - h.y) + h.x &&
								(n = !n),
								(o = Math.min(o, e.distToSegmentSquared(t, h, c)));
						}
		...
		(c.prototype.push = function (e) {
			...
			(c.prototype._down = function (e) {
				for (
					var t = this.data, r = this.compare, n = this.length >> 1, o = t[e];
					e < n;
					...
					var i = 1 + (e << 1),
						...
						s = i + 1;
					if (
						(s < this.length && r(t[s], a) < 0 && ((i = s), (a = t[s])),
						r(a, o) >= 0)
					)
						break;
					(t[e] = a), (e = i);
		...
		var m = e.createCommonjsModule(function (e) {
			...
			v = e.createCommonjsModule(function (e) {
				e.exports = function (e, t) {
					for (var r, n = e.length, o = t ^ n, i = 0; n >= 4; )
						(r =
							1540483477 *
								(65535 &
									(r =
		...
		function M(t, r, n, o, i, a) {
			...
			if ("composite" === t.textSizeData.functionType) {
				...
				h.compositeTextSizes = [
					u["text-size"].possiblyEvaluate(new e.EvaluationParameters(p)),
					u["text-size"].possiblyEvaluate(new e.EvaluationParameters(f)),
				];
			}
			if ("composite" === t.iconSizeData.functionType) {
				...
				h.compositeIconSizes = [
					u["icon-size"].possiblyEvaluate(new e.EvaluationParameters(g)),
					u["icon-size"].possiblyEvaluate(new e.EvaluationParameters(m)),
				];
			}
			(h.layoutTextSize = u["text-size"].possiblyEvaluate(
				new e.EvaluationParameters(t.zoom + 1),
			)),
				(h.layoutIconSize = u["icon-size"].possiblyEvaluate(
					new e.EvaluationParameters(t.zoom + 1),
				)),
				(h.textMaxSize = u["text-size"].possiblyEvaluate(
					new e.EvaluationParameters(18),
				));
			for (
				var v = 24 * l.get("text-line-height"),
					y =
						"map" === l.get("text-rotation-alignment") &&
						"point" !== l.get("symbol-placement"),
					x = l.get("text-keep-upright"),
					w = 0,
					M = t.features;
				w < M.length;
				w += 1
				...
				if (I) {
					var k = I.toString(),
						...
						D =
							"point" === l.get("symbol-placement")
								? 24 * l.get("text-max-width").evaluate(_, {})
								: 0;
					(T.horizontal = e.shapeText(
						I,
						r,
						P,
						D,
						...
						e.allowsVerticalWritingMode(k) &&
							y &&
							x &&
							(T.vertical = e.shapeText(
								I,
								r,
								P,
								D,
				...
				if (_.icon) {
					...
					N &&
						((O = e.shapeIcon(
							i[_.icon],
							l.get("icon-offset").evaluate(_, {}),
							l.get("icon-anchor").evaluate(_, {}),
						)),
						void 0 === t.sdfIcons
							? (t.sdfIcons = N.sdf)
							: t.sdfIcons !== N.sdf &&
		...
		function S(t, r, n, o, i, a) {
					...
					l.x < 0 ||
						...
						(function (
							...
							if (i) {
								var R = (function (t, r, n, o, i, a) {
										...
										if ("none" !== p.get("icon-text-fit") && i) {
											var v = m - d,
												...
												z =
													"width" === p.get("icon-text-fit")
														? 0.5 * (P - y)
														: 0,
												C =
													"height" === p.get("icon-text-fit")
														? 0.5 * (_ - v)
														: 0,
												E =
													"width" === p.get("icon-text-fit") ||
													"both" === p.get("icon-text-fit")
														? _
														: v,
												A =
													"height" === p.get("icon-text-fit") ||
													"both" === p.get("icon-text-fit")
														? P
														: y;
											(s = new e.Point(w + C - k, S + z - b)),
												(l = new e.Point(w + C + T + E, S + z - b)),
												(u = new e.Point(w + C + T + E, S + z + I + A)),
												(h = new e.Point(w + C - k, S + z + I + A));
										} else
											(s = new e.Point(d, f)),
												(l = new e.Point(m, f)),
												(u = new e.Point(m, g)),
												(h = new e.Point(d, g));
										var L =
											(n.layout.get("icon-rotate").evaluate(a, {}) * Math.PI) /
											180;
										if (L) {
											var D = Math.sin(L),
												O = Math.cos(L),
								...
								(I = new h(s, n, r, l, u, c, i, m, v, !1, t.overscaling, F)),
									(z = 4 * R.length);
								var B = t.iconSizeData,
									Z = null;
								"source" === B.functionType
									? (Z = [
											e.SIZE_PACK_FACTOR *
												a.layout.get("icon-size").evaluate(M, {}),
										])[0] > _ &&
										e.warnOnce(
											t.layerIds[0] +
												': Value for "icon-size" is >= 256. Reduce your "icon-size".',
										)
									: "composite" === B.functionType &&
										((Z = [
											e.SIZE_PACK_FACTOR *
												b.compositeIconSizes[0].evaluate(M, {}),
											e.SIZE_PACK_FACTOR *
												b.compositeIconSizes[1].evaluate(M, {}),
										])[0] > _ ||
											Z[1] > _) &&
										e.warnOnce(
											t.layerIds[0] +
							...
							t.glyphOffsetArray.length >= e.SymbolBucket.MAX_GLYPHS &&
								e.warnOnce(
			...
			if ("line" === E)
										...
										(c.y < n && p.y < n) ||
											...
											(c.x >= o && p.x >= o) ||
												...
												(c.y >= i && p.y >= i) ||
													...
													(u && c.equals(u[u.length - 1])) ||
														((u = [c]), a.push(u)),
													u.push(p)))));
								}
							return a;
						})(r.geometry, 0, 0, e.EXTENT, e.EXTENT);
					D < O.length;
					D += 1
				)
					for (
				...
				for (var j = 0, G = r.geometry; j < G.length; j += 1) {
					var J = G[j];
					if (J.length > 1) {
				...
				for (
					var V = 0, W = e.classifyRings(r.geometry, 0);
					V < W.length;
					V += 1
				) {
					var Y = W[V],
		...
		function P(t, r, n, o, i, a, s, l, u, h, c, p) {
			var f = (function (t, r, n, o, i, a) {
					for (
						var s =
								(n.layout.get("text-rotate").evaluate(i, {}) * Math.PI) / 180,
							l = n.layout
								.get("text-offset")
								.evaluate(i, {})
								.map(function (e) {
							...
							if (g) {
								...
								if (o && p.vertical) {
									var k = new e.Point(-v, v),
										z = -Math.PI / 2,
										C = new e.Point(5, 0);
									P._rotateAround(z, k)._add(C),
										b._rotateAround(z, k)._add(C),
										T._rotateAround(z, k)._add(C),
										I._rotateAround(z, k)._add(C);
								}
								if (s) {
									var E = Math.sin(s),
										A = Math.cos(s),
			...
			return (
				"source" === d.functionType
					? (g = [
							e.SIZE_PACK_FACTOR * o.layout.get("text-size").evaluate(a, {}),
						])[0] > _ &&
						e.warnOnce(
							t.layerIds[0] +
					...
					: "composite" === d.functionType &&
						((g = [
							e.SIZE_PACK_FACTOR * p.compositeTextSizes[0].evaluate(a, {}),
							e.SIZE_PACK_FACTOR * p.compositeTextSizes[1].evaluate(a, {}),
						])[0] > _ ||
							g[1] > _) &&
						e.warnOnce(
							t.layerIds[0] +
				...
				h.push(t.text.placedSymbolArray.length - 1),
				4 * f.length
			);
		}
		function b(e, t, r, n) {
			var o = e.compareText;
			if (t in o) {
				for (var i = o[t], a = i.length - 1; a >= 0; a--)
					if (n.dist(i[a]) < r) return !0;
			} else o[t] = [];
			return o[t].push(n), !1;
		}
		var T = function (t) {
			...
			var h = e.potpack(n),
				c = h.w,
				p = h.h,
				f = new e.AlphaImage({ width: c || 1, height: p || 1 });
			for (var d in t) {
				var g = t[d];
				for (var m in g) {
					var v = g[+m];
		...
		function k(t, r) {
			for (
				var n = new e.EvaluationParameters(r), o = 0, i = t;
				o < i.length;
				o += 1
			) {
				i[o].recalculate(n);
		...
		I.prototype.parse = function (t, r, n, o) {
			...
			for (var g in d) {
				...
				if (m) {
					...
					for (var v = a.encode(g), y = [], x = 0; x < m.length; x++) {
						var w = m.feature(x);
						y.push({ feature: w, index: x, sourceLayerIndex: v });
					}
					for (var S = 0, _ = d[g]; S < _.length; S += 1) {
						var P = _[S],
							b = P[0];
						if (!(b.minzoom && this.zoom < Math.floor(b.minzoom)))
							if (!(b.maxzoom && this.zoom >= b.maxzoom))
								if ("none" !== b.visibility)
									k(P, this.zoom),
										(p[b.id] = b.createBucket({
			...
			Object.keys(I).length
				? n.send("getGlyphs", { uid: this.uid, stacks: I }, function (e, t) {
						l || ((l = e), (u = t), E.call(i));
					})
				: (u = {});
			var z = Object.keys(f.iconDependencies);
			z.length
				? n.send("getImages", { icons: z }, function (e, t) {
						l || ((l = e), (h = t), E.call(i));
					})
				: (h = {});
			...
			function E() {
				...
				if (u && h && c) {
					...
					for (var n in p) {
						var i = p[n];
						i instanceof e.SymbolBucket
							? (k(i.layers, this.zoom),
								M(
									i,
									u,
									t.positions,
							...
							: i.hasPattern &&
								(i instanceof e.LineBucket ||
									i instanceof e.FillBucket ||
									i instanceof e.FillExtrusionBucket) &&
								(k(i.layers, this.zoom), i.addFeatures(f, r.patternPositions));
					}
					(this.status = "done"),
						o(null, {
			...
			C.length
				? n.send("getImages", { icons: C }, function (e, t) {
						l || ((l = e), (c = t), E.call(i));
					})
				: (c = {}),
				E.call(this);
		...
		var z = "undefined" != typeof performance,
			C = {
				getEntriesByName: function (e) {
					return (
						!!(z && performance && performance.getEntriesByName) &&
						performance.getEntriesByName(e)
					);
				},
				mark: function (e) {
					return (
						!!(z && performance && performance.mark) && performance.mark(e)
					);
				},
				measure: function (e, t, r) {
					return (
						!!(z && performance && performance.measure) &&
						performance.measure(e, t, r)
					);
				},
				clearMarks: function (e) {
					return (
						!!(z && performance && performance.clearMarks) &&
						performance.clearMarks(e)
					);
				},
				clearMeasures: function (e) {
					return (
						!!(z && performance && performance.clearMeasures) &&
		...
		(E.prototype.finish = function () {
			...
			return (
				0 === e.length &&
					(C.measure(this._marks.measure, this._marks.start, this._marks.end),
					(e = C.getEntriesByName(this._marks.measure)),
					C.clearMarks(this._marks.start),
					C.clearMarks(this._marks.end),
					C.clearMeasures(this._marks.measure)),
				e
			);
		}),
			(C.Performance = E);
		...
		(L.prototype.loadTile = function (t, r) {
			...
			var i =
					...
					new C.Performance(t.request),
				a = (this.loading[o] = new I(t));
			a.abort = this.loadVectorData(t, function (t, s) {
				if ((delete n.loading[o], t || !s))
					return (a.status = "done"), (n.loaded[o] = a), r(t);
				var l = s.rawData,
					u = {};
				...
				(a.vectorTile = s.vectorTile),
					a.parse(s.vectorTile, n.layerIndex, n.actor, function (t, n) {
						if (t || !n) return r(t);
						r(null, e.extend({ rawTileData: l.slice(0) }, n, u, h));
					}),
					(n.loaded = n.loaded || {}),
					(n.loaded[o] = a);
			});
			...
			(L.prototype.reloadTile = function (e, t) {
				...
				if (r && r[n]) {
					...
					var a = function (e, r) {
						...
						n &&
							(delete i.reloadCallback,
							i.parse(i.vectorTile, o.layerIndex, o.actor, n)),
							t(e, r);
					};
					"parsing" === i.status
						? (i.reloadCallback = a)
						: "done" === i.status &&
							(i.vectorTile
								? i.parse(i.vectorTile, this.layerIndex, this.actor, a)
								: a());
				}
			}),
			...
			if (l > 2) {
				for (a = 0; a < l; a++)
					a === l - 2
						...
						(t = e[n]),
						(r = e[o]),
						(s += (F(e[i][0]) - F(t[0])) * Math.sin(F(r[1])));
			...
			Z = function e(t, r) {
				switch ((t && t.type) || null) {
					...
					case "MultiPolygon":
						return (function (e, t) {
							"Polygon" === e.type
								? (e.coordinates = G(e.coordinates, t))
								: "MultiPolygon" === e.type &&
									(e.coordinates = e.coordinates.map(j(G, t)));
							return e;
						})(t, r);
					default:
						return t;
		...
		(V.prototype.loadGeometry = function () {
			if (1 === this._feature.type) {
				for (
					var t = [], r = 0, n = this._feature.geometry;
					r < n.length;
					r += 1
				) {
					var o = n[r];
			...
			for (
				var i = [], a = 0, s = this._feature.geometry;
				a < s.length;
				a += 1
			) {
		...
		var H = te,
			...
			$ = function (e, t) {
				...
				var r = {};
				for (var n in e)
					(r[n] = new q(e[n].features, t)),
						(r[n].name = n),
						(r[n].version = t.version),
						(r[n].extent = t.extent);
				return te({ layers: r });
			},
			ee = q;
		...
		function re(e, t) {
			...
			for (r = 0; r < e.length; r++)
				(n.feature = e.feature(r)), t.writeMessage(2, ne, n);
			var o = n.keys;
		...
		function ne(e, t) {
			...
			void 0 !== r.id && t.writeVarintField(1, r.id),
				t.writeMessage(2, oe, e),
				t.writeVarintField(3, r.type),
				t.writeMessage(4, se, r);
		}
		function oe(e, t) {
			var r = e.feature,
				n = e.keys,
			...
			for (var s in r.properties) {
				var l = i[s];
				void 0 === l && (n.push(s), (l = n.length - 1), (i[s] = l)),
					t.writeVarint(l);
				...
				var c = h + ":" + u,
					p = a[c];
				void 0 === p && (o.push(u), (p = o.length - 1), (a[c] = p)),
					t.writeVarint(p);
			}
		}
		function ie(e, t) {
		...
		function se(e, t) {
			for (
				var r = e.loadGeometry(), n = e.type, o = 0, i = 0, a = r.length, s = 0;
				s < a;
				s++
			) {
				var l = r[s],
			...
			if (!(o - n <= r)) {
				...
				!(function e(t, r, n, o, i, a) {
					for (; i > o; ) {
						...
						r[2 * o + a] === d ? he(t, r, o, m) : he(t, r, ++m, i),
							m <= n && (o = m + 1),
							n <= m && (i = m - 1);
					}
				})(e, t, a, n, o, i % 2),
			...
			ge = function (e, t, r, n, o) {
				...
				for (
					var i = e.length < 65536 ? Uint16Array : Uint32Array,
						a = (this.ids = new i(e.length)),
						s = (this.coords = new o(2 * e.length)),
						l = 0;
					l < e.length;
					l++
				)
				...
				for (var s, l, u = [0, e.length - 1, 0], h = []; u.length; ) {
					...
					if (p - f <= a)
						for (var d = f; d <= p; d++)
							(s = t[2 * d]),
								(l = t[2 * d + 1]),
								s >= r && s <= o && l >= n && l <= i && h.push(e[d]);
					else {
						var g = Math.floor((f + p) / 2);
						(s = t[2 * g]),
							(l = t[2 * g + 1]),
							s >= r && s <= o && l >= n && l <= i && h.push(e[g]);
						var m = (c + 1) % 2;
						(0 === c ? r <= s : n <= l) &&
							(u.push(f), u.push(g - 1), u.push(m)),
							(0 === c ? o >= s : i >= l) &&
								(u.push(g + 1), u.push(p), u.push(m));
					}
				}
				return h;
			...
			(ge.prototype.within = function (e, t, r) {
				return (function (e, t, r, n, o, i) {
					for (var a = [0, e.length - 1, 0], s = [], l = o * o; a.length; ) {
						...
						if (h - c <= i)
							for (var p = c; p <= h; p++)
								pe(t[2 * p], t[2 * p + 1], r, n) <= l && s.push(e[p]);
						else {
							...
							var m = (u + 1) % 2;
							(0 === u ? r - o <= d : n - o <= g) &&
								(a.push(c), a.push(f - 1), a.push(m)),
								(0 === u ? r + o >= d : n + o >= g) &&
									(a.push(f + 1), a.push(h), a.push(m));
						}
					}
					return s;
		...
		var me = {
			...
			ve = function (e) {
				(this.options = Pe(Object.create(me), e)),
		...
		function xe(e, t) {
			var r = e.geometry.coordinates,
				n = r[0],
				o = r[1];
			return { x: Se(n), y: _e(o), zoom: 1 / 0, index: t, parentId: -1 };
		}
		function we(e) {
			return {
				type: "Feature",
			...
			return (
				(function (e) {
					...
					if ("Point" === r || "MultiPoint" === r || "LineString" === r)
						...
						for (var n = 0; n < t.length; n++) ze(e, t[n]);
					else if ("MultiPolygon" === r)
						for (n = 0; n < t.length; n++)
							for (var o = 0; o < t[n].length; o++) ze(e, t[n][o]);
				})(o),
				o
			);
		}
		...
		function Ce(e, t, r, n) {
			if (t.geometry) {
				...
				if (
					...
					for (var u = 0; u < o.length; u++) Ee(o[u], s);
				else if ("LineString" === i) Ae(o, s, a, !1);
				else if ("MultiLineString" === i) {
					if (r.lineMetrics) {
						for (u = 0; u < o.length; u++)
							(s = []),
								Ae(o[u], s, a, !1),
								e.push(ke(l, "LineString", s, t.properties));
						return;
					}
					Le(o, s, a, !1);
				} else if ("Polygon" === i) Le(o, s, a, !0);
				else {
					if ("MultiPolygon" !== i) {
			...
			for (var o, i, a = 0, s = 0; s < e.length; s++) {
				...
				t.push(l),
					...
					s > 0 &&
						(a += n
							? (o * u - l * i) / 2
							: Math.sqrt(Math.pow(l - o, 2) + Math.pow(u - i, 2))),
					(o = l),
					(i = u);
			}
			var h = t.length - 3;
		...
		function Ne(e, t, r, n, o, i, a, s) {
			...
			for (var l = [], u = 0; u < e.length; u++) {
				...
				if (f >= r && d < n) l.push(h);
					...
					var g = [];
					if ("Point" === p || "MultiPoint" === p) Re(c, g, r, n, o);
					else if ("LineString" === p) Fe(c, g, r, n, o, !1, s.lineMetrics);
					else if ("MultiLineString" === p) Ze(c, g, r, n, o, !1);
					else if ("Polygon" === p) Ze(c, g, r, n, o, !0);
					...
					if (g.length) {
						...
						("LineString" !== p && "MultiLineString" !== p) ||
							...
							("Point" !== p && "MultiPoint" !== p) ||
								(p = 3 === g.length ? "Point" : "MultiPoint"),
							l.push(ke(h.id, p, g, h.tags));
					}
				}
			}
		...
		function Fe(e, t, r, n, o, i, a) {
			for (
				var s, l, u = Be(e), h = 0 === o ? Ge : Je, c = e.start, p = 0;
				p < e.length - 3;
				p += 3
			) {
				var f = e[p],
				...
				a && (s = Math.sqrt(Math.pow(f - m, 2) + Math.pow(d - v, 2))),
					y < r
						? x > r && ((l = h(u, f, d, m, v, r)), a && (u.start = c + s * l))
						: y > n
							? x < n && ((l = h(u, f, d, m, v, n)), a && (u.start = c + s * l))
							: je(u, f, d, g),
					x < r && y >= r && ((l = h(u, f, d, m, v, r)), (w = !0)),
					x > n && y <= n && ((l = h(u, f, d, m, v, n)), (w = !0)),
					!i && w && (a && (u.end = c + s * l), t.push(u), (u = Be(e))),
					a && (c += s);
			}
			var M = e.length - 3;
			(f = e[M]),
			...
			for (var r = [], n = 0; n < e.length; n++) {
				...
				if ("Point" === a || "MultiPoint" === a || "LineString" === a)
					...
					for (var s = 0; s < i.geometry.length; s++)
						o.push(Ve(i.geometry[s], t));
				} else if ("MultiPolygon" === a)
					for (o = [], s = 0; s < i.geometry.length; s++) {
						for (var l = [], u = 0; u < i.geometry[s].length; u++)
							l.push(Ve(i.geometry[s][u], t));
						o.push(l);
					}
			...
			for (r = 0; r < e.features.length; r++) {
				...
				if (((l.geometry = []), 1 === h))
					for (n = 0; n < u.length; n += 2)
						l.geometry.push(Ye(u[n], u[n + 1], t, i, a, s));
				else
					for (n = 0; n < u.length; n++) {
						var c = [];
						for (o = 0; o < u[n].length; o += 2)
							c.push(Ye(u[n][o], u[n][o + 1], t, i, a, s));
						l.geometry.push(c);
					}
			}
		...
		function qe(e, t, r, n, o) {
			for (
				var i = t === o.maxZoom ? 0 : o.tolerance / ((1 << t) * o.extent),
					a = {
						features: [],
						numPoints: 0,
						numSimplified: 0,
		...
		function Ue(e, t, r, n) {
			...
			else if ("LineString" === i) Ke(a, o, e, r, !1, !1);
			else if ("MultiLineString" === i || "Polygon" === i)
				for (s = 0; s < o.length; s++)
					Ke(a, o[s], e, r, "Polygon" === i, 0 === s);
			...
			if (a.length) {
				...
				if ("LineString" === i && n.lineMetrics) {
					...
					(h.mapbox_clip_start = o.start / o.size),
						(h.mapbox_clip_end = o.end / o.size);
				}
				var p = {
					geometry: a,
					type:
		...
		function Ke(e, t, r, n, o, i) {
			var a = n * n;
			if (n > 0 && t.size < (o ? a : n)) r.numPoints += t.length / 3;
			else {
				for (var s = [], l = 0; l < t.length; l += 3)
					(0 === n || t[l + 2] > a) &&
						(r.numSimplified++, s.push(t[l]), s.push(t[l + 1])),
						r.numPoints++;
				o &&
					(function (e, t) {
						for (
							var r = 0, n = 0, o = e.length, i = o - 2;
							n < o;
							i = n, n += 2
						)
							r += (e[n] - e[i]) * (e[n + 1] + e[i + 1]);
						if (r > 0 === t)
							for (n = 0, o = e.length; n < o / 2; n += 2) {
								var a = e[n],
									s = e[n + 1];
								(e[n] = e[o - 2 - n]),
									(e[n + 1] = e[o - 1 - n]),
			...
			var n = (function (e, t) {
				...
				if ("FeatureCollection" === e.type)
					for (var n = 0; n < e.features.length; n++)
						Ce(r, e.features[n], t, n);
				else "Feature" === e.type ? Ce(r, e, t) : Ce(r, { geometry: e }, t);
				return r;
			})(e, t);
			(this.tiles = {}),
				(this.tileCoords = []),
				...
				(n = (function (e, t) {
					...
					return (
						(o || i) &&
							((n = Ne(e, 1, -r, 1 + r, 0, -1, 2, t) || []),
							o && (n = Xe(o, 1).concat(n)),
							i && (n = n.concat(Xe(i, -1)))),
						n
					);
				})(n, t)).length && this.splitTile(n, 0, 0, 0),
				r &&
					(n.length &&
						console.log(
							"features: %d, points: %d",
		...
		function $e(e, t) {
			...
			(0 === i.byteOffset && i.byteLength === i.buffer.byteLength) ||
				(i = new Uint8Array(i)),
				t(null, { vectorTile: o, rawData: i.buffer });
		}
		(ve.prototype.load = function (e) {
			...
			for (var s = [], l = 0; l < e.length; l++)
				e[l].geometry && s.push(xe(e[l], l));
			(this.trees[o + 1] = new ge(s, be, Te, i, Float32Array)),
				r && console.timeEnd(a);
			for (var u = o; u >= n; u--) {
				var h = +Date.now();
				(s = this._cluster(s, u)),
					(this.trees[u] = new ge(s, be, Te, i, Float32Array)),
					r &&
						console.log(
			...
			(ve.prototype.getChildren = function (e) {
				...
				for (
					...
					var h = u[l],
						c = o.points[h];
					c.parentId === e &&
						s.push(c.numPoints ? we(c) : this.points[c.index]);
				}
				...
				for (var i = 0, a = this.getChildren(t); i < a.length; i += 1) {
					...
					if (
						(l && l.cluster
							? o + l.point_count <= n
								? (o += l.point_count)
								: (o = this._appendLeaves(e, l.cluster_id, r, n, o))
							: o < n
								? o++
								: e.push(s),
						e.length === r)
				...
				for (var a = 0, s = e; a < s.length; a += 1) {
					var l = t[s[a]],
						u = {
							...
							geometry: [
								[
									Math.round(this.options.extent * (l.x * o - r)),
									Math.round(this.options.extent * (l.y * o - n)),
								],
							],
			...
			(ve.prototype._cluster = function (e, t) {
				for (
					...
					if (!(u.zoom <= t)) {
						u.zoom = t;
						for (
							var h = this.trees[t + 1],
								c = h.within(u.x, u.y, s),
								p = u.numPoints || 1,
								f = u.x * p,
								d = u.y * p,
								g = a ? this._map(u, !0) : null,
								m = (l << 5) + (t + 1),
								v = 0,
								y = c;
							v < y.length;
						...
						1 === p
							? r.push(u)
							: ((u.parentId = m), r.push(ye(f / p, d / p, m, p, g)));
					}
				}
				return r;
			}),
				...
				for (var s = [e, t, r, n], l = this.options, u = l.debug; s.length; ) {
					...
					if (((p.source = null), 0 !== e.length)) {
						...
						var g,
							...
							x,
							w,
							M = (0.5 * l.buffer) / l.extent,
							S = 0.5 - M,
							_ = 0.5 + M,
							P = 1 + M;
						(g = m = v = y = null),
							(x = Ne(e, h, r - M, r + _, 0, p.minX, p.maxX, l)),
							(w = Ne(e, h, r + S, r + P, 0, p.minX, p.maxX, l)),
							(e = null),
							x &&
								((g = Ne(x, h, n - M, n + _, 1, p.minY, p.maxY, l)),
								(m = Ne(x, h, n + S, n + P, 1, p.minY, p.maxY, l)),
								(x = null)),
							w &&
								((v = Ne(w, h, n - M, n + _, 1, p.minY, p.maxY, l)),
								(y = Ne(w, h, n + S, n + P, 1, p.minY, p.maxY, l)),
								(w = null)),
							u > 1 && console.timeEnd("clipping"),
							s.push(g || [], t + 1, 2 * r, 2 * n),
							s.push(m || [], t + 1, 2 * r, 2 * n + 1),
							s.push(v || [], t + 1, 2 * r + 1, 2 * n),
							s.push(y || [], t + 1, 2 * r + 1, 2 * n + 1);
					}
				}
			}),
			(He.prototype.getTile = function (e, t, r) {
				...
				return l && l.source
					? (i > 1 && console.log("found parent tile z%d-%d-%d", u, h, c),
						...
						this.tiles[s] ? We(this.tiles[s], o) : null)
					: null;
			});
		var et = (function (t) {
			function r(e, r, n) {
			...
			return (
					...
					if (this._pendingCallback && this._pendingLoadDataParams) {
						...
						this.loadGeoJSON(n, function (i, a) {
							...
							if (o) {
								...
								l &&
									((s.resourceTiming = {}),
									(s.resourceTiming[n.source] = JSON.parse(JSON.stringify(l))));
							}
							r(null, s);
						});
					}
				...
				(r.prototype.reloadTile = function (e, r) {
					var n = this.loaded,
						o = e.uid;
					return n && n[o]
						? t.prototype.reloadTile.call(this, e, r)
						: this.loadTile(e, r);
				}),
		...
		var tt = function (t) {
			...
			(this.self = t),
				...
				(this.layerIndexes = {}),
				(this.workerSourceTypes = { vector: L, geojson: et }),
				(this.workerSources = {}),
		...
		return (
			(tt.prototype.setReferrer = function (e, t) {
				this.referrer = t;
			}),
			...
			(tt.prototype.removeSource = function (e, t, r) {
				if (
					...
					delete this.workerSources[e][t.type][t.source],
						void 0 !== n.removeSource ? n.removeSource(t, r) : r();
				}
			}),
			...
			(tt.prototype.getWorkerSource = function (e, t, r) {
				...
				if (
					...
					this.workerSources[e][t][r] = new this.workerSourceTypes[t](
						o,
	...
	define(["./shared.js"], function (t) {
						...
						(function (t) {
							void 0 === i[t] &&
								(i[t] = (function (t) {
									...
									return (
										(o.failIfMajorPerformanceCaveat = t),
										i.probablySupportsContext
											? i.probablySupportsContext("webgl", o) ||
												i.probablySupportsContext("experimental-webgl", o)
											: i.supportsContext
												? i.supportsContext("webgl", o) ||
													i.supportsContext("experimental-webgl", o)
												: i.getContext("webgl", o) ||
													i.getContext("experimental-webgl", o)
									);
								})(t));
							return i[t];
		...
		(i.addEventListener = function (t, e, i, o) {
			void 0 === o && (o = {}),
				"passive" in o && l
					...
					: t.addEventListener(e, i, o.capture);
		}),
			(i.removeEventListener = function (t, e, i, o) {
				void 0 === o && (o = {}),
					"passive" in o && l
						? t.removeEventListener(e, i, o)
						: t.removeEventListener(e, i, o.capture);
			});
		var u = function (e) {
			e.preventDefault(),
				e.stopPropagation(),
		...
		(i.suppressClick = function () {
			...
			(i.mousePos = function (e, i) {
				...
				return (
					...
					new t.Point(
						i.clientX - o.left - e.clientLeft,
						i.clientY - o.top - e.clientTop,
					)
				);
			}),
			(i.touchPos = function (e, i) {
				for (
					var o = e.getBoundingClientRect(),
						r = [],
						a = "touchend" === i.type ? i.changedTouches : i.touches,
						n = 0;
					n < a.length;
					n++
				)
					r.push(
						new t.Point(
							a[n].clientX - o.left - e.clientLeft,
							a[n].clientY - o.top - e.clientTop,
						),
					);
				return r;
			}),
		...
		(h.prototype.isLoaded = function () {
			...
			(h.prototype.getPattern = function (e) {
				...
				if (!o) return null;
				var r = { w: o.data.width + 2, h: o.data.height + 2, x: 0, y: 0 },
			...
			(h.prototype.bind = function (e) {
				...
				this.atlasTexture
					...
					: (this.atlasTexture = new t.Texture(e, this.atlasImage, i.RGBA)),
			...
			(h.prototype._updatePatternAtlas = function () {
				...
				var o = t.potpack(e),
					...
					a = o.h,
					n = this.atlasImage;
				for (var s in (n.resize({ width: r || 1, height: a || 1 }),
				this.patterns)) {
		...
		function m(t, e, i, o, r) {
			...
			for (var a = 1, n = 0; a < r; a++) {
				for (
					var s = (t[a] + a * a - (t[i[n]] + i[n] * i[n])) / (2 * a - 2 * i[n]);
					s <= o[n];
		...
		_.prototype.draw = function (t) {
			...
			for (
				...
				(this.gridOuter[o] =
					1 === r ? 0 : 0 === r ? d : Math.pow(Math.max(0, 0.5 - r), 2)),
					(this.gridInner[o] =
						1 === r ? d : 0 === r ? 0 : Math.pow(Math.max(0, r - 0.5), 2));
			}
			for (
				f(this.gridOuter, this.size, this.size, this.f, this.d, this.v, this.z),
					f(
						this.gridInner,
						this.size,
						this.size,
				...
				i[o] = Math.max(
					...
					Math.min(
						255,
						Math.round(255 - 255 * (a / this.radius + this.cutoff)),
					),
				);
			}
			return i;
		...
		(g.prototype.setURL = function (t) {
				...
				t.asyncAll(
					...
					function (t, e) {
						var i = t.stack,
							r = t.id,
							a = o.entries[i];
						a || (a = o.entries[i] = { glyphs: {}, requests: {} });
						var n = a.glyphs[r];
						if (void 0 === n)
							if ((n = o._tinySDF(a, i, r)))
								e(null, { stack: i, id: r, glyph: n });
							else {
									...
									l ||
										...
										l.push(function (t, o) {
											t
												? e(t)
												: o &&
													e(null, { stack: i, id: r, glyph: o[r] || null });
										});
								}
							}
						else e(null, { stack: i, id: r, glyph: n });
					},
					function (t, e) {
						if (t) i(t);
						else if (e) {
			...
			(g.prototype._tinySDF = function (e, i, o) {
				...
				if (
					r &&
					(t.isChar["CJK Unified Ideographs"](o) ||
						t.isChar["Hangul Syllables"](o))
				) {
					var a = e.tinySDF;
					if (!a) {
						var n = "400";
						/bold/i.test(i)
							...
							(a = e.tinySDF = new g.TinySDF(24, 3, 8, 0.25, r, n));
					}
					return {
						id: o,
			...
			x = (function (e) {
				...
				return (
					...
					(i.prototype.setLight = function (e, i) {
						if (
							(void 0 === i && (i = {}), !this._validate(t.validateLight, e, i))
						)
							for (var o in e) {
								var r = e[o];
								t.endsWith(o, "-transition")
									? this._transitionable.setTransition(
											o.slice(0, -"-transition".length),
											r,
										)
		...
		(b.prototype.getDash = function (t, e) {
			...
			return (
				this.positions[i] || (this.positions[i] = this.addDash(t, e)),
				this.positions[i]
			);
		}),
			(b.prototype.addDash = function (e, i) {
				...
				for (
					var s = this.width / a, l = s / 2, c = e.length % 2 == 1, u = -o;
					u <= o;
					u++
				)
					for (
						var h = this.nextRow + o + u,
							p = this.width * h,
							d = c ? -e[e.length - 1] : 0,
							_ = e[0],
							f = 1,
				...
				var T = {
					y: (this.nextRow + o + 0.5) / this.height,
		...
		function E(e, i, o) {
			var r = function (i, r) {
				...
				if (r) {
					...
					r.vector_layers &&
						((a.vectorLayers = r.vector_layers),
			...
			return e.url
				? t.getJSON(i(t.normalizeSourceURL(e.url), t.ResourceType.Source), r)
		...
		var I = (function (e) {
				function i(i, o, r, a) {
					if (
						...
						(this._options = t.extend({ type: "vector" }, o)),
				...
				return (
									...
									(e._tileJSONRequest = null),
										i
											...
											: o &&
												...
												t.postTurnstileEvent(o.tiles),
												t.postMapLoadEvent(o.tiles, e.map._getMapId()),
												e.fire(
													new t.Event("data", {
														dataType: "source",
					...
					(i.prototype.loadTile = function (e, i) {
						...
						(r.request.collectResourceTiming = this._collectResourceTiming),
							void 0 === e.workerID || "expired" === e.state
			...
			C = (function (e) {
				...
				return (
					...
					(i.prototype.loadTile = function (e, i) {
						var o = this,
							r = t.normalizeTileURL(
								e.tileID.canonical.url(this.tiles, this.scheme),
								this.url,
								this.tileSize,
							);
						e.request = t.getImage(
							this.map._transformRequest(r, t.ResourceType.Tile),
							function (r, a) {
								if ((delete e.request, e.aborted))
									(e.state = "unloaded"), i(null);
									...
									(e.texture = o.map.painter.getTileTexture(a.width)),
										e.texture
											? e.texture.update(a, { useMipmap: !0 })
											: ((e.texture = new t.Texture(n, a, s.RGBA, {
												...
												n.extTextureFilterAnisotropic &&
													s.texParameterf(
														s.TEXTURE_2D,
														n.extTextureFilterAnisotropic
															.TEXTURE_MAX_ANISOTROPY_EXT,
														n.extTextureFilterAnisotropicMax,
													)),
										(e.state = "loaded"),
										i(null);
								}
			...
			S = (function (e) {
				...
				return (
					...
					(i.prototype.loadTile = function (e, i) {
						...
						(e.request = t.getImage(
							this.map._transformRequest(o, t.ResourceType.Tile),
							function (o, r) {
								if ((delete e.request, e.aborted))
									(e.state = "unloaded"), i(null);
					...
					(i.prototype._getNeighboringTiles = function (e) {
						var i = e.canonical,
							...
							l = {};
						return (
							(l[new t.OverscaledTileID(e.overscaledZ, a, i.z, r, i.y).key] = {
								backfilled: !1,
							}),
							...
							i.y > 0 &&
								((l[
									new t.OverscaledTileID(e.overscaledZ, a, i.z, r, i.y - 1).key
								] = { backfilled: !1 }),
								(l[
								...
								(l[
									new t.OverscaledTileID(e.overscaledZ, s, i.z, n, i.y - 1).key
								] = { backfilled: !1 })),
							i.y + 1 < o &&
								((l[
									new t.OverscaledTileID(e.overscaledZ, a, i.z, r, i.y + 1).key
					...
					this.workerOptions = t.extend(
						{
							...
							geojsonVtOptions: {
								...
								tolerance: (void 0 !== o.tolerance ? o.tolerance : 0.375) * n,
								extent: t.EXTENT,
								maxZoom: this.maxzoom,
						...
						this.fire(new t.Event("dataloading", { dataType: "source" })),
							this._updateWorkerData(function (i) {
								if (i) e.fire(new t.ErrorEvent(i));
									...
									var o = { dataType: "source", sourceDataType: "metadata" };
									e._collectResourceTiming &&
										e._resourceTiming &&
										e._resourceTiming.length > 0 &&
										((o.resourceTiming = e._resourceTiming),
										(e._resourceTiming = [])),
						...
						return (
							...
							this._updateWorkerData(function (e) {
								if (e) i.fire(new t.ErrorEvent(e));
									...
									var o = { dataType: "source", sourceDataType: "content" };
									i._collectResourceTiming &&
										i._resourceTiming &&
										i._resourceTiming.length > 0 &&
										((o.resourceTiming = i._resourceTiming),
										(i._resourceTiming = [])),
					...
					(i.prototype.getClusterLeaves = function (t, e, i, o) {
						return (
							this.dispatcher.send(
								...
								{ source: this.id, clusterId: t, limit: e, offset: i },
								o,
								this.workerID,
							),
							this
							...
							(this.workerID = this.dispatcher.send(
								...
								function (t, r) {
									i._removed ||
										...
										r &&
											r.resourceTiming &&
											r.resourceTiming[i.id] &&
											(i._resourceTiming = r.resourceTiming[i.id].slice(0)),
										i.dispatcher.send(
											i.type + ".coalesce",
											{ source: o.source },
											null,
							...
							function (t, a) {
								return (
									...
									e.aborted
										...
										: t
											? i(t)
											: (e.loadVectorData(a, o.map.painter, "reloadTile" === r),
												i(null))
								);
							},
							this.workerID,
				...
				return (
					...
					(i.prototype.load = function (e, i) {
						...
						this.fire(new t.Event("dataloading", { dataType: "source" })),
							...
							t.getImage(
								this.map._transformRequest(this.url, t.ResourceType.Image),
								function (r, a) {
									r
										? o.fire(new t.ErrorEvent(r))
										: a &&
											((o.image = a),
											e && (o.coordinates = e),
											i && i(),
					...
					(i.prototype.setCoordinates = function (e) {
						...
						(this.tileID = (function (e) {
							for (
								var i = 1 / 0, o = 1 / 0, r = -1 / 0, a = -1 / 0, n = 0, s = e;
								n < s.length;
								n += 1
							) {
								var l = s[n];
					...
					(i.prototype.prepare = function () {
						if (0 !== Object.keys(this.tiles).length && this.image) {
							var e = this.map.painter.context,
								i = e.gl;
							for (var o in (this.boundsBuffer ||
								(this.boundsBuffer = e.createVertexBuffer(
									this._boundsArray,
									t.rasterBoundsAttributes.members,
								)),
							this.boundsSegments ||
							...
							this.texture ||
								((this.texture = new t.Texture(e, this.image, i.RGBA)),
		...
		var P = {
					...
					return (
						...
						(i.prototype.load = function () {
							...
							for (var o = 0, r = i.urls; o < r.length; o += 1) {
								var a = r[o];
								this.urls.push(
									this.map._transformRequest(a, t.ResourceType.Source).url,
								);
							}
						...
						(i.prototype.prepare = function () {
							if (
								...
								this.texture
									...
									: ((this.texture = new t.Texture(e, this.video, i.RGBA)),
										this.texture.bind(i.LINEAR, i.CLAMP_TO_EDGE)),
								this.tiles)) {
									var r = this.tiles[o];
									"loaded" !== r.state &&
				...
				canvas: (function (e) {
						...
						e.call(this, i, o, r, a),
							o.coordinates
								? (Array.isArray(o.coordinates) &&
										4 === o.coordinates.length &&
										!o.coordinates.some(function (t) {
											return (
												!Array.isArray(t) ||
												2 !== t.length ||
												t.some(function (t) {
							...
							o.canvas
								? "string" == typeof o.canvas ||
									o.canvas instanceof t.window.HTMLCanvasElement ||
									this.fire(
										new t.ErrorEvent(
											new t.ValidationError(
												"sources." + i,
					...
					return (
						...
						(i.prototype.load = function () {
							this.canvas ||
								(this.canvas =
									this.options.canvas instanceof t.window.HTMLCanvasElement
										? this.options.canvas
										: t.window.document.getElementById(this.options.canvas)),
			...
			D = function (e, i, o, r) {
				...
				if (a.id !== e)
					throw new Error(
						"Expected Source id to be " + e + " instead of " + a.id,
					);
				return (
					t.bindAll(["load", "abort", "unload", "serialize", "prepare"], a), a
				);
			};
		function R(e, i) {
			var o = t.identity([]);
			return (
				t.translate(o, o, [1, 1, 0]),
				t.scale(o, o, [0.5 * e.width, 0.5 * e.height, 1]),
		...
		var N = (function (e) {
			...
			xt = function (t, e, i) {
				...
				(this.colorAttachment = new vt(t, r)),
					(this.depthAttachment = new yt(t, r));
			};
		...
		(bt.ReadOnly = !1),
			(bt.ReadWrite = !0),
			(bt.disabled = new bt(519, bt.ReadOnly, [0, 1]));
		...
		(Et.Replace = [1, 0]),
			(Et.disabled = new Et(Et.Replace, t.Color.transparent, [!1, !1, !1, !1])),
			(Et.unblended = new Et(Et.Replace, t.Color.transparent, [
				!0,
				!0,
				!0,
				!0,
			])),
			(Et.alphaBlended = new Et([1, 771], t.Color.transparent, [
				!0,
				!0,
				!0,
				!0,
		...
		(Tt.disabled = new Tt(!1, 1029, 2305)),
			(Tt.backCCW = new Tt(!0, 1029, 2305));
		var It = function (t) {
			(this.gl = t),
				(this.extVertexArrayObject = this.gl.getExtension(
					"OES_vertex_array_object",
				)),
				(this.clearColor = new N(this)),
				(this.clearDepth = new Z(this)),
				(this.clearStencil = new j(this)),
				(this.colorMask = new V(this)),
				(this.depthMask = new q(this)),
				(this.stencilMask = new G(this)),
				(this.stencilFunc = new W(this)),
				(this.stencilOp = new X(this)),
				(this.stencilTest = new H(this)),
				(this.depthRange = new K(this)),
				(this.depthTest = new Y(this)),
				(this.depthFunc = new J(this)),
				(this.blend = new Q(this)),
				(this.blendFunc = new $(this)),
				(this.blendColor = new tt(this)),
				(this.blendEquation = new et(this)),
				(this.cullFace = new it(this)),
				(this.cullFaceSide = new ot(this)),
				(this.frontFace = new rt(this)),
				(this.program = new at(this)),
				(this.activeTexture = new nt(this)),
				(this.viewport = new st(this)),
				(this.bindFramebuffer = new lt(this)),
				(this.bindRenderbuffer = new ct(this)),
				(this.bindTexture = new ut(this)),
				(this.bindVertexBuffer = new ht(this)),
				(this.bindElementBuffer = new pt(this)),
				(this.bindVertexArrayOES = this.extVertexArrayObject && new dt(this)),
				(this.pixelStoreUnpack = new _t(this)),
				(this.pixelStoreUnpackPremultiplyAlpha = new ft(this)),
				(this.pixelStoreUnpackFlipY = new mt(this)),
		...
		(It.prototype.setDirty = function () {
			...
			(It.prototype.setColorMode = function (e) {
				t.isEqual(e.blendFunction, Et.Replace)
					? this.blend.set(!1)
					: (this.blend.set(!0),
		...
		var Ct = (function (e) {
					...
					this.on("data", function (t) {
						"source" === t.dataType &&
							...
							a._sourceLoaded &&
								...
								(a.reload(), a.transform && a.update(a.transform));
					}),
					this.on("error", function () {
						a._sourceErrored = !0;
					}),
					(this._source = D(i, o, r, this)),
					(this._tiles = {}),
					(this._cache = new k(0, this._unloadTile.bind(this))),
					(this._timers = {}),
					(this._cacheTimers = {}),
			...
			return (
					...
					return e
						? o.sort(function (e, o) {
								var r = i._tiles[e].tileID,
									a = i._tiles[o].tileID,
									n = new t.Point(r.canonical.x, r.canonical.y)._rotate(
										i.transform.angle,
									),
									s = new t.Point(a.canonical.x, a.canonical.y)._rotate(
										i.transform.angle,
									);
				...
				(i.prototype._tileLoaded = function (e, i, o, r) {
					if (r)
						return (
							(e.state = "errored"),
							void (404 !== r.status
								? this._source.fire(new t.ErrorEvent(r, { tile: e }))
				...
				(i.prototype._backfillDEM = function (t) {
					...
					function a(t, e) {
						...
						(0 === i && 0 === o) ||
							...
							e.dem &&
								t.dem &&
								(t.dem.backfillBorder(e.dem, i, o),
								t.neighboringTiles &&
					...
					for (var r in this._tiles) {
						...
						if (
							!(
								o[r] ||
								!a.hasData() ||
								a.tileID.overscaledZ <= e ||
								a.tileID.overscaledZ > i
							)
						) {
				...
				(i.prototype.updateCacheSize = function (t) {
					var e =
							(Math.ceil(t.width / this._source.tileSize) + 1) *
							(Math.ceil(t.height / this._source.tileSize) + 1),
						i = Math.floor(5 * e),
						o =
					...
					if (((this.transform = e), this._sourceLoaded && !this._paused)) {
						...
						this.updateCacheSize(e),
							...
							this.used
								...
								: (r = []);
						var a = (this._source.roundZoom ? Math.round : Math.floor)(
								this.getZoom(e),
							),
						...
						for (
							var y = 0, x = t.keysDifference(this._tiles, l);
							y < x.length;
							y += 1
						) {
							var b = x[y],
				...
				(i.prototype._updateRetainedTiles = function (t, e) {
					for (
						var o = {},
							r = {},
							a = Math.max(e - i.maxOverzooming, this._source.minzoom),
							n = Math.max(e + i.maxUnderzooming, this._source.minzoom),
							s = {},
							l = 0,
							c = t;
						l < c.length;
					...
					for (var p = 0, d = t; p < d.length; p += 1) {
						...
						if (!f.hasData()) {
							if (e + 1 > this._source.maxzoom) {
								...
								if (o[v[0].key] && o[v[1].key] && o[v[2].key] && o[v[3].key])
									continue;
							}
							for (
								var y = f.wasRequested(), x = _.overscaledZ - 1;
								x >= a;
								--x
							) {
								var b = _.scaledTo(x);
								...
								if (
									((r[b.key] = !0),
									!(f = this.getTile(b)) && y && (f = this._addTile(b)),
									f && ((o[b.key] = b), (y = f.wasRequested()), f.hasData()))
								)
									break;
							}
						}
				...
				(i.prototype._addTile = function (e) {
					...
					return (
						o ||
							((i = new t.Tile(e, this._source.tileSize * e.overscaleFactor())),
							this._loadTile(
								i,
								this._tileLoaded.bind(this, i, e.key, i.state),
							)),
						i
							? (i.uses++,
								(this._tiles[e.key] = i),
				...
				(i.prototype.tilesIn = function (e, i, o) {
					...
					if (!n) return a;
					for (
						var s = o ? n.getCameraQueryGeometry(e) : e,
							l = e.map(function (t) {
						...
						var v = function (e) {
								...
								if (!o.holdingForFade()) {
									var s = o.tileID,
										...
										g = [
											s.getTilePoint(new t.MercatorCoordinate(h, p)),
											s.getTilePoint(new t.MercatorCoordinate(d, _)),
										];
									if (
										g[0].x - m < t.EXTENT &&
										g[0].y - m < t.EXTENT &&
		...
		function At(t) {
			...
			for (var o = 0; o < t.length; o++)
				"ref" in t[o] && (t[o] = Mt(t[o], e[t[o].ref]));
			return t;
		}
		...
		function Bt(t, e, i) {
			i.push({ command: kt.addSource, args: [t, e[t]] });
		}
		function Ot(t, e, i) {
			e.push({ command: kt.removeSource, args: [t] }), (i[t] = !0);
		}
		function Ft(t, e, i, o) {
			Ot(t, i, o), Bt(t, e, i);
		}
		function Ut(e, i, o) {
			...
			for (r in e[o])
				if (
					e[o].hasOwnProperty(r) &&
					"data" !== r &&
					!t.isEqual(e[o][r], i[o][r])
				)
					return !1;
			for (r in i[o])
				if (
		...
		function Nt(e, i, o, r, a, n) {
			...
			for (s in ((i = i || {}), (e = e || {})))
				e.hasOwnProperty(s) &&
					(t.isEqual(e[s], i[s]) ||
						o.push({ command: n, args: [r, s, i[s], a] }));
			for (s in i)
				i.hasOwnProperty(s) &&
					!e.hasOwnProperty(s) &&
					(t.isEqual(e[s], i[s]) ||
		...
		function Vt(e, i) {
			if (!e) return [{ command: kt.setStyle, args: [i] }];
			var o = [];
			try {
				if (!t.isEqual(e.version, i.version))
					return [{ command: kt.setStyle, args: [i] }];
				t.isEqual(e.center, i.center) ||
					o.push({ command: kt.setCenter, args: [i.center] }),
					t.isEqual(e.zoom, i.zoom) ||
						o.push({ command: kt.setZoom, args: [i.zoom] }),
					t.isEqual(e.bearing, i.bearing) ||
						o.push({ command: kt.setBearing, args: [i.bearing] }),
					t.isEqual(e.pitch, i.pitch) ||
						o.push({ command: kt.setPitch, args: [i.pitch] }),
					t.isEqual(e.sprite, i.sprite) ||
						o.push({ command: kt.setSprite, args: [i.sprite] }),
					t.isEqual(e.glyphs, i.glyphs) ||
						o.push({ command: kt.setGlyphs, args: [i.glyphs] }),
					t.isEqual(e.transition, i.transition) ||
						o.push({ command: kt.setTransition, args: [i.transition] }),
					t.isEqual(e.light, i.light) ||
						o.push({ command: kt.setLight, args: [i.light] });
				var r = {},
					a = [];
				!(function (e, i, o, r) {
					var a;
					for (a in ((i = i || {}), (e = e || {})))
						e.hasOwnProperty(a) && (i.hasOwnProperty(a) || Ot(a, o, r));
					for (a in i)
						i.hasOwnProperty(a) &&
							(e.hasOwnProperty(a)
								? t.isEqual(e[a], i[a]) ||
				...
				e.layers &&
					e.layers.forEach(function (t) {
						r[t.source]
							? o.push({ command: kt.removeLayer, args: [t.id] })
							: n.push(t);
					}),
					(o = o.concat(a)),
					(function (e, i, o) {
						...
						for (r = 0, a = 0; r < h.length; r++)
							(n = h[r]),
								_.hasOwnProperty(n)
									? a++
									: (o.push({ command: kt.removeLayer, args: [n] }),
						...
						for (r = 0, a = 0; r < p.length; r++)
							(n = p[p.length - 1 - r]),
								f[f.length - 1 - r] !== n &&
									(d.hasOwnProperty(n)
										? (o.push({ command: kt.removeLayer, args: [n] }),
											f.splice(f.lastIndexOf(n, f.length - a), 1))
										: a++,
									(c = f[f.length - r]),
									o.push({ command: kt.addLayer, args: [_[n], c] }),
									f.splice(f.length - r, 0, n),
									(m[n] = !0));
						for (r = 0; r < p.length; r++)
							if (((s = d[(n = p[r])]), (l = _[n]), !m[n] && !t.isEqual(s, l)))
								if (
									t.isEqual(s.source, l.source) &&
									t.isEqual(s["source-layer"], l["source-layer"]) &&
									t.isEqual(s.type, l.type)
								) {
									for (u in (Nt(
										s.layout,
										l.layout,
										...
										n,
										null,
										kt.setLayoutProperty,
									),
									Nt(s.paint, l.paint, o, n, null, kt.setPaintProperty),
									t.isEqual(s.filter, l.filter) ||
										o.push({ command: kt.setFilter, args: [n, l.filter] }),
									(t.isEqual(s.minzoom, l.minzoom) &&
										t.isEqual(s.maxzoom, l.maxzoom)) ||
										o.push({
									...
									s))
										s.hasOwnProperty(u) &&
											...
											"maxzoom" !== u &&
											(0 === u.indexOf("paint.")
												? Nt(s[u], l[u], o, n, u.slice(6), kt.setPaintProperty)
												: t.isEqual(s[u], l[u]) ||
													o.push({
									...
									o.push({ command: kt.removeLayer, args: [n] }),
										...
										o.push({ command: kt.addLayer, args: [l, c] });
					})(n, i.layers, o);
			} catch (t) {
				console.warn("Unable to compute style diff:", t),
					(o = [{ command: kt.setStyle, args: [i] }]);
			}
			return o;
		}
		...
		(qt.prototype.keysLength = function () {
			...
			(qt.prototype._query = function (t, e, i, o, r, a) {
				if (i < 0 || t > this.width || o < 0 || e > this.height)
					return !r && [];
				var n = [];
				...
				var p = { hitTest: r, seenUids: { box: {}, circle: {} } };
				return (
					this._forEachCell(t, e, i, o, this._queryCell, n, p, a),
					r ? n.length > 0 : n
				);
			}),
			(qt.prototype._queryCircle = function (t, e, i, o, r) {
				var a = t - i,
					...
					s = e - i,
					l = e + i;
				if (n < 0 || a > this.width || l < 0 || s > this.height)
					return !o && [];
				var c = [],
					u = {
						hitTest: o,
				...
				return (
					this._forEachCell(a, s, n, l, this._queryCellCircle, c, u, r),
					o ? c.length > 0 : c
				);
			}),
		...
		function Wt(e, i, o, r, a) {
			...
			return (
				i
					? (t.identity(n),
						t.scale(n, n, [1 / a, 1 / a, 1]),
						o || t.rotateZ(n, n, r.angle))
					: (t.scale(n, n, [r.width / 2, -r.height / 2, 1]),
		...
		function Xt(e, i, o, r, a) {
			...
			return (
				i
					...
					: (t.scale(n, n, [1, -1, 1]),
						t.translate(n, n, [-1, -1, 0]),
						t.scale(n, n, [2 / r.width, 2 / r.height, 1])),
				n
			);
		}
		function Ht(e, i) {
		...
		function Yt(e, i, o, r, a, n, s, l) {
			var c = r ? e.textSizeData : e.iconSizeData,
				u = t.evaluateSizeForZoom(
					c,
					o.transform.zoom,
					Gt.properties[r ? "text-size" : "icon-size"],
				),
			...
			p.clear();
			for (
				var d = e.lineVertexArray,
					_ = r ? e.text.placedSymbolArray : e.icon.placedSymbolArray,
				...
				var v = _.get(g);
				if (v.hidden || (v.writingMode === t.WritingMode.vertical && !m))
					oe(v.numGlyphs, p);
				else {
					m = !1;
					var y = [v.anchorX, v.anchorY, 0, 1];
					if ((t.transformMat4(y, y, i), Kt(y, h))) {
						var x = 0.5 + (y[3] / o.transform.cameraToCenterDistance) * 0.5,
						...
						(m = C.useVertical),
							(C.notEnoughRoom ||
								m ||
								(C.needsFlipping &&
									$t(v, w, !0, l, i, a, n, e.glyphOffsetArray, d, p, T, E, I, f)
										.notEnoughRoom)) &&
								oe(v.numGlyphs, p);
		...
		function $t(e, i, o, r, a, n, s, l, c, u, h, p, d, _) {
			...
			if (e.numGlyphs > 1) {
				...
				var M = ee(
					m * l.getoffsetX(e.glyphStartIndex),
					g,
					v,
					o,
					h,
			...
			for (
				...
				if (((x = y), void 0 === (y = p[g]))) {
					...
					if (I.signedDistanceFromCamera > 0) y = p[g] = I.point;
						...
						var C = g - f;
						y = te(
							0 === b ? n : new t.Point(u.getx(C), u.gety(C)),
							T,
							x,
							E - b + 1,
							h,
			...
			return (
				...
				),
				{
					...
					tileDistance: d
						? {
								prevTileDistance:
									g - f === v ? 0 : u.gettileUnitDistanceFromAnchor(g - f),
		...
		function se(e, i, o) {
			return (
				i * (t.EXTENT / (e.tileSize * Math.pow(2, o - e.tileID.overscaledZ)))
			);
		}
		(ae.prototype.placeCollisionBox = function (t, e, i, o, r) {
			var a = this.projectAndGetPerspectiveRatio(
					o,
					t.anchorPointX,
					t.anchorPointY,
				),
				...
				c = t.x2 * n + a.point.x,
				u = t.y2 * n + a.point.y;
			return !this.isInsideGrid(s, l, c, u) ||
				(!e && this.grid.hitTest(s, l, c, u, r))
				? { box: [], offscreen: !1 }
				: { box: [s, l, c, u], offscreen: this.isOffscreen(s, l, c, u) };
		}),
			...
			(ae.prototype.placeCollisionCircles = function (
				e,
				i,
				o,
				r,
				...
				x &&
					...
					(S = this.approximateTileDistance(
						x.last.tileDistance,
						x.last.angle,
						I,
						f.cameraDistance,
				...
				for (var z = 0; z < e.length; z += 5) {
					...
					if (!x || R < -C || R > S) ne(e, z, !1);
						...
						var U = M.x - A,
							...
							j = M.y + A;
						if (
							((E = E && this.isOffscreen(U, N, Z, j)),
							(w = w || this.isInsideGrid(U, N, Z, j)),
							!i && this.grid.hitTestCircle(M.x, M.y, A, d))
						) {
							if (!h) return { circles: [], offscreen: !1 };
							b = !0;
						}
					}
				}
				return { circles: b || !w ? [] : _, offscreen: E };
			}),
			(ae.prototype.queryRenderedSymbols = function (e) {
				...
				for (
					var h = {},
						...
						_ = this.grid
							.query(o, r, a, n)
							.concat(this.ignoredGrid.query(o, r, a, n));
					d < _.length;
					d += 1
				) {
					var f = _[d],
						m = f.key;
					if (
						(void 0 === h[m.bucketInstanceId] && (h[m.bucketInstanceId] = {}),
						!h[m.bucketInstanceId][m.featureIndex])
					) {
						var g = [
							new t.Point(f.x1, f.y1),
							new t.Point(f.x2, f.y1),
							new t.Point(f.x2, f.y2),
							new t.Point(f.x1, f.y2),
						];
						t.polygonIntersectsPolygon(i, g) &&
							((h[m.bucketInstanceId][m.featureIndex] = !0),
							void 0 === p[m.bucketInstanceId] && (p[m.bucketInstanceId] = []),
							p[m.bucketInstanceId].push(m.featureIndex));
					}
				}
				return p;
			}),
			(ae.prototype.insertCollisionBox = function (t, e, i, o, r) {
				var a = { bucketInstanceId: i, featureIndex: o, collisionGroupID: r };
				(e ? this.ignoredGrid : this.grid).insert(a, t[0], t[1], t[2], t[3]);
			}),
			(ae.prototype.insertCollisionCircles = function (t, e, i, o, r) {
				for (
					var a = e ? this.ignoredGrid : this.grid,
						n = { bucketInstanceId: i, featureIndex: o, collisionGroupID: r },
						s = 0;
					s < t.length;
					s += 4
				)
			...
			(ae.prototype.projectAnchor = function (t, e, i) {
				...
				return (
					...
					{
						perspectiveRatio:
							0.5 + (this.transform.cameraToCenterDistance / o[3]) * 0.5,
						cameraDistance: o[3],
					}
				);
			}),
			(ae.prototype.projectPoint = function (e, i, o) {
				...
				return (
					re(r, r, e),
					new t.Point(
						((r[0] / r[3] + 1) / 2) * this.transform.width + 100,
			...
			(ae.prototype.projectAndGetPerspectiveRatio = function (e, i, o) {
				...
				return (
					re(r, r, e),
					{
						...
						perspectiveRatio:
							0.5 + (this.transform.cameraToCenterDistance / r[3]) * 0.5,
					}
				);
			}),
		...
		var ce = function (t, e, i, o, r) {
			(this.text = new le(t ? t.text : null, e, i, r)),
				(this.icon = new le(t ? t.icon : null, e, o, r));
		};
		...
		var de = function (t, e, i) {
			(this.transform = t.clone()),
				(this.collisionIndex = new ae(this.transform)),
				(this.placements = {}),
				(this.opacities = {}),
				(this.stale = !1),
				(this.commitTime = 0),
		...
		(de.prototype.placeLayerTile = function (e, i, o, r) {
			...
			if (a && n && e.id === a.layerIds[0]) {
				...
				(this.retainedQueryData[a.bucketInstanceId] = new he(
					a.bucketInstanceId,
					n,
					a.sourceLayerIndex,
					a.index,
			...
			(de.prototype.placeLayerBucket = function (e, i, o, r, a, n, s, l, c, u) {
				var h = e.layers[0].layout,
					p = t.evaluateSizeForZoom(
						e.textSizeData,
						this.transform.zoom,
						t.properties.layout.properties["text-size"],
					),
				...
				for (var x = 0; x < e.symbolInstances.length; x++) {
					...
					if (!c[b.crossTileID]) {
						...
						P.textFeatureIndex && (z = P.textFeatureIndex),
							P.textBox &&
								((w =
									(I = this.collisionIndex.placeCollisionBox(
										P.textBox,
										h.get("text-allow-overlap"),
										n,
										i,
										y.predicate,
									)).box.length > 0),
						...
						var D = P.textCircles;
						if (D) {
							var R = e.text.placedSymbolArray.get(
									b.horizontalPlacedTextSymbolIndex,
								),
								M = t.evaluateSizeForFeature(e.textSizeData, p, R);
							(C = this.collisionIndex.placeCollisionCircles(
								D,
								h.get("text-allow-overlap"),
								a,
								n,
								...
								o,
								s,
								"map" === h.get("text-pitch-alignment"),
								y.predicate,
							)),
								(w = h.get("text-allow-overlap") || C.circles.length > 0),
								(T = T && C.offscreen);
						}
						P.iconFeatureIndex && (L = P.iconFeatureIndex),
							P.iconBox &&
								((E =
									(S = this.collisionIndex.placeCollisionBox(
										P.iconBox,
										h.get("icon-allow-overlap"),
										n,
										i,
										y.predicate,
									)).box.length > 0),
						...
						A || k ? (k ? A || (E = E && w) : (w = E && w)) : (E = w = E && w),
							...
							(this.placements[b.crossTileID] = new ue(
								w || g,
								E || v,
								T || e.justReloaded,
							)),
			...
			(de.prototype.commit = function (t, e) {
				...
				for (var a in this.placements) {
					var n = this.placements[a],
						s = r[a];
					s
						? ((this.opacities[a] = new ce(s, o, n.text, n.icon)),
							(i = i || n.text !== s.text.placed || n.icon !== s.icon.placed))
						: ((this.opacities[a] = new ce(
								null,
								o,
								n.text,
								n.icon,
				...
				for (var l in r) {
					...
					if (!this.opacities[l]) {
						...
						u.isHidden() ||
							((this.opacities[l] = u),
							(i = i || c.text.placed || c.icon.placed));
					}
				}
				i
			...
			(de.prototype.updateLayerOpacities = function (t, e) {
				for (var i = {}, o = 0, r = e; o < r.length; o += 1) {
					...
					n &&
						...
						t.id === n.layerIds[0] &&
						this.updateBucketOpacities(n, i, a.collisionBoxArray);
				}
			}),
			(de.prototype.updateBucketOpacities = function (t, e, i) {
				...
				var o = t.layers[0].layout,
					...
					s = new ce(
						null,
						0,
						a && (n || !t.hasIconData() || o.get("icon-optional")),
						n && (a || !t.hasTextData() || o.get("text-optional")),
						!0,
					);
				!t.collisionArrays &&
					i &&
					(t.hasCollisionBoxData() || t.hasCollisionCircleData()) &&
					t.deserializeCollisionBoxes(i);
				for (var l = 0; l < t.symbolInstances.length; l++) {
					var c = t.symbolInstances.get(l),
						u = e[c.crossTileID],
						h = this.opacities[c.crossTileID];
					u ? (h = r) : h || ((h = s), (this.opacities[c.crossTileID] = h)),
						(e[c.crossTileID] = !0);
					...
					if (p) {
						for (
							var _ = we(h.text),
								f = (c.numGlyphVertices + c.numVerticalGlyphVertices) / 4,
								m = 0;
							m < f;
							m++
						)
							t.text.opacityVertexArray.emplaceBack(_);
						(t.text.placedSymbolArray.get(
							c.horizontalPlacedTextSymbolIndex,
						).hidden = h.text.isHidden()),
							c.verticalPlacedTextSymbolIndex >= 0 &&
								(t.text.placedSymbolArray.get(
									c.verticalPlacedTextSymbolIndex,
								).hidden = h.text.isHidden());
					}
					if (d) {
						for (var g = we(h.icon), v = 0; v < c.numIconVertices / 4; v++)
					...
					if (t.hasCollisionBoxData() || t.hasCollisionCircleData()) {
						...
						if (y) {
							y.textBox &&
								_e(t.collisionBox.collisionVertexArray, h.text.placed, !1),
								y.iconBox &&
									_e(t.collisionBox.collisionVertexArray, h.icon.placed, !1);
							var x = y.textCircles;
		...
		Ee.prototype.continuePlacement = function (t, e, i, o, r) {
			for (; this._currentTileIndex < t.length; ) {
				...
				if (
					(e.placeLayerTile(o, a, i, this._seenCrossTileIDs),
			...
			(Te.prototype.continuePlacement = function (e, i, o) {
				for (
					...
					if (
						...
						if (
							(this._inProgressLayer || (this._inProgressLayer = new Ee()),
			...
			(Ce.prototype.findMatches = function (t, e, i) {
				for (
					...
					if (!a.crossTileID) {
						...
						if (n)
							for (
								var s = this.getScaledCoordinates(a, e), l = 0, c = n;
								l < c.length;
								l += 1
							) {
								var u = c[l];
								if (
									Math.abs(u.coord.x - s.x) <= o &&
									Math.abs(u.coord.y - s.y) <= o &&
									!i[u.crossTileID]
								) {
		...
		(ze.prototype.handleWrapJump = function (t) {
			...
			(ze.prototype.addBucket = function (t, e, i) {
				...
				for (var u = 0; u < e.symbolInstances.length; u++) {
					...
					h.crossTileID ||
						((h.crossTileID = i.generate()), (r[h.crossTileID] = !0));
				}
				return (
					void 0 === this.indexes[t.overscaledZ] &&
						(this.indexes[t.overscaledZ] = {}),
					(this.indexes[t.overscaledZ][t.key] = new Ce(
						t,
						e.symbolInstances,
						e.bucketInstanceId,
					)),
			...
			(ze.prototype.removeBucketCrossTileIDs = function (t, e) {
				for (var i in e.indexedSymbolInstances)
					for (
						var o = 0, r = e.indexedSymbolInstances[i];
						o < r.length;
						o += 1
					) {
						var a = r[o];
			...
			(ze.prototype.removeStaleBuckets = function (t) {
				...
				for (var i in this.indexes) {
					var o = this.indexes[i];
					for (var r in o)
						t[o[r].bucketInstanceId] ||
							(this.removeBucketCrossTileIDs(i, o[r]), delete o[r], (e = !0));
				}
				return e;
			});
		var Le = function () {
			(this.layerIndexes = {}),
				(this.crossTileIDs = new Se()),
		...
		(Le.prototype.addLayer = function (t, e, i) {
			...
			for (var n = 0, s = e; n < s.length; n += 1) {
				...
				c &&
					...
					o.addBucket(l.tileID, c, this.crossTileIDs) && (r = !0),
					(a[c.bucketInstanceId] = !0));
			}
			...
			Me = (function (e) {
				function i(o, r) {
					...
					void 0 === r && (r = {}),
						e.call(this),
						(this.map = o),
						(this.dispatcher = new w((Dt || (Dt = new Pt()), Dt), this)),
						(this.imageManager = new h()),
						(this.glyphManager = new g(
							o._transformRequest,
					...
					var n = this;
					(this._rtlTextPluginCallback = i.registerForPluginAvailability(
						function (t) {
							for (var e in (n.dispatcher.broadcast(
								"loadRTLTextPlugin",
								t.pluginURL,
				...
				return (
					...
					(i.prototype.loadURL = function (e, i) {
						...
						var r =
							"boolean" == typeof i.validate ? i.validate : !t.isMapboxURL(e);
					...
					(i.prototype._load = function (e, i) {
						...
						if (!i || !Pe(this, t.validateStyle(e))) {
							...
							(this.stylesheet = e),
							e.sources))
								this.addSource(r, e.sources[r], { validate: !1 });
							e.sprite
								? (this._spriteRequest = (function (e, i, o) {
											...
											if (n) o(n);
												...
												for (var s in r) {
													var l = r[s],
														...
														d = l.sdf,
														_ = l.pixelRatio,
														f = new t.RGBAImage({ width: c, height: u });
													t.RGBAImage.copy(
														e,
														f,
														{ x: h, y: p },
										...
										if (((o._spriteRequest = null), e))
											o.fire(new t.ErrorEvent(e));
										else if (i)
											for (var r in i) o.imageManager.addImage(r, i[r]);
										o.imageManager.setLoaded(!0),
											o.fire(new t.Event("data", { dataType: "style" }));
									}))
					...
					(i.prototype._validateLayer = function (e) {
						...
						if (i) {
							...
							if (o) {
								var r = i.getSource();
								("geojson" === r.type ||
									(r.vectorLayerIds && -1 === r.vectorLayerIds.indexOf(o))) &&
									this.fire(
										new t.ErrorEvent(
											new Error(
												'Source layer "' +
					...
					(i.prototype.update = function (e) {
						if (this._loaded) {
							...
							if (this._changed) {
								...
								for (var a in ((o.length || r.length) &&
									this._updateWorkerLayers(o, r),
								this._updatedSources)) {
									var n = this._updatedSources[a];
									"reload" === n
										? this._reloadSource(a)
										: "clear" === n && this._clearSource(a);
								}
							...
							this.light.recalculate(e),
								(this.z = e.zoom),
								i && this.fire(new t.Event("data", { dataType: "style" }));
						}
					}),
					...
					(i.prototype.removeImage = function (e) {
						if (!this.getImage(e))
							return this.fire(
								new t.ErrorEvent(new Error("No image with this name exists.")),
							);
					...
					(i.prototype.addLayer = function (e, i, o) {
						...
						if (this.getLayer(r))
							...
							if ("custom" === e.type) {
								...
								if (
									("object" == typeof e.source &&
										(this.addSource(r, e.source),
										(e = t.clone(e)),
										(e = t.extend(e, { source: r }))),
									this._validate(
								...
								(a = t.createStyleLayer(e)),
									...
									a.setEventedParent(this, { layer: { id: r } });
							}
							...
							if (i && -1 === n)
								...
								if (
									(this._order.splice(n, 0, r),
									(this._layerOrderChanged = !0),
									(this._layers[r] = a),
									this._removedLayers[r] && a.source && "custom" !== a.type)
								) {
								...
								return null == i
									...
									: void (
											this._validate(
												...
												null,
												o,
											) || ((r.filter = t.clone(i)), this._updateLayer(r))
										);
						} else
							this.fire(
								new t.ErrorEvent(
					...
					(i.prototype.setLayoutProperty = function (e, i, o, r) {
						...
						a
							? t.isEqual(a.getLayoutProperty(i), o) ||
								(a.setLayoutProperty(i, o, r), this._updateLayer(a))
							: this.fire(
									new t.ErrorEvent(
										new Error(
											"The layer '" +
					...
					(i.prototype.setPaintProperty = function (e, i, o, r) {
						...
						var a = this.getLayer(e);
						a
							? t.isEqual(a.getPaintProperty(i), o) ||
								(a.setPaintProperty(i, o, r) && this._updateLayer(a),
								(this._changed = !0),
					...
					(i.prototype.queryRenderedFeatures = function (e, i, o) {
						...
						for (var u in this.sourceCaches)
							(i.layers && !r[u]) ||
								c.push(M(this.sourceCaches[u], this._layers, e, i, o));
						return (
							this.placement &&
								c.push(
									(function (t, e, i, o, r, a) {
										for (
											var n = {},
												s = r.queryRenderedSymbols(i),
												l = [],
												c = 0,
												u = Object.keys(s).map(Number);
											c < u.length;
											c += 1
										) {
											var h = u[c];
										...
										for (
											var p = function () {
													var e = _[d],
														i = e.featureIndex.lookupSymbolFeatures(
															s[e.bucketInstanceId],
															e.bucketIndex,
															e.sourceLayerIndex,
															o.filter,
															o.layers,
					...
					(i.prototype.addSourceType = function (t, e, o) {
						return i.getSourceType(t)
							? o(new Error('A source type called "' + t + '" already exists.'))
							: (i.setSourceType(t, e),
								e.workerSourceURL
					...
					(i.prototype._updatePlacement = function (e, i, o, r) {
						for (
							var a = !1, n = !1, s = {}, l = 0, c = this._order;
							l < c.length;
							l += 1
						) {
							var u = c[l],
							...
							if ("symbol" === h.type) {
								...
								var d = this.crossTileSymbolIndex.addLayer(
									h,
									s[h.source],
									e.center.lng,
								);
						...
						if (
							((_ ||
								...
								(this.pauseablePlacement.isDone() &&
									!this.placement.stillRecent(t.browser.now()))) &&
								((this.pauseablePlacement = new Te(e, this._order, _, i, o, r)),
							...
							for (var f = 0, m = this._order; f < m.length; f += 1) {
								var g = m[f],
									v = this._layers[g];
								"symbol" === v.type &&
									this.placement.updateLayerOpacities(v, s[v.source]);
							}
						return (
							!this.pauseablePlacement.isDone() ||
		...
		var Ae = t.createLayout([{ name: "a_pos", type: "Int16", components: 2 }]),
			ke = si(
			...
			je = si(
				...
				"attribute vec2 a_pos;attribute vec2 a_anchor_pos;attribute vec2 a_extrude;attribute vec2 a_placed;uniform mat4 u_matrix;uniform vec2 u_extrude_scale;uniform float u_camera_to_center_distance;varying float v_placed;varying float v_notUsed;void main() {vec4 projectedPoint=u_matrix*vec4(a_anchor_pos,0,1);highp float camera_to_anchor_distance=projectedPoint.w;highp float collision_perspective_ratio=clamp(0.5+0.5*(u_camera_to_center_distance/camera_to_anchor_distance),0.0,4.0);gl_Position=u_matrix*vec4(a_pos,0.0,1.0);gl_Position.xy+=a_extrude*u_extrude_scale*gl_Position.w*collision_perspective_ratio;v_placed=a_placed.x;v_notUsed=a_placed.y;}",
			),
			Ve = si(
		...
		(ci.prototype.bind = function (t, e, i, o, r, a, n, s) {
			this.context = t;
			for (
				var l = this.boundPaintVertexBuffers.length !== o.length, c = 0;
				!l && c < o.length;
				c++
			)
		...
		var ui = function (e, i, o, r, a) {
			...
			var s = o
				.defines()
				.concat(
					"#define DEVICE_PIXEL_RATIO " + t.browser.devicePixelRatio.toFixed(1),
				);
			...
			n.linkProgram(this.program),
				(this.numAttributes = n.getProgramParameter(
					this.program,
					n.ACTIVE_ATTRIBUTES,
				)),
				(this.attributes = {});
			for (var _ = {}, f = 0; f < this.numAttributes; f++) {
				...
				m &&
					(this.attributes[m.name] = n.getAttribLocation(this.program, m.name));
			}
			for (
				var g = n.getProgramParameter(this.program, n.ACTIVE_UNIFORMS), v = 0;
				v < g;
				v++
			) {
		...
		ui.prototype.draw = function (
			...
			var m,
				g = t.gl;
			for (var v in (t.program.set(this.program),
			t.setDepthMode(i),
			t.setStencilMode(o),
			t.setColorMode(r),
			t.setCullFace(a),
		...
		var pi = function (e, i, o) {
				var r = i.style.light,
					...
					n = [a.x, a.y, a.z],
					s = t.create();
				"viewport" === r.properties.get("anchor") &&
					t.fromRotation(s, -i.transform.angle),
					t.transformMat3(n, n, s);
			...
			vi = function (e, i, o, r, a) {
				return t.extend(mi(e, i, o, r), { u_world: a });
			},
			yi = function (t, e, i, o) {
				var r,
					a,
			...
			bi = function (t, e, i) {
				...
				return {
					...
					u_extrude_scale: [
						e.pixelsToGLUnits[0] / (o * r),
						e.pixelsToGLUnits[1] / (o * r),
					],
			...
			Ti = function (t, e, i, o) {
				return { u_matrix: t, u_extrude_scale: se(e, 1, i), u_intensity: o };
			},
			Ii = function (e, i, o, r) {
				var a = t.create$1();
			...
			Si = function (e, i) {
				var o = e.dem.stride,
					r = t.create$1();
				return (
					t.ortho(r, 0, t.EXTENT, -t.EXTENT, 0, 0, 1),
		...
		function zi(e, i) {
			var o = Math.pow(2, i.canonical.z),
				r = i.canonical.y;
			return [
				new t.MercatorCoordinate(0, r / o).toLngLat().lat,
				new t.MercatorCoordinate(0, (r + 1) / o).toLngLat().lat,
			];
		}
		var Li = function (t, e, i) {
			...
			Pi = function (e, i, o) {
				return t.extend(Li(e, i, o), { u_image: 0 });
			},
			Di = function (e, i, o, r) {
				var a = e.transform,
					n = Mi(i, a);
			...
			Ri = function (e, i, o, r, a) {
				...
				return t.extend(Li(e, i, o), {
					...
					u_sdfgamma:
						s.width / (256 * Math.min(p, d) * t.browser.devicePixelRatio) / 2,
					u_image: 0,
					u_tex_y_a: u.y,
					u_tex_y_b: h.y,
					u_mix: a.t,
		...
		var ki = function (t, e, i, o, r) {
			return {
				...
				u_saturation_factor:
					((n = r.paint.get("raster-saturation")),
					n > 0 ? 1 - 1 / (1.001 - n) : -n),
				u_contrast_factor:
		...
		var Oi = function (t, e, i, o, r, a, n, s, l, c) {
			...
			Zi = {
				...
				fill: function (e, i) {
					return { u_matrix: new t.UniformMatrix4f(e, i.u_matrix) };
				},
		...
		function ji(e, i) {
			for (
				var o = e.sort(function (t, e) {
						return t.tileID.isLessThan(e.tileID)
							? -1
				...
				Vi(
					...
					n.tileID,
					s,
					new t.OverscaledTileID(0, n.tileID.wrap + 1, 0, 0, 0),
					a,
				),
					n.setMask(a, i);
			}
		...
		function Vi(e, i, o, r, a) {
			...
			var u = i.overscaledZ - e.overscaledZ,
				h = new t.CanonicalTileID(
					u,
					i.canonical.x - (e.canonical.x << u),
					i.canonical.y - (e.canonical.y << u),
				);
			a[h.key] = a[h.key] || h;
		}
		function qi(t, e, i, o, r) {
			for (
				var a = t.context,
					n = a.gl,
					s = r
						? t.useProgram("collisionCircle")
						: t.useProgram("collisionBox"),
					l = 0;
				l < o.length;
				l++
			) {
				...
				if (h) {
					...
					p &&
						s.draw(
							a,
							r ? n.TRIANGLES : n.LINES,
							bt.disabled,
							wt.disabled,
							t.colorModeForRenderPass(),
							Tt.disabled,
							bi(c.posMatrix, t.transform, u),
							i.id,
		...
		function Xi(e, i, o, r, a, n, s, l, c, u, h, p) {
			for (
				var d,
					...
					v = "map" === l,
					y = "map" === c,
					x = v && "point" !== o.layout.get("symbol-placement"),
					b = v && !y && !x,
					w = void 0 !== o.layout.get("symbol-sort-key").constantOr(1),
					E = e.depthModeForSublayer(0, bt.ReadOnly),
					T = [],
					I = 0,
					C = r;
				I < C.length;
				...
				if (L) {
					...
					if (P && P.segments.get().length) {
						...
						d ||
							((d = e.useProgram(R ? "symbolSDF" : "symbolIcon", D)),
							(_ = t.evaluateSizeForZoom(
								M,
								g.zoom,
								Wi.properties[a ? "text-size" : "icon-size"],
							))),
						...
						var A = void 0,
							...
							B = void 0;
						if (a)
							(k = z.glyphAtlasTexture),
								(B = m.LINEAR),
								(A = z.glyphAtlasTexture.size);
						else {
							var O =
									1 !== o.layout.get("icon-size").constantOr(0) ||
									L.iconsNeedLinear,
								F = y || 0 !== g.pitch;
							(k = z.imageAtlasTexture),
								(B =
									R || e.options.rotating || e.options.zooming || O || F
										? m.LINEAR
										: m.NEAREST),
								(A = z.imageAtlasTexture.size);
						}
						...
						var j = e.translatePosMatrix(S.posMatrix, z, n, s),
							...
							W = {
								...
								buffers: P,
								uniformValues: R
									? Fi(M.functionType, _, b, y, e, j, V, q, a, A, !0)
									: Oi(M.functionType, _, b, y, e, j, V, q, a, A),
								atlasTexture: k,
						...
						if (w)
							for (var X = 0, H = P.segments.get(); X < H.length; X += 1) {
								var K = H[X];
								T.push({
						...
						else T.push({ segments: P.segments, sortKey: 0, state: W });
					}
				}
			}
			w &&
			...
			for (var Y = 0, J = T; Y < J.length; Y += 1) {
				var Q = J[Y],
					$ = Q.state;
				if (
					($.atlasTexture.bind($.atlasInterpolation, m.CLAMP_TO_EDGE), $.isSDF)
				) {
					var tt = $.uniformValues;
					$.hasHalo &&
						((tt.u_is_halo = 1),
						Hi($.buffers, Q.segments, o, e, $.program, E, h, p, tt)),
						(tt.u_is_halo = 0);
				}
		...
		function Ki(t, e, i, o, r, a, n) {
			...
			n
				? ((l =
						_ && !i.getPaintProperty("fill-outline-color")
							? "fillOutlinePattern"
							: "fillOutline"),
					(s = p.LINES))
				...
				if (!_ || y.patternsLoaded()) {
					...
					if (x) {
						var b = x.programConfigurations.get(i.id),
							w = t.useProgram(l, b);
						_ &&
							(t.context.activeTexture.set(p.TEXTURE0),
							y.imageAtlasTexture.bind(p.LINEAR, p.CLAMP_TO_EDGE),
							b.updatePatternPaintBuffers(f));
						...
						if (n) {
							...
							c =
								"fillOutlinePattern" === l && _ ? vi(C, t, f, y, S) : gi(C, S);
						} else
							(u = x.indexBuffer),
								(h = x.segments),
								(c = _ ? mi(C, t, f, y) : fi(C));
		...
		function Yi(e, i) {
			...
			if ((e.depthRboNeedsClear && e.setupOffscreenDepthRenderbuffer(), !a)) {
				var n = new t.Texture(
					o,
					{ width: e.width, height: e.height, data: null },
					r.RGBA,
				);
				n.bind(r.LINEAR, r.CLAMP_TO_EDGE),
					(a = i.viewportFrame =
						o.createFramebuffer(e.width, e.height)).colorAttachment.set(
						n.texture,
					);
			}
			o.bindFramebuffer.set(a.framebuffer),
				a.depthAttachment.set(e.depthRbo),
				e.depthRboNeedsClear &&
					(o.clear({ depth: 1 }), (e.depthRboNeedsClear = !1)),
				o.clear({ color: t.Color.transparent }),
				o.setStencilMode(wt.disabled),
				o.setDepthMode(new bt(r.LEQUAL, bt.ReadWrite, [0, 1])),
		...
		function Ji(t, e, i) {
			...
			if (o) {
				...
				r.activeTexture.set(a.TEXTURE0),
					a.bindTexture(a.TEXTURE_2D, o.colorAttachment.get()),
					t
		...
		function Qi(t, e, i, o, r, a) {
			...
			if (l) {
				...
				var u = Ci(t, e, i);
				e.maskedBoundsBuffer && e.maskedIndexBuffer && e.segments
					? c.draw(
							n,
							s.TRIANGLES,
							o,
		...
		function $i(e, i, o, r, a, n, s) {
			...
			if (i.dem && i.dem.data) {
				...
				if (
					...
					(i.demTexture = i.demTexture || e.getTileTexture(h)),
					i.demTexture)
				) {
					var d = i.demTexture;
					d.update(p, { premultiply: !1 }), d.bind(c.NEAREST, c.CLAMP_TO_EDGE);
				} else
					(i.demTexture = new t.Texture(l, p, c.RGBA, { premultiply: !1 })),
						i.demTexture.bind(c.NEAREST, c.CLAMP_TO_EDGE);
				l.activeTexture.set(c.TEXTURE0);
				var _ = i.fbo;
				if (!_) {
					var f = new t.Texture(l, { width: u, height: u, data: null }, c.RGBA);
					f.bind(c.LINEAR, c.CLAMP_TO_EDGE),
						(_ = i.fbo = l.createFramebuffer(u, u)).colorAttachment.set(
							f.texture,
						);
				}
							...
							if ((l = io[t[r]])) {
								for (h = null, n = 0, s = l[1].length; n < s; n += 2)
									-1 === l[1][n] && -1 === l[1][n + 1]
										...
										: ((c = e + l[1][n] * o),
											(u = i - l[1][n + 1] * o),
											h && p.push(h.x, h.y, c, u),
											(h = { x: c, y: u }));
								e += l[0] * o;
							}
						return p;
					})(o.toString(), 50, 200, 5),
					d = new t.StructArrayLayout2i4(),
					_ = new t.StructArrayLayout2ui4(),
					f = 0;
				f < p.length;
				f += 2
			)
				d.emplaceBack(p[f], p[f + 1]), _.emplaceBack(f, f + 1);
			for (
				var m = r.createVertexBuffer(d, Ae.members),
					g = r.createIndexBuffer(_),
					v = t.SegmentVector.simpleSegment(0, 0, d.length / 2, d.length / 2),
					y = i.getTile(o).tileSize,
					x = t.EXTENT / (Math.pow(2, e.transform.zoom - o.overscaledZ) * y),
					b = [
						[-1, -1],
						[-1, 1],
						[1, -1],
				...
				s.draw(
					...
					u,
					Tt.disabled,
					wi(t.translate([], n, [x * E[0], x * E[1], 0]), t.Color.white),
					h,
					m,
					g,
					v,
		...
		var io = {
			...
			"#": [
				21,
				[
					11, 25, 4, -7, -1, -1, 17, 25, 10, -7, -1, -1, 4, 12, 18, 12, -1, -1,
					3, 6, 17, 6,
				],
			],
			$: [
				20,
				[
					8, 25, 8, -4, -1, -1, 12, 25, 12, -4, -1, -1, 17, 18, 15, 20, 12, 21,
					8, 21, 5, 20, 3, 18, 3, 16, 4, 14, 5, 13, 7, 12, 13, 10, 15, 9, 16, 8,
			...
			"%": [
				...
				[
					...
					16, 3, 18, 4, 20, 6, 21, 8, 21, 10, 20, 13, 19, 16, 19, 19, 20, 21,
					21, -1, -1, 17, 7, 15, 6, 14, 4, 14, 2, 16, 0, 18, 0, 20, 1, 21, 3,
					21, 5, 19, 7, 17, 7,
				],
			],
			"&": [
				26,
				[
					23, 12, 23, 13, 22, 14, 21, 14, 20, 13, 19, 11, 17, 6, 15, 3, 13, 1,
					11, 0, 7, 0, 5, 1, 4, 2, 3, 4, 3, 6, 4, 8, 5, 9, 12, 13, 13, 14, 14,
					16, 14, 18, 13, 20, 11, 21, 9, 20, 8, 18, 8, 16, 9, 13, 11, 10, 16, 3,
			...
			3: [
				20,
				[
					5, 21, 16, 21, 10, 13, 13, 13, 15, 12, 16, 11, 17, 8, 17, 6, 16, 3,
			...
			6: [
				...
				[
					...
					10, 0, 11, 0, 14, 1, 16, 3, 17, 6, 17, 7, 16, 10, 14, 12, 11, 13, 10,
					13, 7, 12, 5, 10, 4, 7,
				],
			],
			...
			9: [
				...
				[
					...
					6, 20, 9, 21, 10, 21, 13, 20, 15, 18, 16, 14, 16, 9, 15, 4, 13, 1, 10,
					0, 8, 0, 5, 1, 4, 3,
				],
			],
			":": [
				10,
				[
					5, 14, 4, 13, 5, 12, 6, 13, 5, 14, -1, -1, 5, 2, 4, 1, 5, 0, 6, 1, 5,
					2,
				],
			],
			";": [
				10,
				[
					5, 14, 4, 13, 5, 12, 6, 13, 5, 14, -1, -1, 6, 1, 5, 0, 4, 1, 5, 2, 6,
					1, 6, -1, 5, -3, 4, -4,
				],
			],
			"<": [24, [20, 18, 4, 9, 20, 0]],
			...
			"?": [
				...
				[
					...
					15, 14, 13, 13, 12, 9, 10, 9, 7, -1, -1, 9, 2, 8, 1, 9, 0, 10, 1, 9,
					2,
				],
			],
			"@": [
				...
				[
					...
					12, 23, 15, 22, 17, 20, 19, 18, 20, 15, 21, 12, 21, 9, 20, 7, 19, 5,
					17, 4, 15, 3, 12, 3, 9, 4, 6, 5, 4, 7, 2, 9, 1, 12, 0, 15, 0, 18, 1,
			...
			B: [
				21,
				[
					4, 21, 4, 0, -1, -1, 4, 21, 13, 21, 16, 20, 17, 19, 18, 17, 18, 15,
					17, 13, 16, 12, 13, 11, -1, -1, 4, 11, 13, 11, 16, 10, 17, 9, 18, 7,
					18, 4, 17, 2, 16, 1, 13, 0, 4, 0,
				],
			],
			C: [
				21,
				[
					...
					8, 4, 5, 5, 3, 7, 1, 9, 0, 13, 0, 15, 1, 17, 3, 18, 5,
				],
			],
			D: [
				21,
				[
					4, 21, 4, 0, -1, -1, 4, 21, 11, 21, 14, 20, 16, 18, 17, 16, 18, 13,
					18, 8, 17, 5, 16, 3, 14, 1, 11, 0, 4, 0,
				],
			],
			E: [
				19,
			...
			G: [
				...
				[
					18, 16, 17, 18, 15, 20, 13, 21, 9, 21, 7, 20, 5, 18, 4, 16, 3, 13, 3,
					8, 4, 5, 5, 3, 7, 1, 9, 0, 13, 0, 15, 1, 17, 3, 18, 5, 18, 8, -1, -1,
					13, 8, 18, 8,
				],
			],
			...
			O: [
				22,
				[
					9, 21, 7, 20, 5, 18, 4, 16, 3, 13, 3, 8, 4, 5, 5, 3, 7, 1, 9, 0, 13,
			...
			P: [
				21,
				[
					4, 21, 4, 0, -1, -1, 4, 21, 13, 21, 16, 20, 17, 19, 18, 17, 18, 14,
					17, 12, 16, 11, 13, 10, 4, 10,
				],
			],
			Q: [
				22,
			...
			R: [
				...
				[
					4, 21, 4, 0, -1, -1, 4, 21, 13, 21, 16, 20, 17, 19, 18, 17, 18, 15,
					17, 13, 16, 12, 13, 11, 4, 11, -1, -1, 11, 11, 18, 0,
				],
			],
			S: [
				20,
				[
					...
					12, 13, 10, 15, 9, 16, 8, 17, 6, 17, 3, 15, 1, 12, 0, 8, 0, 5, 1, 3,
					3,
				],
			],
			...
			"]": [
				14,
				[
					9, 25, 9, -7, -1, -1, 10, 25, 10, -7, -1, -1, 3, 25, 10, 25, -1, -1,
					3, -7, 10, -7,
				],
			],
			"^": [
			...
			b: [
				...
				[
					...
					8, 16, 6, 15, 3, 13, 1, 11, 0, 8, 0, 6, 1, 4, 3,
				],
			],
			c: [
				18,
				[
					15, 11, 13, 13, 11, 14, 8, 14, 6, 13, 4, 11, 3, 8, 3, 6, 4, 3, 6, 1,
					8, 0, 11, 0, 13, 1, 15, 3,
				],
			],
			d: [
			...
			g: [
				19,
				[
					15, 14, 15, -2, 14, -5, 13, -6, 11, -7, 8, -7, 6, -6, -1, -1, 15, 11,
					13, 13, 11, 14, 8, 14, 6, 13, 4, 11, 3, 8, 3, 6, 4, 3, 6, 1, 8, 0, 11,
					0, 13, 1, 15, 3,
				],
			],
			h: [
			...
			j: [
				10,
				[
					5, 21, 6, 20, 7, 21, 6, 22, 5, 21, -1, -1, 6, 14, 6, -3, 5, -6, 3, -7,
					1, -7,
				],
			],
			...
			m: [
				...
				[
					...
					0, -1, -1, 15, 10, 18, 13, 20, 14, 23, 14, 25, 13, 26, 10, 26, 0,
				],
			],
			n: [
				19,
			...
			o: [
				19,
				[
					8, 14, 6, 13, 4, 11, 3, 8, 3, 6, 4, 3, 6, 1, 8, 0, 11, 0, 13, 1, 15,
			...
			q: [
				19,
				[
					15, 14, 15, -7, -1, -1, 15, 11, 13, 13, 11, 14, 8, 14, 6, 13, 4, 11,
			...
			s: [
				17,
				[
					14, 11, 13, 13, 10, 14, 7, 14, 4, 13, 3, 11, 4, 9, 6, 8, 11, 7, 13, 6,
			...
			"{": [
				...
				[
					...
					8, 7, 9, 5, 9, 3, 8, 1, 7, 0, 6, -2, 6, -4, 7, -6, -1, -1, 6, 8, 8, 6,
			...
			"}": [
				...
				[
					...
					6, 7, 5, 5, 5, 3, 6, 1, 7, 0, 8, -2, 8, -4, 7, -6, -1, -1, 8, 8, 6, 6,
					6, 4, 7, 2, 8, 1, 9, -1, 9, -3, 8, -5, 7, -6, 5, -7,
				],
			],
			"~": [
				24,
				[
					3, 6, 3, 8, 4, 11, 6, 12, 8, 12, 10, 11, 14, 8, 16, 7, 18, 7, 20, 8,
					21, 10, -1, -1, 3, 8, 4, 10, 6, 11, 8, 11, 10, 10, 14, 7, 16, 6, 18,
					6, 20, 7, 21, 10, 21, 12,
				],
			],
		};
		var oo = {
				...
				circle: function (t, e, i, o) {
					if ("translucent" === t.renderPass) {
						...
						if (
							0 !== r.constantOr(1) ||
							(0 !== a.constantOr(1) && 0 !== n.constantOr(1))
						)
							for (
								var s = t.context,
									l = s.gl,
									c = t.depthModeForSublayer(0, bt.ReadOnly),
									u = wt.disabled,
					...
					if (0 !== o.paint.get("heatmap-opacity"))
						if ("offscreen" === e.renderPass) {
							var a = e.context,
								...
								l = wt.disabled,
								c = new Et([n.ONE, n.ONE], t.Color.transparent, [
									!0,
									!0,
									!0,
									!0,
							...
							!(function (t, e, i) {
								...
								if (r)
									...
									o.bindTexture(o.TEXTURE_2D, a),
										...
										(r = i.heatmapFbo =
											t.createFramebuffer(e.width / 4, e.height / 4)),
										(function t(e, i, o, r) {
											var a = e.gl;
											a.texImage2D(
												a.TEXTURE_2D,
												...
												e.extTextureHalfFloat &&
													...
													r.colorAttachment.setDirty(),
													t(e, i, o, r));
										})(t, e, a, r);
								}
							})(a, e, o),
								a.clear({ color: t.Color.transparent });
								...
								if (!i.hasRenderableParent(h)) {
									...
									if (d) {
										...
										f.draw(
											...
											c,
											Tt.disabled,
											Ti(h.posMatrix, p, m, o.paint.get("heatmap-intensity")),
											o.id,
							...
							"translucent" === e.renderPass &&
								...
								(function (e, i) {
									...
									if (a) {
										...
										n ||
											(n = i.colorRampTexture =
												new t.Texture(o, i.colorRamp, r.RGBA)),
											n.bind(r.LINEAR, r.CLAMP_TO_EDGE),
											e
					...
					if ("translucent" === e.renderPass) {
						...
						if (0 !== a.constantOr(1) && 0 !== n.constantOr(1)) {
							...
							if (p) {
								...
								v ||
									(v = o.gradientTexture =
										new t.Texture(f, o.gradient, m.RGBA)),
										...
										var D = c
											...
											: h
												...
												: p
													? Pi(e, w, o)
													: Li(e, w, o);
										c && (S || e.lineAtlas.dirty)
											? (f.activeTexture.set(m.TEXTURE0), e.lineAtlas.bind(f))
											: h &&
												(f.activeTexture.set(m.TEXTURE0),
												w.imageAtlasTexture.bind(m.LINEAR, m.CLAMP_TO_EDGE),
												T.updatePatternPaintBuffers(d)),
											C.draw(
												f,
												m.TRIANGLES,
												s,
				...
				fill: function (e, i, o, r) {
					...
					if (0 !== n.constantOr(1)) {
						var s = e.colorModeForRenderPass(),
							l =
								o.paint.get("fill-pattern").constantOr(1) ||
								1 !== a.constantOr(t.Color.transparent).a ||
								1 !== n.constantOr(0)
									? "translucent"
									: "opaque";
						if (e.renderPass === l) {
							var c = e.depthModeForSublayer(
								1,
								"opaque" === e.renderPass ? bt.ReadWrite : bt.ReadOnly,
							);
							Ki(e, i, o, r, c, s, !1);
						}
						if (
							...
							var u = e.depthModeForSublayer(
								o.getPaintProperty("fill-outline-color") ? 2 : 0,
								bt.ReadOnly,
							);
							Ki(e, i, o, r, u, s, !0);
						}
				...
				"fill-extrusion": function (t, e, i, o) {
					if (0 !== i.paint.get("fill-extrusion-opacity"))
						if ("offscreen" === t.renderPass) {
								...
								for (
									...
									if (m) {
										...
										u &&
											...
											f.imageAtlasTexture.bind(l.LINEAR, l.CLAMP_TO_EDGE),
											g.updatePatternPaintBuffers(h));
							...
							"translucent" === t.renderPass &&
								Ji(t, i, i.paint.get("fill-extrusion-opacity"));
				},
				hillshade: function (t, e, i, o) {
					if ("offscreen" === t.renderPass || "translucent" === t.renderPass) {
						for (
							var r = t.context,
								a = e.getSource().maxzoom,
								n = t.depthModeForSublayer(0, bt.ReadOnly),
								s = wt.disabled,
							...
							var h = u[c],
								p = e.getTile(h);
							p.needsHillshadePrepare && "offscreen" === t.renderPass
								? $i(t, p, i, a, n, s, l)
								: "translucent" === t.renderPass && Qi(t, p, i, n, s, l);
						}
					...
					if (
						...
						for (
							...
							r.activeTexture.set(a.TEXTURE0),
								...
								v
									? (v.texture.bind(
										...
										(x = Math.pow(
											2,
											v.tileID.overscaledZ - m.tileID.overscaledZ,
										)),
										(b = [
											(m.tileID.canonical.x * x) % 1,
											(m.tileID.canonical.y * x) % 1,
										]))
									: m.texture.bind(w, a.CLAMP_TO_EDGE, a.LINEAR_MIPMAP_NEAREST);
							...
							n instanceof L
								...
								: m.maskedBoundsBuffer && m.maskedIndexBuffer && m.segments
									? s.draw(
											r,
											a.TRIANGLES,
											f,
							...
							if (t.renderPass === u) {
								var h = wt.disabled,
									p = t.depthModeForSublayer(
										0,
										"opaque" === u ? bt.ReadWrite : bt.ReadOnly,
									),
								...
								for (
									var m = i.getCrossfadeParameters(), g = 0, v = f;
									g < v.length;
									g += 1
								) {
									var y = v[g],
										...
										b = c
											? Ni(x, r, t, c, { tileID: y, tileSize: l }, m)
											: Ui(x, r, o);
									_.draw(
										a,
										n.TRIANGLES,
				...
				custom: function (t, e, i) {
					...
					if ("offscreen" === t.renderPass) {
						...
						a &&
							...
							a.call(r, o.gl, t.transform.customLayerMatrix()),
							o.setDirty(),
							t.setBaseState()),
							"3d" === r.renderingMode &&
								(t.setCustomLayerDefaults(),
						...
						if ("3d" === r.renderingMode) Ji(t, i, 1);
						else {
							t.setCustomLayerDefaults(),
			...
			ro = function (e, i) {
				(this.context = new It(e)),
					(this.transform = i),
					(this._tileTextures = {}),
					this.setup(),
					(this.numSublayers = Ct.maxUnderzooming + Ct.maxOverzooming + 1),
		...
		function no(t, e, i, o, r) {
			...
			if (
				t.x0 === e.x0 && t.y0 === e.y0
					? t.x0 + (e.dy / t.dy) * t.dx < e.x1
					: t.x1 - (e.dy / t.dy) * t.dx < e.x0
			) {
				var s = t;
				(t = e), (e = s);
			}
			for (
				var l = t.dx / t.dy, c = e.dx / e.dy, u = t.dx > 0, h = e.dx < 0, p = a;
				p < n;
				p++
			) {
		...
		(ro.prototype.resize = function (e, i) {
			...
			this.depthRbo &&
				(o.deleteRenderbuffer(this.depthRbo), (this.depthRbo = null));
		}),
			(ro.prototype.setup = function () {
				...
				i.emplaceBack(0, 0),
					...
					(this.tileExtentBuffer = e.createVertexBuffer(i, Ae.members)),
				...
				o.emplaceBack(0, 0),
					...
					(this.debugBuffer = e.createVertexBuffer(o, Ae.members)),
				...
				a.emplaceBack(0, 0),
					...
					a.emplaceBack(0, 1),
					a.emplaceBack(1, 1),
					(this.viewportBuffer = e.createVertexBuffer(a, Ae.members)),
			...
			(ro.prototype.depthModeForSublayer = function (t, e, i) {
				var o =
					1 -
					((1 + this.currentLayer) * this.numSublayers + t) * this.depthEpsilon;
			...
			(ro.prototype.render = function (e, i) {
				...
				for (var h in r) {
					var p = r[h];
					(l[h] = p.getVisibleCoordinates()),
						(c[h] = l[h].slice().reverse()),
						(u[h] = p.getVisibleCoordinates(!0).reverse());
				}
				for (var d in r) {
					var _ = r[d],
						f = _.getSource();
				...
				for (var x = 0, b = o; x < b.length; x += 1) {
					...
					if (E.hasOffscreenPass() && !E.isHidden(this.transform.zoom)) {
						var T = c[E.source];
						("custom" === E.type || T.length) &&
							this.renderLayer(this, r[E.source], E, T);
					}
				}
				for (
					...
					I.source !== s &&
						C &&
						(this.clearStencil(),
						C.getSource().isTileClipped && this._renderTileClippingMasks(S)),
						this.renderLayer(this, C, I, S),
						(s = I.source);
				}
				for (
					this.renderPass = "translucent", this.currentLayer = 0, s = null;
					...
					z.source !== s &&
						L &&
						(this.clearStencil(),
						L.getSource().isTileClipped &&
							this._renderTileClippingMasks(l[z.source])),
						this.renderLayer(this, L, z, P),
						(s = z.source);
				}
			...
			(ro.prototype.setupOffscreenDepthRenderbuffer = function () {
				var t = this.context;
				this.depthRbo ||
					(this.depthRbo = t.createRenderbuffer(
						t.gl.DEPTH_COMPONENT16,
						this.width,
						this.height,
					));
			}),
			(ro.prototype.renderLayer = function (t, e, i, o) {
				i.isHidden(this.transform.zoom) ||
					(("background" === i.type || "custom" === i.type || o.length) &&
						((this.id = i.id), oo[i.type](t, e, i, o)));
			}),
			(ro.prototype.translatePosMatrix = function (e, i, o, r, a) {
				...
				var c = [
						a ? o[0] : se(i, o[0], this.transform.zoom),
						a ? o[1] : se(i, o[1], this.transform.zoom),
						0,
					],
		...
		(lo.prototype.clone = function () {
			...
			(co.pitch.set = function (e) {
				...
				this._pitch !== i &&
					((this._unmodified = !1), (this._pitch = i), this._calcMatrices());
			}),
			(co.fov.get = function () {
			...
			(lo.prototype.getVisibleUnwrappedCoordinates = function (e) {
				...
				if (this._renderWorldCopies)
					for (
						var o = this.pointCoordinate(new t.Point(0, 0)),
							r = this.pointCoordinate(new t.Point(this.width, 0)),
							a = this.pointCoordinate(new t.Point(this.width, this.height)),
							n = this.pointCoordinate(new t.Point(0, this.height)),
							s = Math.floor(Math.min(o.x, r.x, a.x, n.x)),
							l = Math.floor(Math.max(o.x, r.x, a.x, n.x)),
							c = s - 1;
						c <= l + 1;
						c++
					)
			...
			(lo.prototype.coveringTiles = function (e) {
				...
				var r = t.MercatorCoordinate.fromLngLat(this.center),
					a = Math.pow(2, i),
					n = new t.Point(a * r.x - 0.5, a * r.y - 0.5);
				return (function (e, i, o, r) {
						...
						if (l >= 0 && l <= a)
							for (c = i; c < s; c++)
								(u = Math.floor(c / a)),
									(h = ((c % a) + a) % a),
									(0 !== u && !0 !== r) ||
										((p = new t.OverscaledTileID(o, u, e, h, l)),
										(n[p.key] = p));
					}
					...
					return (
						so(l[0], l[1], l[2], 0, a, s),
						so(l[2], l[3], l[0], 0, a, s),
					...
					[
						...
						this.pointCoordinate(new t.Point(this.width, this.height)),
						this.pointCoordinate(new t.Point(0, this.height)),
					],
					e.reparseOverscaled ? o : i,
			...
			(lo.prototype.project = function (e) {
				...
				return new t.Point(
					...
					t.mercatorYfromLat(i) * this.worldSize,
				);
			}),
			...
			(lo.prototype.pointCoordinate = function (e) {
				...
				var r = i[3],
					...
					p = u === h ? 0 : (0 - u) / (h - u);
				return new t.MercatorCoordinate(
					t.number(n, s, p) / this.worldSize,
					t.number(l, c, p) / this.worldSize,
				);
			}),
				...
				if (this.center && this.width && this.height && !this._constraining) {
					...
					if (this.latRange) {
						...
						(a = t.mercatorYfromLat(h[1]) * this.worldSize),
							(e =
								(n = t.mercatorYfromLat(h[0]) * this.worldSize) - a < c.y
									? c.y / (n - a)
									: 0);
					}
					if (this.lngRange) {
						...
						(s = t.mercatorXfromLng(p[0]) * this.worldSize),
							(i =
								(l = t.mercatorXfromLng(p[1]) * this.worldSize) - s < c.x
									? c.x / (l - s)
									: 0);
					}
					var d = this.point,
					...
					if (_)
						return (
							(this.center = this.unproject(
								new t.Point(i ? (l + s) / 2 : d.x, e ? (n + a) / 2 : d.y),
							)),
					...
					(void 0 === o && void 0 === r) ||
						(this.center = this.unproject(
							new t.Point(void 0 !== o ? o : d.x, void 0 !== r ? r : d.y),
						)),
						(this._unmodified = u),
			...
			(lo.prototype._calcMatrices = function () {
				if (this.height) {
					...
					var e = this._fov / 2,
						...
						o =
							(Math.sin(e) * this.cameraToCenterDistance) /
							Math.sin(Math.PI - i - e),
						r = this.point,
						a = r.x,
						n = r.y,
						s =
							1.01 *
							(Math.cos(Math.PI / 2 - this._pitch) * o +
								this.cameraToCenterDistance),
					...
					if (
						(t.translate(f, f, [d > 0.5 ? d - 1 : d, _ > 0.5 ? _ - 1 : _, 0]),
						(this.alignedProjMatrix = f),
						(l = t.create$1()),
			...
			(lo.prototype.maxPitchScaleFactor = function () {
				...
				return (
					t.transformMat4(i, i, this.pixelMatrix)[3] /
					this.cameraToCenterDistance
				);
			}),
			...
			(lo.prototype.getCameraQueryGeometry = function (e) {
				...
				for (
					var o = i.x, r = i.y, a = i.x, n = i.y, s = 0, l = e;
					s < l.length;
					s += 1
				) {
					var c = l[s];
		...
		var uo = function () {
			...
			t.bindAll(["_onHashChange", "_updateHash"], this),
				(this._updateHash =
					((e = this._updateHashUnthrottled.bind(this)),
					(i = 300),
					(o = !1),
					(r = 0),
					(a = function () {
		...
		(uo.prototype.addTo = function (e) {
			...
			(uo.prototype.getHashString = function (t) {
				var e = this._map.getCenter(),
					...
					o = Math.ceil((i * Math.LN2 + Math.log(512 / 360 / 0.5)) / Math.LN10),
					r = Math.pow(10, o),
		...
		var ho = (function (e) {
				function o(o, r, a, n) {
					...
					e.call(
						this,
						o,
						t.extend({ point: s, lngLat: l, originalEvent: a }, n),
					),
			...
			_o = (function (t) {
				function e(e, i, o) {
					t.call(this, e, { originalEvent: o }), (this._defaultPrevented = !1);
				}
				t && (e.__proto__ = t),
					(e.prototype = Object.create(t && t.prototype)),
					(e.prototype.constructor = e);
			...
			fo = function (e) {
				(this._map = e),
					...
					(this._delta = 0),
					t.bindAll(
						["_onWheel", "_onTimeout", "_onScrollFrame", "_onScrollFinished"],
						this,
					);
			};
		(fo.prototype.isEnabled = function () {
						...
						0 !== i && i % 4.000244140625 == 0
							...
							: 0 !== i && Math.abs(i) < 4
								...
								: r > 400
									...
									: this._type ||
										((this._type =
											Math.abs(r * i) < 200 ? "trackpad" : "wheel"),
										this._timeout &&
			...
			(fo.prototype._start = function (e) {
				if (this._delta) {
					this._frameId &&
						...
						(this._active = !0),
						(this._zooming = !0),
						this._map.fire(new t.Event("movestart", { originalEvent: e })),
						this._map.fire(new t.Event("zoomstart", { originalEvent: e })),
						this._finishTimeout && clearTimeout(this._finishTimeout);
					var o = i.mousePos(this._el, e);
					(this._around = t.LngLat.convert(
						this._aroundCenter ? this._map.getCenter() : this._map.unproject(o),
					)),
			...
			(fo.prototype._onScrollFrame = function () {
				...
				if (((this._frameId = null), this.isActive())) {
					...
					if (0 !== this._delta) {
						var o =
								"wheel" === this._type && Math.abs(this._delta) > 4.000244140625
									? 1 / 450
									: 0.01,
						...
						(this._targetZoom = Math.min(
							i.maxZoom,
							Math.max(i.minZoom, i.scaleZoom(a * r)),
						)),
							"wheel" === this._type &&
					...
					var n =
							"number" == typeof this._targetZoom ? this._targetZoom : i.zoom,
						s = this._startZoom,
						l = this._easing,
						c = !1;
			...
			(fo.prototype._smoothOutEasing = function (e) {
				...
				if (this._prevEase) {
					var o = this._prevEase,
						...
						a = o.easing(r + 0.01) - o.easing(r),
						n = (0.27 / Math.sqrt(a * a + 1e-4)) * 0.01,
						s = Math.sqrt(0.0729 - n * n);
					i = t.bezier(n, s, 0.25, 1);
				}
				return (
					(this._prevEase = { start: t.browser.now(), duration: e, easing: i }),
					i
				);
			});
		var mo = function (e, i) {
				...
				if (0 === e.button) {
					...
					this._finish(),
						...
						o.x === r.x && o.y === r.y
							...
							: this._map
									.fitScreenCoordinates(o, r, this._map.getBearing(), {
										linear: !0,
									})
		...
		(vo.prototype.isEnabled = function () {
			...
			(vo.prototype.onMouseDown = function (e) {
				if ("enabled" === this._state) {
					if ("right" === this._button) {
						if (
							((this._eventButton = i.mouseButton(e)),
				...
				if (e) {
					...
					this._drainInertiaBuffer(),
						...
						this._pitchWithRotate &&
							(this._fireEvent("pitch", e), (i.pitch = l)),
			...
			(vo.prototype._deactivate = function () {
				this._frameId &&
					(this._map._cancelRenderFrame(this._frameId), (this._frameId = null)),
					delete this._lastMoveEvent,
					delete this._startPos,
					delete this._lastPos;
			}),
			(vo.prototype._inertialRotate = function (t) {
				...
				if (r.length < 2) a();
					...
					var n = r[0],
						...
						p = (s[0] - n[0]) / 1e3;
					if (0 !== u && 0 !== p) {
						var d = Math.abs(u * (0.25 / p));
						d > 180 && (d = 180);
						var _ = d / 180;
						(c += h * d * (_ / 2)),
							Math.abs(i._normalizeBearing(c, 0)) < this._bearingSnap &&
								(c = i._normalizeBearing(0, c)),
							i.rotateTo(
								c,
								{ duration: 1e3 * _, easing: go, noMoveStart: !0 },
								{ originalEvent: t },
							);
					} else a();
				}
			...
			(vo.prototype._fireEvent = function (e, i) {
				return this._map.fire(new t.Event(e, i ? { originalEvent: i } : {}));
			}),
			(vo.prototype._drainInertiaBuffer = function () {
				for (
					var e = this._inertia, i = t.browser.now();
					e.length > 0 && i - e[0][0] > 160;

				)
					e.shift();
			});
		var yo = t.bezier(0, 0, 0.3, 1),
			xo = function (e, i) {
				(this._map = e),
					(this._el = e.getCanvasContainer()),
					(this._state = "disabled"),
					(this._clickTolerance = i.clickTolerance || 1),
					t.bindAll(
						["_onMove", "_onMouseUp", "_onTouchEnd", "_onBlur", "_onDragFrame"],
						this,
					);
			};
		(xo.prototype.isEnabled = function () {
			...
			(xo.prototype.disable = function () {
				if (this.isEnabled())
					switch (
						(this._el.classList.remove("mapboxgl-touch-drag-pan"), this._state)
					) {
						case "active":
							(this._state = "disabled"),
								this._unbind(),
			...
			(xo.prototype.onMouseDown = function (e) {
				"enabled" === this._state &&
					(e.ctrlKey ||
						0 !== i.mouseButton(e) ||
						(i.addEventListener(t.window.document, "mousemove", this._onMove, {
							capture: !0,
						}),
			...
			(xo.prototype._start = function (e) {
				t.window.addEventListener("blur", this._onBlur),
					...
					(this._startPos =
						this._mouseDownPos =
						this._lastPos =
							i.mousePos(this._el, e)),
					(this._inertia = [[t.browser.now(), this._startPos]]);
			}),
			(xo.prototype._onMove = function (e) {
				e.preventDefault();
				var o = i.mousePos(this._el, e);
				this._lastPos.equals(o) ||
					("pending" === this._state &&
						o.dist(this._mouseDownPos) < this._clickTolerance) ||
			...
			(xo.prototype._inertialPan = function (t) {
				...
				if (e.length < 2) this._fireEvent("moveend", t);
					...
					if (0 === a || i[1].equals(o[1])) this._fireEvent("moveend", t);
						...
						this._map.panBy(
							c,
							{ duration: 1e3 * l, easing: yo, noMoveStart: !0 },
							{ originalEvent: t },
						);
					}
				}
		...
		(Io.prototype.isEnabled = function () {
			...
			(Io.prototype._getTouchEventData = function (t) {
				...
				return {
					...
					bearing: this._rotationDisabled
						? 0
						: (180 * r.angleWith(this._startVec)) / Math.PI,
				};
			}),
			(Io.prototype._onMove = function (e) {
				if (2 === e.touches.length) {
					...
					if (!this._gestureIntent) {
						var n =
							(this._rotationDisabled && 1 !== r) || Math.abs(1 - r) > 0.15;
						Math.abs(a) > 10
							? (this._gestureIntent = "rotate")
							: n && (this._gestureIntent = "zoom"),
							this._gestureIntent &&
								(this._map.fire(
			...
			(Io.prototype._onTouchFrame = function () {
				...
				if (e) {
					var i = this._map.transform;
					this._startScale ||
						((this._startScale = i.scale), (this._startBearing = i.bearing));
			...
			(Io.prototype._onEnd = function (e) {
				...
				if (
					...
					this._map.fire(new t.Event(o + "end", { originalEvent: e })),
						this._drainInertiaBuffer();
					var a = this._inertia,
						n = this._map;
					if (a.length < 2) n.snapToNorth({}, { originalEvent: e });
					else {
						var s = a[a.length - 1],
							l = a[0],
						...
						} else n.snapToNorth({}, { originalEvent: e });
					}
				}
			}),
				...
				return (
					...
					(i.prototype.panBy = function (e, i, o) {
						return (
							...
							this.panTo(this.transform.center, t.extend({ offset: e }, i), o)
						);
					}),
					...
					(i.prototype._cameraForBoxAndBearing = function (e, i, o, r) {
						...
						if (
							t.isEqual(
								Object.keys(r.padding).sort(function (t, e) {
									return t < e ? -1 : t > e ? 1 : 0;
								}),
					...
					(i.prototype.fitScreenCoordinates = function (e, i, o, r, a) {
						return this._fitInternal(
							this._cameraForBoxAndBearing(
								...
								this.transform.pointLocation(t.Point.convert(i)),
								o,
								r,
							),
							r,
					...
					(i.prototype.jumpTo = function (e, i) {
						...
						return (
							...
							"bearing" in e &&
								o.bearing !== +e.bearing &&
								((a = !0), (o.bearing = +e.bearing)),
							"pitch" in e &&
								o.pitch !== +e.pitch &&
								((n = !0), (o.pitch = +e.pitch)),
							this.fire(new t.Event("movestart", i)).fire(
								new t.Event("move", i),
							),
							r &&
								this.fire(new t.Event("zoomstart", i))
									.fire(new t.Event("zoom", i))
									.fire(new t.Event("zoomend", i)),
							a &&
								this.fire(new t.Event("rotatestart", i))
									.fire(new t.Event("rotate", i))
									.fire(new t.Event("rotateend", i)),
							n &&
								this.fire(new t.Event("pitchstart", i))
									.fire(new t.Event("pitch", i))
									.fire(new t.Event("pitchend", i)),
					...
					(i.prototype.easeTo = function (e, i) {
						...
						return (
							e.around &&
								((_ = t.LngLat.convert(e.around)), (f = r.locationPoint(_))),
							(this._zooming = l !== a),
							(this._rotating = n !== c),
							(this._pitching = u !== s),
							...
							this._ease(
								...
								function () {
									e.delayEndEvents
										? (o._easeEndTimeoutID = setTimeout(function () {
							...
							this._ease(
								function (e) {
									...
									(r.zoom = 1 === e ? l : a + r.scaleZoom(d)),
										...
										o._pitching && (r.pitch = t.number(s, u, e));
									var g =
										1 === e ? _ : r.unproject(f.add(m.mult(L(h))).mult(d));
					...
					(i.prototype._renderFrameCallback = function () {
						var e = Math.min(
							(t.browser.now() - this._easeStart) / this._easeOptions.duration,
							1,
						);
		...
		(zo.prototype.getDefaultPosition = function () {
			...
			(zo.prototype._updateEditLink = function () {
				...
				var i = [
					...
					{ key: "access_token", value: t.config.ACCESS_TOKEN },
				];
				if (e) {
					var o = i.reduce(function (t, e, o) {
						return (
							e.value &&
								(t += e.key + "=" + e.value + (o < i.length - 1 ? "&" : "")),
							t
						);
					}, "?");
					e.href =
				...
				if (this._map.style) {
					...
					for (var o in i) {
						...
						if (r.used) {
							var a = r.getSource();
							a.attribution &&
								t.indexOf(a.attribution) < 0 &&
								t.push(a.attribution);
						}
					}
					t.sort(function (t, e) {
						...
						(t = t.filter(function (e, i) {
							...
							? ((this._innerContainer.innerHTML = t.join(" | ")),
			...
			(Po.prototype.remove = function (t) {
				for (
					var e = this._currentlyRunning,
						i = 0,
						o = e ? this._queue.concat(e) : this._queue;
					i < o.length;
					i += 1
				) {
					var r = o[i];
			...
			Ao = (function (o) {
				function r(e) {
					...
					o.call(this, a, e),
						...
						(this._renderTaskQueue = new Po()),
						(this._controls = []),
						(this._mapId = t.uniqueId());
					var n = e.transformRequest;
					if (
						((this._transformRequest = n
							? function (t, e) {
									return n(t, e) || { url: t };
								}
							: function (t) {
					...
					this.on("move", function () {
						...
						void 0 !== t.window &&
							(t.window.addEventListener("online", this._onWindowOnline, !1),
						...
						(function (t, e) {
							...
							i.addEventListener(o, "mouseout", function (e) {
									...
									t.fire(s),
										s.defaultPrevented ||
											(e.interactive &&
												...
												t.stop(),
											t.boxZoom.onMouseDown(r),
											t.boxZoom.isActive() ||
												t.dragPan.isActive() ||
												t.dragRotate.onMouseDown(r),
											t.boxZoom.isActive() ||
												t.dragRotate.isActive() ||
												t.dragPan.onMouseDown(r));
								}),
								i.addEventListener(o, "mouseup", function (e) {
									var i = t.dragRotate.isActive();
									r && !i && t.fire(new ho("contextmenu", t, r)),
										(r = null),
										(a = !1),
										t.fire(new ho("mouseup", t, e));
								}),
									...
									function (i) {
										...
										t.fire(o),
											o.defaultPrevented ||
												...
												t.boxZoom.isActive() ||
													t.dragRotate.isActive() ||
													t.dragPan.onTouchStart(i),
												t.touchZoomRotate.onStart(i),
												t.doubleClickZoom.onTouchStart(o));
									},
									{ passive: !1 },
								),
								i.addEventListener(
								...
								i.addEventListener(o, "click", function (r) {
									...
									(a.equals(n) || a.dist(n) < e.clickTolerance) &&
										t.fire(new ho("click", t, r));
								}),
								...
								i.addEventListener(o, "contextmenu", function (e) {
									var i = t.dragRotate.isActive();
									a || i ? a && (r = e) : t.fire(new ho("contextmenu", t, e)),
										(t.dragRotate.isEnabled() || t.listens("contextmenu")) &&
											e.preventDefault();
								}),
								i.addEventListener(
									o,
						...
						(this._hash = e.hash && new uo().addTo(this)),
						...
						e.attributionControl &&
							this.addControl(
								new zo({ customAttribution: e.customAttribution }),
							),
						this.addControl(new Lo(), e.logoPosition),
				...
				return (
					(r.prototype._getMapId = function () {
						return this._mapId;
					}),
					...
					(r.prototype.removeControl = function (e) {
						...
						return (
							i > -1 && this._controls.splice(i, 1), e.onRemove(this), this
						);
					}),
						...
						var a = (function () {
								...
								return {
									...
									delegates: {
										mousemove: function (o) {
											var n = r.getLayer(e)
												? r.queryRenderedFeatures(o.point, { layers: [e] })
												: [];
											n.length
												? a ||
													((a = !0),
													i.call(
														r,
														new ho(t, r, o.originalEvent, { features: n }),
													))
												: (a = !1);
										},
										mouseout: function () {
									...
									delegates: {
										mousemove: function (o) {
											(r.getLayer(e)
												...
												? (n = !0)
												: n &&
													((n = !1), i.call(r, new ho(t, r, o.originalEvent)));
										},
										mouseout: function (e) {
							...
							return {
								...
								delegates:
									...
									(o[t] = function (t) {
										var o = r.getLayer(e)
											? r.queryRenderedFeatures(t.point, { layers: [e] })
											: [];
										o.length &&
											((t.features = o), i.call(r, t), delete t.features);
									}),
									o),
							};
						})();
						for (var n in ((this._delegatedListeners =
					...
					(r.prototype.off = function (t, e, i) {
						...
						if (this._delegatedListeners && this._delegatedListeners[t])
							for (
								var r = this._delegatedListeners[t], a = 0;
								a < r.length;
								a++
							) {
								var n = r[a];
					...
					(r.prototype.setStyle = function (t, e) {
						return (!e || (!1 !== e.diff && !e.localIdeographFontFamily)) &&
							this.style &&
							t
							? (this._diffStyle(t, e), this)
					...
					(r.prototype.addImage = function (e, i, o) {
						...
						if ((void 0 === a && (a = !1), i instanceof Do)) {
							...
							this.style.addImage(e, {
								data: new t.RGBAImage({ width: s, height: l }, c),
								pixelRatio: r,
								sdf: a,
							});
						} else {
					...
					(r.prototype._setupContainer = function () {
						...
						var e = (this._canvasContainer = i.create(
							"div",
						...
						var r = (this._controlContainer = i.create(
								"div",
					...
					(r.prototype._setupPainter = function () {
						...
						o
							? ((this.painter = new ro(o, this.transform)),
								t.webpSupported.testSupport(o))
							: this.fire(
					...
					(r.prototype._contextLost = function (e) {
						e.preventDefault(),
							...
							this.fire(new t.Event("webglcontextlost", { originalEvent: e }));
					}),
					...
					(r.prototype.remove = function () {
						...
						o && o.loseContext(),
							ko(this._canvasContainer),
							ko(this._controlContainer),
							ko(this._missingCSSCanary),
					...
					(r.prototype.triggerRepaint = function () {
						...
						this.style &&
							!this._frame &&
							(this._frame = t.browser.frame(function () {
		...
		var Bo = { showCompass: !0, showZoom: !0 },
			Oo = function (e) {
				var o = this;
				(this.options = t.extend({}, Bo, e)),
					(this._container = i.create(
						"div",
		...
		function Fo(e, i, o) {
			if (((e = new t.LngLat(e.lng, e.lat)), i)) {
				...
				o.locationPoint(r).distSqr(i) < n
					? (e = r)
					: o.locationPoint(a).distSqr(i) < n && (e = a);
			}
		...
		var Zo,
			jo = (function (e) {
				function o(o, r) {
					if (
						(e.call(this),
						(o instanceof t.window.HTMLElement || r) &&
							(o = t.extend({ element: o }, r)),
						t.bindAll(
							["_update", "_onMove", "_onUp", "_addDragHandler", "_onMapClick"],
							this,
						),
						(this._anchor = (o && o.anchor) || "center"),
						(this._color = (o && o.color) || "#3FB1CE"),
						(this._draggable = (o && o.draggable) || !1),
						(this._state = "inactive"),
						o && o.element)
					)
						(this._element = o.element),
				...
				return (
					...
					(o.prototype.setPopup = function (t) {
						if (
							(this._popup && (this._popup.remove(), (this._popup = null)), t)
						) {
					...
					(o.prototype._update = function (t) {
						this._map &&
							...
							No(this._element, this._anchor, "marker"));
					}),
					...
					(o.prototype._onMove = function (e) {
						(this._pos = e.point.sub(this._positionDelta)),
							...
							"pending" === this._state &&
								((this._state = "active"), this.fire(new t.Event("dragstart"))),
		...
		var qo = (function (e) {
				...
				return (
						...
						return (
							...
							void 0 !== Zo
								...
								: void 0 !== t.window.navigator.permissions
									...
									: ((Zo = !!t.window.navigator.geolocation), o(Zo)),
							this._container
						);
					}),
						...
						!1 !== e
							? (this._container.addEventListener("contextmenu", function (t) {
								...
								this.options.showUserLocation &&
									...
									(this._userLocationDotMarker = new jo(this._dotElement)),
								...
								this.options.trackUserLocation &&
									this._map.on("movestart", function (e) {
										e.geolocateSource ||
											...
											o.fire(new t.Event("trackuserlocationend")));
									}))
							: t.warnOnce(
					...
					(o.prototype.trigger = function () {
						if (!this._setup)
							return (
								t.warnOnce("Geolocate control triggered before added to a map"),
								!1
							);
						if (this.options.trackUserLocation) {
							switch (this._watchState) {
			...
			Go = { maxWidth: 100, unit: "metric" },
			Wo = function (e) {
				(this.options = t.extend({}, Go, e)),
		...
		function Xo(t, e, i) {
			var o,
				...
				h =
					...
					(s = r.lat * a),
					(l =
						Math.sin(n) * Math.sin(s) +
						Math.cos(n) * Math.cos(s) * Math.cos((r.lng - o.lng) * a)),
					6371e3 * Math.acos(Math.min(l, 1)));
			if (i && "imperial" === i.unit) {
				var p = 3.2808 * h;
				if (p > 5280) Ho(e, c, p / 5280, "mi");
				else Ho(e, c, p, "ft");
		...
		function Ho(t, e, i, o) {
			var r,
				...
				s =
					((r = i),
					(a = Math.pow(10, ("" + Math.floor(r)).length - 1)),
					(n =
						(n = r / a) >= 10
							? 10
							: n >= 5
		...
		(Ko.prototype.onAdd = function (e) {
			...
			(Ko.prototype._setupUI = function () {
				var e = (this._fullscreenButton = i.create(
					"button",
		...
		var Yo = { closeButton: !0, closeOnClick: !0, className: "" },
			Jo = (function (e) {
				function o(i) {
					e.call(this),
						(this.options = t.extend(Object.create(Yo), i)),
						...
						if (this._map && this._lngLat && this._content) {
							...
							var o = (this._pos = this._map.project(this._lngLat)),
								...
								a = (function e(i) {
									if (i) {
										if ("number" == typeof i) {
											var o = Math.round(Math.sqrt(0.5 * Math.pow(i, 2)));
											return {
							...
							if (!r) {
								...
								(n =
									o.y + a.bottom.y < l
										? ["top"]
										: o.y > this._map.transform.height - l
											? ["bottom"]
											: []),
									o.x < s / 2
										? n.push("left")
										: o.x > this._map.transform.width - s / 2 &&
											n.push("right"),
							...
							i.setTransform(
								this._container,
								Uo[r] + " translate(" + c.x + "px," + c.y + "px)",
							),
								No(this._container, r, "popup");
						}
					}),
