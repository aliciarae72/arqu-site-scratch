...
(function () {
  ...
  var MARKS = [
    { sel: '#hero-title', text: 'beyond', kind: 'circle', seed: 9, wait: 1100 },
  ...
  function heroMotif() {
    ...
    if (!svg) return;
    var rc = rough.svg(svg), g = document.createElementNS('http://www.w3.org/2000/svg', 'g');
    ...
    [rc.circle(40, 316, 27, opts(21, fig)), rc.linearPath([[40, 330], [41, 378]], opts(22, fig)),
     rc.linearPath([[41, 378], [28, 413]], opts(23, fig)), rc.linearPath([[41, 378], [55, 412]], opts(24, fig)),
     rc.linearPath([[40, 344], [26, 372]], opts(25, fig)),
     rc.linearPath([[40, 343], [61, 326], [81, 306]], opts(26, fig))].forEach(function (n) { g.appendChild(n); });
    ...
    svg.appendChild(ask); svg.appendChild(g); svg.appendChild(arrow);
    ink(ask, 750, 0.6);
    ink(g, 1150, 0.35);
    ink(arrow, 2050, 0.4);
  }
